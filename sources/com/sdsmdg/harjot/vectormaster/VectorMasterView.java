...
public class VectorMasterView extends View {
    ...
    public VectorMasterView(Context context2) {
        super(context2);
        this.context = context2;
    }

    public VectorMasterView(Context context2, AttributeSet attributeSet) {
        super(context2, attributeSet);
        this.context = context2;
        init(attributeSet);
    }

    public VectorMasterView(Context context2, AttributeSet attributeSet, int i) {
    ...
    void init(AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = this.context.obtainStyledAttributes(attributeSet, R.styleable.VectorMasterView);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (vectorModel2 != null) {
            setAlpha(vectorModel2.getAlpha());
