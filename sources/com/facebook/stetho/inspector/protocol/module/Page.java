...
public class Page implements ChromeDevtoolsDomain {
    ...
    public JsonRpcResult getResourceTree(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        FrameResourceTree createSimpleFrameResourceTree = createSimpleFrameResourceTree("1", null, "Stetho", it2.hasNext() ? it2.next() : "");
        ...
        while (it2.hasNext()) {
            ...
            createSimpleFrameResourceTree.childFrames.add(createSimpleFrameResourceTree(sb2, "1", "Child #" + sb2, it2.next()));
            i = i2;
        }
