...
public final class l<LookupExtra extends f.a> {
    ...
    public int hashCode() {
        return com.tencent.msdk.dns.base.e.a.b(this.a, this.b, Integer.valueOf(this.c), this.d, this.e, Boolean.valueOf(this.g), Boolean.valueOf(this.h), Integer.valueOf(this.i), Boolean.valueOf(this.j), Boolean.valueOf(this.k), Integer.valueOf(this.f1450l), Boolean.valueOf(this.m));
    }

    public String toString() {
        return "LookupParameters{appContext=" + this.a + ", hostname='" + this.b + "', timeoutMills=" + this.c + ", lookupExtra=" + this.d + ", channel='" + this.e + "', token=" + this.f + ", fallback2Local=" + this.g + ", blockFirst=" + this.h + ", family=" + this.i + ", ignoreCurNetStack=" + this.j + ", enableAsyncLookup=" + this.k + ", curRetryTime=" + this.f1450l + ", netChangeLookup=" + this.m + '}';
    }
                ...
                if (str != null) {
                    ...
                    if (-1 != i2) {
                        ...
                        if (lookupextra != null) {
                            String str2 = this.e;
                            if (str2 != null) {
                                return new l<>(context, str, i2, lookupextra, str2, this.f, this.g, this.h, this.i, this.j, this.k, this.f1451l, this.m);
                            }
