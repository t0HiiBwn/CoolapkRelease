...
public class CommsTokenStore {
    ...
    public CommsTokenStore(String str) {
        ...
        this.logContext = str;
        logger.fine("CommsTokenStore", "<Init>", "308");
    }
    ...
    public MqttToken removeToken(String str) {
        log.fine("CommsTokenStore", "removeToken", "306", new Object[]{str});
        if (str != null) {
    ...
    protected MqttDeliveryToken restoreToken(MqttPublish mqttPublish) {
        ...
        synchronized (this.tokens) {
            ...
            if (this.tokens.containsKey(num)) {
                ...
                log.fine("CommsTokenStore", "restoreToken", "302", new Object[]{num, mqttPublish, mqttDeliveryToken});
            } else {
                ...
                log.fine("CommsTokenStore", "restoreToken", "303", new Object[]{num, mqttPublish, mqttDeliveryToken});
            }
        }
    ...
    protected void saveToken(MqttToken mqttToken, MqttWireMessage mqttWireMessage) throws MqttException {
        synchronized (this.tokens) {
            ...
            if (mqttException == null) {
                ...
                log.fine("CommsTokenStore", "saveToken", "300", new Object[]{key, mqttWireMessage});
    ...
    protected void saveToken(MqttToken mqttToken, String str) {
        synchronized (this.tokens) {
            log.fine("CommsTokenStore", "saveToken", "307", new Object[]{str, mqttToken.toString()});
    ...
    protected void quiesce(MqttException mqttException) {
        synchronized (this.tokens) {
            log.fine("CommsTokenStore", "quiesce", "309", new Object[]{mqttException});
