...
public class k {
    ...
    private k() {
        ...
        this.h = new Application.ActivityLifecycleCallbacks() {
            /* class com.umeng.analytics.pro.k.AnonymousClass1 */
            ...
            public void onActivityStopped(Activity activity) {
                ...
                if ((k.f == 1 || (k.f == 0 && !UMUtils.isMainProgress(activity))) && activity != null) {
                    ...
                    b.a().a((Context) activity, "$$_onUMengEnterBackground", (Map<String, Object>) hashMap);
                    if (k.e != null) {
                        k.e = null;
                    }
                }
                ...
                if (activity != null) {
                    if (k.this.n <= 0) {
                        ...
                        if (k.f == 0 && UMUtils.isMainProgress(activity)) {
                            ...
                            hashMap.put("pid", Integer.valueOf(Process.myPid()));
                            hashMap.put("isMainProcess", Integer.valueOf(UMUtils.isMainProgress(activity) ? 1 : 0));
                            b.a().a((Context) activity, "$$_onUMengEnterForegroundInitError", (Map<String, Object>) hashMap);
                            k.f = -2;
