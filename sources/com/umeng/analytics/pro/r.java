...
public class r {
            ...
            if (!a(str)) {
                ...
                if (map.size() > 100) {
                    ...
                    for (Map.Entry<String, Object> entry : map.entrySet()) {
                        if (!Arrays.asList(c.aN).contains(entry.getKey())) {
    ...
    public void a(String str, Map<String, Object> map, String str2) {
        try {
            if (a(str)) {
                ...
                String d2 = x.a().d(UMGlobalContext.getAppContext(g));
    ...
    private void a(String str, boolean z) {
        try {
            if (!"$st_fl".equals(str) && !"du".equals(str) && !"id".equals(str) && !"ts".equals(str) && !this.h.has(str)) {
                this.h.put(str, z);
            }
        } catch (Exception unused) {
        }
