...
public class x {
    ...
    public static void c(Context context) {
        ...
        intent.setPackage(packageName);
        try {
            ActivityInfo a2 = a(packageManager, intent, jb.a(context, "com.xiaomi.push.service.receivers.PingReceiver"));
        ...
        for (ResolveInfo resolveInfo : packageManager.queryBroadcastReceivers(intent2, 16384)) {
            ...
            if (activityInfo != null) {
                try {
                    if (!TextUtils.isEmpty(activityInfo.name) && PushMessageReceiver.class.isAssignableFrom(jb.a(context, activityInfo.name)) && activityInfo.enabled) {
                        z = true;
                        if (!z) {
                            break;
                        }
