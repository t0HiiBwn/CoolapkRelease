...
public class dd implements LoggerInterface {
    ...
    private static final SimpleDateFormat f309a = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss aaa");

    /* renamed from: a  reason: collision with other field name */
    private static List<Pair<String, Throwable>> f310a = Collections.synchronizedList(new ArrayList());
    ...
    public dd(Context context) {
        ...
        this.b = this.f311a.getPackageName();
        HandlerThread handlerThread = new HandlerThread("Log2FileHandlerThread");
        handlerThread.start();
        this.f312a = new Handler(handlerThread.getLooper());
    }
    ...
    private void a() {
        ...
        try {
            if (TextUtils.isEmpty(this.c) && (externalFilesDir = this.f311a.getExternalFilesDir(null)) != null) {
            ...
            try {
                ...
                while (!f310a.isEmpty()) {
                    try {
                        Pair<String, Throwable> remove = f310a.remove(0);
    ...
    public final void log(String str, Throwable th) {
        this.f312a.post(new de(this, str, th));
    }
