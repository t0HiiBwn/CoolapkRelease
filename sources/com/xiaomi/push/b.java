...
public final class b {
    ...
    private final InputStream f219a;
    ...
    private boolean a(boolean z) {
        ...
        if (i2 >= i3) {
            ...
            if (i4 + i3 != this.f) {
                this.e = i4 + i3;
                this.c = 0;
                InputStream inputStream = this.f219a;
                int read = inputStream == null ? -1 : inputStream.read(this.f220a);
                this.a = read;
                if (read == 0 || read < -1) {
    ...
    public String m117a() {
        ...
        if (d2 > this.a - this.c || d2 <= 0) {
            return new String(m122a(d2), "UTF-8");
        }
        String str = new String(this.f220a, this.c, d2, "UTF-8");
        this.c += d2;
        return str;
    }
        ...
        if (i2 >= 0) {
            ...
            if (i5 <= i6) {
                ...
                if (i2 <= i7 - i4) {
                    ...
                    System.arraycopy(this.f220a, i4, bArr, 0, i2);
                    this.c += i2;
                    return bArr;
                } else if (i2 < 4096) {
                    byte[] bArr2 = new byte[i2];
                    int i8 = i7 - i4;
                    System.arraycopy(this.f220a, i4, bArr2, 0, i8);
                    this.c = this.a;
                    while (true) {
                        a(true);
                        int i9 = i2 - i8;
                        int i10 = this.a;
                        if (i9 > i10) {
                            System.arraycopy(this.f220a, 0, bArr2, i8, i10);
                            int i11 = this.a;
                            i8 += i11;
                            this.c = i11;
                        } else {
                            System.arraycopy(this.f220a, 0, bArr2, i8, i9);
                            this.c = i9;
                            return bArr2;
                        }
                    }
                    ...
                    System.arraycopy(this.f220a, i4, bArr4, 0, i12);
