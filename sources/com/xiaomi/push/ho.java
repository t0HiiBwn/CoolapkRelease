...
public class ho implements hu<ho, Object>, Serializable, Cloneable {
    private static final il j = new il("XmPushActionSubscriptionResult");
    ...
    public boolean a(ho hoVar) {
        ...
        boolean a2 = a();
        boolean a3 = hoVar.a();
        if ((a2 || a3) && (!a2 || !a3 || !this.a.equals(hoVar.a))) {
            return false;
        }
        boolean b2 = b();
        boolean b3 = hoVar.b();
        if ((b2 || b3) && (!b2 || !b3 || !this.b.a(hoVar.b))) {
            return false;
        }
        boolean c2 = c();
        boolean c3 = hoVar.c();
        if ((c2 || c3) && (!c2 || !c3 || !this.c.equals(hoVar.c))) {
            return false;
        }
        boolean d2 = d();
        boolean d3 = hoVar.d();
        if ((d2 || d3) && (!d2 || !d3 || !this.d.equals(hoVar.d))) {
            return false;
        }
        boolean e2 = e();
        boolean e3 = hoVar.e();
        if ((e2 || e3) && (!e2 || !e3 || this.e != hoVar.e)) {
            return false;
        }
        boolean f2 = f();
        boolean f3 = hoVar.f();
        if ((f2 || f3) && (!f2 || !f3 || !this.f.equals(hoVar.f))) {
            return false;
        }
        boolean h2 = h();
        boolean h3 = hoVar.h();
        if ((h2 || h3) && (!h2 || !h3 || !this.g.equals(hoVar.g))) {
            return false;
        }
        boolean i2 = i();
        boolean i3 = hoVar.i();
        if ((i2 || i3) && (!i2 || !i3 || !this.h.equals(hoVar.h))) {
            return false;
        }
        boolean k2 = k();
        boolean k3 = hoVar.k();
        if (k2 || k3) {
            return k2 && k3 && this.i.equals(hoVar.i);
        }
        return true;
    }
    ...
    public int compareTo(ho hoVar) {
        ...
        if (a() && (a10 = hv.a(this.a, hoVar.a)) != 0) {
            return a10;
        }
        ...
        if (i() && (a3 = hv.a(this.h, hoVar.h)) != 0) {
            return a3;
        }
        int compareTo9 = Boolean.valueOf(k()).compareTo(Boolean.valueOf(hoVar.k()));
        if (compareTo9 != 0) {
            return compareTo9;
        }
        if (!k() || (a2 = hv.a(this.i, hoVar.i)) == 0) {
            return 0;
        }
        return a2;
    }
