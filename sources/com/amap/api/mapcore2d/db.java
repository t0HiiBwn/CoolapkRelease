...
public class db {
    ...
    public static byte[] c() {
        try {
            ...
            String[] split2 = new StringBuffer(new String(cv.b(new String(bArr)))).reverse().toString().split(",");
    ...
    static PublicKey d() throws CertificateException, InvalidKeySpecException, NoSuchAlgorithmException, NullPointerException, IOException {
        ...
        Throwable th;
        try {
            byteArrayInputStream = new ByteArrayInputStream(cv.b(""));
            try {
