...
public class FlexboxLayoutManager extends RecyclerView.LayoutManager implements FlexContainer, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int layoutFlexLineMainAxisHorizontal(FlexLine flexLine, LayoutState layoutState) {
        ...
        int i3 = layoutState.mPosition;
        int i4 = this.mJustifyContent;
        int i5 = 1;
        if (i4 != 0) {
            if (i4 == 1) {
                float f4 = (float) ((width - flexLine.mMainSize) + paddingRight);
                f = 0.0f;
                f2 = (float) (flexLine.mMainSize - paddingLeft);
                f3 = f4;
            } else if (i4 == 2) {
                f3 = ((float) paddingLeft) + (((float) (width - flexLine.mMainSize)) / 2.0f);
                f2 = ((float) (width - paddingRight)) - (((float) (width - flexLine.mMainSize)) / 2.0f);
            } else if (i4 == 3) {
                f3 = (float) paddingLeft;
                f = ((float) (width - flexLine.mMainSize)) / (flexLine.mItemCount != 1 ? (float) (flexLine.mItemCount - 1) : 1.0f);
                f2 = (float) (width - paddingRight);
            } else if (i4 == 4) {
                f = flexLine.mItemCount != 0 ? ((float) (width - flexLine.mMainSize)) / ((float) flexLine.mItemCount) : 0.0f;
                float f5 = f / 2.0f;
                f3 = ((float) paddingLeft) + f5;
                f2 = ((float) (width - paddingRight)) - f5;
            } else if (i4 == 5) {
                f = flexLine.mItemCount != 0 ? ((float) (width - flexLine.mMainSize)) / ((float) (flexLine.mItemCount + 1)) : 0.0f;
            ...
            float f6 = f3 - ((float) this.mAnchorInfo.mPerpendicularCoordinate);
            float f7 = f2 - ((float) this.mAnchorInfo.mPerpendicularCoordinate);
            float max = Math.max(f, 0.0f);
            int i6 = 0;
            itemCount = flexLine.getItemCount();
            i = i3;
            while (i < i3 + itemCount) {
                ...
                if (flexItemAt != null) {
                    ...
                    float leftDecorationWidth = f6 + ((float) (layoutParams2.leftMargin + getLeftDecorationWidth(flexItemAt)));
                    float rightDecorationWidth = f7 - ((float) (layoutParams2.rightMargin + getRightDecorationWidth(flexItemAt)));
                    ...
                    i6 = i6;
                    f6 = leftDecorationWidth + ((float) (flexItemAt.getMeasuredWidth() + layoutParams.rightMargin + getRightDecorationWidth(flexItemAt))) + max;
                    f7 = rightDecorationWidth - (((float) ((flexItemAt.getMeasuredWidth() + layoutParams.leftMargin) + getLeftDecorationWidth(flexItemAt))) + max);
                }
                i++;
                i5 = 1;
            }
    ...
    private int layoutFlexLineMainAxisVertical(FlexLine flexLine, LayoutState layoutState) {
        ...
        if (i6 != 0) {
            if (i6 == 1) {
                float f4 = (float) ((height - flexLine.mMainSize) + paddingBottom);
                f = 0.0f;
                f2 = (float) (flexLine.mMainSize - paddingTop);
                f3 = f4;
            } else if (i6 == 2) {
                f3 = ((float) paddingTop) + (((float) (height - flexLine.mMainSize)) / 2.0f);
                f2 = ((float) (height - paddingBottom)) - (((float) (height - flexLine.mMainSize)) / 2.0f);
            } else if (i6 == 3) {
                f3 = (float) paddingTop;
                f = ((float) (height - flexLine.mMainSize)) / (flexLine.mItemCount != 1 ? (float) (flexLine.mItemCount - 1) : 1.0f);
                f2 = (float) (height - paddingBottom);
            } else if (i6 == 4) {
                f = flexLine.mItemCount != 0 ? ((float) (height - flexLine.mMainSize)) / ((float) flexLine.mItemCount) : 0.0f;
                float f5 = f / 2.0f;
                f3 = ((float) paddingTop) + f5;
                f2 = ((float) (height - paddingBottom)) - f5;
            } else if (i6 == 5) {
                f = flexLine.mItemCount != 0 ? ((float) (height - flexLine.mMainSize)) / ((float) (flexLine.mItemCount + 1)) : 0.0f;
            ...
            while (i < i5 + itemCount) {
                ...
                if (flexItemAt == null) {
                    ...
                    float topDecorationHeight = f6 + ((float) (layoutParams.topMargin + getTopDecorationHeight(flexItemAt)));
                    float bottomDecorationHeight = f7 - ((float) (layoutParams.rightMargin + getBottomDecorationHeight(flexItemAt)));
                    if (layoutState.mLayoutDirection == 1) {
                        calculateItemDecorationsForChild(flexItemAt, TEMP_RECT);
                        addView(flexItemAt);
                    } else {
                    ...
                    i7 = i7;
                    f6 = topDecorationHeight + ((float) (view.getMeasuredHeight() + layoutParams.topMargin + getBottomDecorationHeight(view))) + max;
                    f7 = bottomDecorationHeight - (((float) ((view.getMeasuredHeight() + layoutParams.bottomMargin) + getTopDecorationHeight(view))) + max);
                }
                i = i2 + 1;
            }
            layoutState.mFlexLinePosition += this.mLayoutState.mLayoutDirection;
