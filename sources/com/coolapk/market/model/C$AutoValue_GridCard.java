...
abstract class C$AutoValue_GridCard extends C$$AutoValue_GridCard {
    ...
    public static final class GsonTypeAdapter extends TypeAdapter<GridCard> {
        ...
        public void write(JsonWriter jsonWriter, GridCard gridCard) throws IOException {
            if (gridCard == null) {
            ...
            this.entityTypeNameAdapter.write(jsonWriter, gridCard.getEntityTypeName());
            jsonWriter.name("entityTemplate");
            this.entityTemplateAdapter.write(jsonWriter, gridCard.getEntityTemplate());
            jsonWriter.name("entityId");
            this.entityIdAdapter.write(jsonWriter, gridCard.getEntityId());
            jsonWriter.name("entityFixed");
            this.entityFixedAdapter.write(jsonWriter, gridCard.getEntityFixed());
            jsonWriter.name("pic");
            this.picAdapter.write(jsonWriter, gridCard.getPic());
            jsonWriter.name("logo");
            this.logoAdapter.write(jsonWriter, gridCard.getLogo());
            jsonWriter.name("id");
            this.idAdapter.write(jsonWriter, gridCard.getId());
            jsonWriter.name("extraData");
            this.extraDataAdapter.write(jsonWriter, gridCard.getExtraData());
            jsonWriter.name("dateline");
            this.datelineAdapter.write(jsonWriter, gridCard.getDateline());
            jsonWriter.name("lastupdate");
            this.lastUpdateAdapter.write(jsonWriter, gridCard.getLastUpdate());
            jsonWriter.name("title");
            this.titleAdapter.write(jsonWriter, gridCard.getTitle());
            jsonWriter.name("url");
            this.urlAdapter.write(jsonWriter, gridCard.getUrl());
            jsonWriter.name("description");
            this.descriptionAdapter.write(jsonWriter, gridCard.getDescription());
            jsonWriter.name("subTitle");
            this.subTitleAdapter.write(jsonWriter, gridCard.getSubTitle());
            jsonWriter.name("entities");
            this.entitiesAdapter.write(jsonWriter, gridCard.getEntities());
            jsonWriter.endObject();
        }

        @Override // com.google.gson.TypeAdapter
        public GridCard read(JsonReader jsonReader) throws IOException {
