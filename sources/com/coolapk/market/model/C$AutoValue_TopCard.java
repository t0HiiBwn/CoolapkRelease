...
abstract class C$AutoValue_TopCard extends C$$AutoValue_TopCard {
    C$AutoValue_TopCard(String str, String str2, String str3, Integer num, String str4, String str5, String str6, Long l, Long l2, String str7, String str8, String str9, String str10, String str11, String str12, List<ServiceApp> list) {
        super(str, str2, str3, num, str4, str5, str6, l, l2, str7, str8, str9, str10, str11, str12, list);
    }
    ...
    public static final class GsonTypeAdapter extends TypeAdapter<TopCard> {
        ...
        public TopCard read(JsonReader jsonReader) throws IOException {
            ...
            return new AutoValue_TopCard(str23, str13, str14, num2, str15, str16, str17, l3, l4, str18, str19, str20, str21, str22, str24, list);
        }
    }
}
