...
final class AutoValue_Feed extends C$AutoValue_Feed {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeList(getIncludeGoods());
        if (getFid() == null) {
            parcel.writeInt(1);
        } else {
            parcel.writeInt(0);
