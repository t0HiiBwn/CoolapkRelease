...
abstract class C$AutoValue_AlbumCard extends C$$AutoValue_AlbumCard {
    C$AutoValue_AlbumCard(String str, String str2, String str3, Integer num, String str4, String str5, String str6, String str7, String str8, Long l, Long l2, String str9, String str10, String str11, List<Album> list) {
    ...
    public static final class GsonTypeAdapter extends TypeAdapter<AlbumCard> {
        ...
        private List<Album> defaultEntities = Collections.emptyList();
        ...
        public GsonTypeAdapter(Gson gson) {
            ...
            this.entitiesAdapter = gson.getAdapter(TypeToken.getParameterized(List.class, Album.class));
        }
        ...
        public GsonTypeAdapter setDefaultEntities(List<Album> list) {
        ...
        public void write(JsonWriter jsonWriter, AlbumCard albumCard) throws IOException {
            ...
            this.entityTemplateAdapter.write(jsonWriter, albumCard.getEntityTemplate());
            jsonWriter.name("entityId");
            this.entityIdAdapter.write(jsonWriter, albumCard.getEntityId());
            jsonWriter.name("entityFixed");
            this.entityFixedAdapter.write(jsonWriter, albumCard.getEntityFixed());
            jsonWriter.name("pic");
            this.picAdapter.write(jsonWriter, albumCard.getPic());
            jsonWriter.name("logo");
            this.logoAdapter.write(jsonWriter, albumCard.getLogo());
            jsonWriter.name("subTitle");
            this.subTitleAdapter.write(jsonWriter, albumCard.getSubTitle());
            jsonWriter.name("id");
            this.idAdapter.write(jsonWriter, albumCard.getId());
            jsonWriter.name("extraData");
            this.extraDataAdapter.write(jsonWriter, albumCard.getExtraData());
            jsonWriter.name("dateline");
            this.datelineAdapter.write(jsonWriter, albumCard.getDateline());
            jsonWriter.name("lastupdate");
            this.lastUpdateAdapter.write(jsonWriter, albumCard.getLastUpdate());
        ...
        public AlbumCard read(JsonReader jsonReader) throws IOException {
            ...
            List<Album> list = this.defaultEntities;
            String str12 = str2;
            String str13 = str3;
            Integer num2 = num;
            String str14 = str4;
            ...
            return new AutoValue_AlbumCard(str22, str12, str13, num2, str14, str15, str16, str17, str18, l3, l4, str19, str20, str21, list);
        }
    }
}
