...
abstract class C$AutoValue_LinkCard extends C$$AutoValue_LinkCard {
    ...
    public static final class GsonTypeAdapter extends TypeAdapter<LinkCard> {
        private final TypeAdapter<Long> datelineAdapter;
        private Long defaultDateline = null;
        private String defaultDescription = null;
        private List<Link> defaultEntities = Collections.emptyList();
        ...
        private final TypeAdapter<List<Link>> entitiesAdapter;
        ...
        public GsonTypeAdapter(Gson gson) {
            ...
            this.entitiesAdapter = gson.getAdapter(TypeToken.getParameterized(List.class, Link.class));
        }
        ...
        public GsonTypeAdapter setDefaultEntities(List<Link> list) {
            this.defaultEntities = list;
            return this;
        }

        public void write(JsonWriter jsonWriter, LinkCard linkCard) throws IOException {
            if (linkCard == null) {
            ...
            this.entityTypeNameAdapter.write(jsonWriter, linkCard.getEntityTypeName());
            jsonWriter.name("entityTemplate");
            this.entityTemplateAdapter.write(jsonWriter, linkCard.getEntityTemplate());
            jsonWriter.name("entityId");
            this.entityIdAdapter.write(jsonWriter, linkCard.getEntityId());
            jsonWriter.name("entityFixed");
            this.entityFixedAdapter.write(jsonWriter, linkCard.getEntityFixed());
            jsonWriter.name("pic");
            this.picAdapter.write(jsonWriter, linkCard.getPic());
            jsonWriter.name("logo");
            this.logoAdapter.write(jsonWriter, linkCard.getLogo());
            jsonWriter.name("subTitle");
            this.subTitleAdapter.write(jsonWriter, linkCard.getSubTitle());
            jsonWriter.name("id");
            this.idAdapter.write(jsonWriter, linkCard.getId());
            jsonWriter.name("extraData");
            this.extraDataAdapter.write(jsonWriter, linkCard.getExtraData());
            jsonWriter.name("dateline");
            this.datelineAdapter.write(jsonWriter, linkCard.getDateline());
            jsonWriter.name("lastupdate");
            this.lastUpdateAdapter.write(jsonWriter, linkCard.getLastUpdate());
            jsonWriter.name("title");
            this.titleAdapter.write(jsonWriter, linkCard.getTitle());
            jsonWriter.name("url");
            this.urlAdapter.write(jsonWriter, linkCard.getUrl());
            jsonWriter.name("description");
            this.descriptionAdapter.write(jsonWriter, linkCard.getDescription());
            jsonWriter.name("entities");
            this.entitiesAdapter.write(jsonWriter, linkCard.getEntities());
            jsonWriter.endObject();
        }

        @Override // com.google.gson.TypeAdapter
        public LinkCard read(JsonReader jsonReader) throws IOException {
            ...
            List<Link> list = this.defaultEntities;
            String str12 = str2;
            String str13 = str3;
            Integer num2 = num;
            String str14 = str4;
