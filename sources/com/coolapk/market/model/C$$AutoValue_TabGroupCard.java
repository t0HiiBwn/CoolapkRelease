...
abstract class C$$AutoValue_TabGroupCard extends TabGroupCard {
    private final Long dateline;
    private final String description;
    private final List<GridCard> entities;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TabGroupCard)) {
            return false;
        }
        TabGroupCard tabGroupCard = (TabGroupCard) obj;
        String str = this.entityTypeName;
        if (str != null ? str.equals(tabGroupCard.getEntityTypeName()) : tabGroupCard.getEntityTypeName() == null) {
            String str2 = this.entityTemplate;
            if (str2 != null ? str2.equals(tabGroupCard.getEntityTemplate()) : tabGroupCard.getEntityTemplate() == null) {
                String str3 = this.entityId;
                if (str3 != null ? str3.equals(tabGroupCard.getEntityId()) : tabGroupCard.getEntityId() == null) {
                    Integer num = this.entityFixed;
                    if (num != null ? num.equals(tabGroupCard.getEntityFixed()) : tabGroupCard.getEntityFixed() == null) {
                        String str4 = this.pic;
                        if (str4 != null ? str4.equals(tabGroupCard.getPic()) : tabGroupCard.getPic() == null) {
                            String str5 = this.logo;
                            if (str5 != null ? str5.equals(tabGroupCard.getLogo()) : tabGroupCard.getLogo() == null) {
                                String str6 = this.subTitle;
                                if (str6 != null ? str6.equals(tabGroupCard.getSubTitle()) : tabGroupCard.getSubTitle() == null) {
                                    String str7 = this.id;
                                            ...
                                            if (l != null ? l.equals(tabGroupCard.getDateline()) : tabGroupCard.getDateline() == null) {
                                                ...
                                                if (l2 != null ? l2.equals(tabGroupCard.getLastUpdate()) : tabGroupCard.getLastUpdate() == null) {
                                                    ...
                                                    if (str9 != null ? str9.equals(tabGroupCard.getTitle()) : tabGroupCard.getTitle() == null) {
                                                        ...
                                                        if (str10 != null ? str10.equals(tabGroupCard.getUrl()) : tabGroupCard.getUrl() == null) {
                                                            String str11 = this.description;
                                                            if (str11 != null ? str11.equals(tabGroupCard.getDescription()) : tabGroupCard.getDescription() == null) {
                                                                List<GridCard> list = this.entities;
                                                                if (list == null) {
                                                                    if (tabGroupCard.getEntities() == null) {
                                                                        return true;
                                                                    }
                                                                } else if (list.equals(tabGroupCard.getEntities())) {
                                                                    return true;
                                                                }
                                                            }
                                                        }
