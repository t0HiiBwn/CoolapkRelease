...
abstract class C$$AutoValue_FunThings extends FunThings {
    ...
    C$$AutoValue_FunThings(String str, String str2, String str3, Integer num, String str4, String str5, String str6, String str7, String str8, Long l, Long l2, String str9, UserInfo userInfo2, String str10, String str11, String str12, String str13, String str14, String str15, int i, String str16, int i2, int i3, int i4, int i5, int i6, int i7, int i8, String str17, int i9, int i10, Long l3, UserAction userAction2, String str18) {
    ...
    public int hashCode() {
        ...
        int hashCode21 = (((((hashCode20 ^ (str17 == null ? 0 : str17.hashCode())) * 1000003) ^ this.isOpen) * 1000003) ^ this.recommend) * 1000003;
    ...
    static final class Builder extends FunThings.Builder {
        ...
        @Override // com.coolapk.market.model.FunThings.Builder
        public FunThings.Builder dateline(Long l) {
            this.dateline = l;
            return this;
        }

        @Override // com.coolapk.market.model.FunThings.Builder
        public FunThings.Builder lastUpdate(Long l) {
            this.lastUpdate = l;
            return this;
        }
        ...
        @Override // com.coolapk.market.model.FunThings.Builder
        public FunThings.Builder createdate(Long l) {
            this.createdate = l;
            return this;
        }
