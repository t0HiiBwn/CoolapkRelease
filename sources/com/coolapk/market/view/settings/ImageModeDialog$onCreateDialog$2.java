...
final class ImageModeDialog$onCreateDialog$2 implements View.OnClickListener {
    final /* synthetic */ LayoutImageModeBinding $binding;
    final /* synthetic */ ImageModeDialog this$0;

    ImageModeDialog$onCreateDialog$2(ImageModeDialog imageModeDialog, LayoutImageModeBinding layoutImageModeBinding) {
    ...
    public final void onClick(View view) {
        this.$binding.radioGroup.check(2131363189);
        this.this$0.dismiss();
    }
}
