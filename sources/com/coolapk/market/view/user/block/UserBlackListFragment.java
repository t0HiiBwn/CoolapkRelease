...
public final class UserBlackListFragment extends EntityListFragment {
    ...
    public Observable<List<Entity>> onCreateRequest(boolean z, int i) {
        ...
        Observable<R> compose = instance.getMyBlackListUser(i, entityId, str).compose(RxUtils.apiCommonToData());
