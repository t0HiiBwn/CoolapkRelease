...
final class LiveActivity$updateUI$3 extends Lambda implements Function0<Fragment> {
    final /* synthetic */ LiveActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LiveActivity$updateUI$3(LiveActivity liveActivity) {
        super(0);
    ...
    public final Fragment invoke() {
        LiveDiscussFragment.Companion companion = LiveDiscussFragment.Companion;
