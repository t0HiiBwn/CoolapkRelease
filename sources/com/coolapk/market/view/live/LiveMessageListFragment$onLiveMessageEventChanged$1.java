...
final class LiveMessageListFragment$onLiveMessageEventChanged$1 extends Lambda implements Function1<Parcelable, Boolean> {
    final /* synthetic */ LiveMessageEvent $event;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LiveMessageListFragment$onLiveMessageEventChanged$1(LiveMessageEvent liveMessageEvent) {
        super(1);
