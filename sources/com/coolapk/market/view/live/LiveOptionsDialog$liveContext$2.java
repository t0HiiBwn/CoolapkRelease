...
final class LiveOptionsDialog$liveContext$2 extends Lambda implements Function0<LiveContext> {
    final /* synthetic */ LiveOptionsDialog this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LiveOptionsDialog$liveContext$2(LiveOptionsDialog liveOptionsDialog) {
        super(0);
