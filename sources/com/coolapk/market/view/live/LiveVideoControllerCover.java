...
public final class LiveVideoControllerCover extends BaseControlCover {
    ...
    public LiveVideoControllerCover(Context context, ItemLiveVideoViewPartBinding itemLiveVideoViewPartBinding) {
        ...
        this.hideControllerRunnable = new LiveVideoControllerCover$hideControllerRunnable$1(this);
    }
    ...
    private final void enqueueLiveDelayHideController(boolean z) {
        if (z) {
            ...
            if (handler3 != null) {
                handler3.postDelayed(this.hideControllerRunnable, 5000);
                return;
            }
            return;
        }
        ...
        if (handler4 != null) {
            handler4.removeCallbacks(this.hideControllerRunnable);
        }
    }
    ...
    public void setControllerState(boolean z, ValueAnimator valueAnimator) {
        ...
        enqueueLiveDelayHideController(z);
        if (z) {
