...
public final class LivePresenter implements LiveContract.Presenter {
    ...
    public final void setNewResult(Result<Live> result) {
        Intrinsics.checkNotNullParameter(result, "result");
        this.live = result.getData();
        this.videoLineMap.clear();
        this.view.onLiveLoaded(result, null);
    }
