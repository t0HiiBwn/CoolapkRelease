...
final class MeUserMenuChildViewHolder$bindTo$2 implements DragAndDropHelper.DragAndDrawListener {
    final /* synthetic */ UserMenu $userMenu;
    final /* synthetic */ MeUserMenuChildViewHolder this$0;

    MeUserMenuChildViewHolder$bindTo$2(MeUserMenuChildViewHolder meUserMenuChildViewHolder, UserMenu userMenu) {
    ...
    public final void onTargetDrop(View view) {
        this.this$0.getPresenter().onDotDragAway(this.$userMenu.getType());
    }
}
