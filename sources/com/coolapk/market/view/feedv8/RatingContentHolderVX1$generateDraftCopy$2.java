...
final class RatingContentHolderVX1$generateDraftCopy$2 extends Lambda implements Function1<ImageUrl, CharSequence> {
    public static final RatingContentHolderVX1$generateDraftCopy$2 INSTANCE = new RatingContentHolderVX1$generateDraftCopy$2();

    RatingContentHolderVX1$generateDraftCopy$2() {
        super(1);
    }
