...
final class TopicPickerActivity$setupUi$4 implements View.OnClickListener {
    final /* synthetic */ TopicPickerActivity this$0;

    TopicPickerActivity$setupUi$4(TopicPickerActivity topicPickerActivity) {
        this.this$0 = topicPickerActivity;
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(View view) {
        AutoCompleteTextView autoCompleteTextView = TopicPickerActivity.access$getBinding$p(this.this$0).searchHeader.searchText;
        ...
        if (text.length() > 0) {
            AutoCompleteTextView autoCompleteTextView2 = TopicPickerActivity.access$getBinding$p(this.this$0).searchHeader.searchText;
