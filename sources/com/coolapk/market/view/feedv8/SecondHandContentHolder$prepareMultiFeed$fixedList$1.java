...
final class SecondHandContentHolder$prepareMultiFeed$fixedList$1<T, R> implements Func1<ImageUrl, ImageUrl> {
    final /* synthetic */ Map $oldImageMap;

    SecondHandContentHolder$prepareMultiFeed$fixedList$1(Map map) {
