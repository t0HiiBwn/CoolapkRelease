...
final class ArticleFeedContentHolder2$onCreateContentView$3 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ ArticleFeedContentHolder2 this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ArticleFeedContentHolder2$onCreateContentView$3(ArticleFeedContentHolder2 articleFeedContentHolder2) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new ArticleEditFeedTextHolder(view, this.this$0.getArticleViewModel());
    }
}
