...
public final class RoughDraftHelper$setEditingDraftSaveToDisk$$inlined$sortByDescending$1<T> implements Comparator<T> {
    @Override // java.util.Comparator
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues(Long.valueOf(t2.getCreateTime()), Long.valueOf(t.getCreateTime()));
    }
}
