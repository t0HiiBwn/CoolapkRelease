...
final class RatingContentHolderVX1$initPhotoViewsAndAdapters$6<T1, T2> implements Action2<Integer, List<String>> {
    final /* synthetic */ RatingContentHolderVX1 this$0;

    RatingContentHolderVX1$initPhotoViewsAndAdapters$6(RatingContentHolderVX1 ratingContentHolderVX1) {
        this.this$0 = ratingContentHolderVX1;
    }

    public final void call(Integer num, List<String> list) {
        this.this$0.getBinding$presentation_coolapkAppRelease().summaryAddPhotoView.performClick();
    }
}
