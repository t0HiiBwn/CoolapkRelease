...
final class RatingContentHolderVX1$generateDraftCopy$1 extends Lambda implements Function1<ImageUrl, CharSequence> {
    public static final RatingContentHolderVX1$generateDraftCopy$1 INSTANCE = new RatingContentHolderVX1$generateDraftCopy$1();

    RatingContentHolderVX1$generateDraftCopy$1() {
        super(1);
    }
