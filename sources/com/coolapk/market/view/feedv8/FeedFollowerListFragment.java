...
public final class FeedFollowerListFragment extends EntityListFragment {
    ...
    public Observable<List<Entity>> onCreateRequest(boolean z, int i) {
        ...
        Observable<R> compose = instance.getQuestionFollowerList(string, i, uid, str).compose(RxUtils.apiCommonToData());
