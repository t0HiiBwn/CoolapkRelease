...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002¨\u0006\u0003"}, d2 = {"<anonymous>", "", "call", "com/coolapk/market/view/feedv8/SecondHandContentHolder$onCreateContentView$1$1"}, k = 3, mv = {1, 4, 2})
/* compiled from: SecondHandContentHolder.kt */
final class SecondHandContentHolder$onCreateContentView$$inlined$apply$lambda$1 implements Action0 {
    final /* synthetic */ PickPhotoAdapterV8 $this_apply;
    final /* synthetic */ SecondHandContentHolder this$0;

    SecondHandContentHolder$onCreateContentView$$inlined$apply$lambda$1(PickPhotoAdapterV8 pickPhotoAdapterV8, SecondHandContentHolder secondHandContentHolder) {
        this.$this_apply = pickPhotoAdapterV8;
    ...
    public final void call() {
        if (this.this$0.getUiConfig().isPickPhotoItemVisible()) {
            ...
            if (this.this$0.getUiConfig().isSecondHandViewVisible()) {
                this.$this_apply.bindIndicator((BindingViewHolder) this.this$0.getBinding$presentation_coolapkAppRelease().recyclerView.findViewHolderForAdapterPosition(0));
            }
        }
    }
}
