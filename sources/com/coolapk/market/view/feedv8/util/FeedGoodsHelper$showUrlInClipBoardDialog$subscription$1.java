...
final class FeedGoodsHelper$showUrlInClipBoardDialog$subscription$1<T1, T2, R> implements Func2<FeedGoods, Long, FeedGoods> {
    public static final FeedGoodsHelper$showUrlInClipBoardDialog$subscription$1 INSTANCE = new FeedGoodsHelper$showUrlInClipBoardDialog$subscription$1();

    FeedGoodsHelper$showUrlInClipBoardDialog$subscription$1() {
    }
