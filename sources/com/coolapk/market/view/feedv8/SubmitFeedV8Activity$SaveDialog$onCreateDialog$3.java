...
final class SubmitFeedV8Activity$SaveDialog$onCreateDialog$3 implements DialogInterface.OnClickListener {
    final /* synthetic */ SubmitFeedV8Activity.SaveDialog this$0;

    SubmitFeedV8Activity$SaveDialog$onCreateDialog$3(SubmitFeedV8Activity.SaveDialog saveDialog) {
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        ...
        StatisticHelper.Companion.getInstance().recordSaveDraftEvent("放弃保存草稿");
