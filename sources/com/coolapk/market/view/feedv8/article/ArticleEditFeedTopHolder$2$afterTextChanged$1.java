...
final class ArticleEditFeedTopHolder$2$afterTextChanged$1 extends Lambda implements Function1<ArticleModel, ArticleModel> {
    final /* synthetic */ Editable $s;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ArticleEditFeedTopHolder$2$afterTextChanged$1(Editable editable) {
        super(1);
        this.$s = editable;
    }
