...
final class VoteExtraView$onItemClick$1 extends Lambda implements Function1<DialogUtil.DialogItemData, Unit> {
    final /* synthetic */ VoteExtraView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VoteExtraView$onItemClick$1(VoteExtraView voteExtraView) {
        super(1);
