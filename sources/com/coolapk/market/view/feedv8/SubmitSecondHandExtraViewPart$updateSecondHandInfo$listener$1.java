...
final class SubmitSecondHandExtraViewPart$updateSecondHandInfo$listener$1 implements View.OnClickListener {
    final /* synthetic */ SubmitSecondHandDealExtraChildBinding $binding;
    final /* synthetic */ boolean $inChangeMode;
    final /* synthetic */ SubmitSecondHandExtraViewPart this$0;

    SubmitSecondHandExtraViewPart$updateSecondHandInfo$listener$1(SubmitSecondHandExtraViewPart submitSecondHandExtraViewPart, boolean z, SubmitSecondHandDealExtraChildBinding submitSecondHandDealExtraChildBinding) {
        ...
        if (!this.$inChangeMode) {
            ...
            switch (view.getId()) {
                case 2131363494:
                    ...
                    CheckedTextView checkedTextView2 = this.$binding.switchRight;
                    Intrinsics.checkNotNullExpressionValue(checkedTextView2, "binding.switchRight");
                ...
                case 2131363495:
                    ...
                    CheckedTextView checkedTextView4 = this.$binding.switchRight;
                    Intrinsics.checkNotNullExpressionValue(checkedTextView4, "binding.switchRight");
                    checkedTextView4.setSelected(true);
                    this.this$0.updateSecondHandSthType(1);
                    this.this$0.bindDataSecondHandType(this.$binding);
                    return;
                default:
                    return;
