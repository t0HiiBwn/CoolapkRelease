...
final class GoodsContentHolder$initCheckBoxViews$3 implements CompoundButton.OnCheckedChangeListener {
    final /* synthetic */ Ref.BooleanRef $handleCheckBox;
    final /* synthetic */ GoodsContentHolder$initCheckBoxViews$1 $updateBuyStatus$1;

    GoodsContentHolder$initCheckBoxViews$3(Ref.BooleanRef booleanRef, GoodsContentHolder$initCheckBoxViews$1 goodsContentHolder$initCheckBoxViews$1) {
    ...
    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        if (this.$handleCheckBox.element) {
            this.$updateBuyStatus$1.invoke(false);
        }
    }
}
