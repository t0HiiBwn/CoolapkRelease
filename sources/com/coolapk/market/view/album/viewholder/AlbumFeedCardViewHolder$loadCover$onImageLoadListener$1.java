...
final class AlbumFeedCardViewHolder$loadCover$onImageLoadListener$1 implements OnImageLoadListener {
    final /* synthetic */ AlbumFeedCardViewHolder this$0;

    AlbumFeedCardViewHolder$loadCover$onImageLoadListener$1(AlbumFeedCardViewHolder albumFeedCardViewHolder) {
    ...
    public final void onLoadComplete(String str, Drawable drawable, View view, boolean z, Throwable th) {
        TextView textView = ((ItemAlbumWithAvatarBinding) this.this$0.getBinding()).titleView;
        Intrinsics.checkNotNullExpressionValue(textView, "binding.titleView");
        textView.setVisibility(0);
        TextView textView2 = ((ItemAlbumWithAvatarBinding) this.this$0.getBinding()).infoView;
        Intrinsics.checkNotNullExpressionValue(textView2, "binding.infoView");
        textView2.setVisibility(0);
        LinearLayout linearLayout = ((ItemAlbumWithAvatarBinding) this.this$0.getBinding()).iconList;
