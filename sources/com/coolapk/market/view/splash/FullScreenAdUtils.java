    ...
    public static final boolean shouldShowAd(Context context) {
        ...
        if (!(list instanceof Collection) || !list.isEmpty()) {
            ...
            while (true) {
                ...
                try {
                    z2 = context.getPackageManager().getApplicationInfo(it2.next(), 0).enabled;
                    continue;
        ...
        try {
            ...
            if (optString.length() == 0) {
                fullScreenAdUtils2.logFile("Splash Ad type 为空");
            ...
            if (!loginSession.isAdmin()) {
                ...
                if (j <= currentTimeMillis && j + TimeUnit.DAYS.toMillis(3) >= currentTimeMillis) {
            ...
            if (preferencesLong < DateUtils.getWeekAgoTime() || preferencesLong > currentTimeMillis) {
                ...
                int optInt = appSetting2.getConfigJson().optInt("SplashAd.Expires", 300);
