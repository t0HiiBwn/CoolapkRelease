...
public final class BaseFullScreenAdActivity$loadAd$1 implements OnAdLoadListener {
    ...
    BaseFullScreenAdActivity$loadAd$1(BaseFullScreenAdActivity baseFullScreenAdActivity, AdSource adSource) {
    ...
    public void onLoadSuccess(Object obj) {
        ...
        View splashView = this.$adSource.getSplashView();
        ...
        Pair<Integer, Integer> splashSize = adSource.getSplashSize(viewGroup);
        int calculateBottomHeight = FullScreenAdUtils.INSTANCE.calculateBottomHeight(this.this$0, Intrinsics.areEqual(this.$adSource.getName(), "COOLAPK_SPLASH"), (splashSize == null || (first = splashSize.getFirst()) == null) ? 1080 : first.intValue(), (splashSize == null || (second = splashSize.getSecond()) == null) ? 1920 : second.intValue());
