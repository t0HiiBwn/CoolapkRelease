...
final class DyhArticleDetailFragment$onActivityCreated$1 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ DyhArticleDetailFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DyhArticleDetailFragment$onActivityCreated$1(DyhArticleDetailFragment dyhArticleDetailFragment) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new DyhArticleDetailViewHolder(view, this.this$0.getBindingComponent(), null);
    }
}
