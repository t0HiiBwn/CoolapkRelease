...
final class EntityListFragment$onRegisterCards$104 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ EntityListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EntityListFragment$onRegisterCards$104(EntityListFragment entityListFragment) {
        super(1);
