...
final class EntityListFragment$onRegisterCards$63 extends Lambda implements Function1<View, BindingViewHolder> {
    final /* synthetic */ EntityListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EntityListFragment$onRegisterCards$63(EntityListFragment entityListFragment) {
        super(1);
    ...
    public final BindingViewHolder invoke(View view) {
        ...
        return new ImageXScrollCardViewHolder(view, this.this$0.getBindingComponent(), 1.0f);
    }
}
