...
final class EntityListFragment$onRegisterCards$105 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ EntityListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EntityListFragment$onRegisterCards$105(EntityListFragment entityListFragment) {
        super(1);
