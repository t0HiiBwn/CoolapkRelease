...
public final class UpgradeCardViewHolder$$special$$inlined$sortByDescending$1<T> implements Comparator<T> {
    ...
    public final int compare(T t, T t2) {
        ...
        Intrinsics.checkNotNullExpressionValue(upgradeInfo, "it.upgradeInfo!!");
        T t4 = t;
        ...
        Intrinsics.checkNotNullExpressionValue(upgradeInfo2, "it.upgradeInfo!!");
