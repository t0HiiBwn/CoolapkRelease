...
final class ContactPickActivityV9$setupHeader$4 implements View.OnClickListener {
    final /* synthetic */ ContactPickActivityV9 this$0;

    ContactPickActivityV9$setupHeader$4(ContactPickActivityV9 contactPickActivityV9) {
    ...
    public final void onClick(View view) {
        ...
        if (text.length() > 0) {
            AutoCompleteTextView autoCompleteTextView2 = ContactPickActivityV9.access$getBinding$p(this.this$0).searchHeader.searchText;
