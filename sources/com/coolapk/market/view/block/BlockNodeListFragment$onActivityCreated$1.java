...
final class BlockNodeListFragment$onActivityCreated$1 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ FragmentBindingComponent $bindingComponent;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BlockNodeListFragment$onActivityCreated$1(FragmentBindingComponent fragmentBindingComponent) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new BlockNodeListFragment.BlockNodeViewHolder(view, this.$bindingComponent, null);
    }
}
