...
final class BaseLeftCategoryFragment$onActivityCreated$2 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ BaseLeftCategoryFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BaseLeftCategoryFragment$onActivityCreated$2(BaseLeftCategoryFragment baseLeftCategoryFragment) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new BaseLeftCategoryFragment.ProductBrandIndicatorHolder(this.this$0, view);
    }
}
