...
public final class ProductBrandListActivity extends AlphaToolbarActivity {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Lcom/coolapk/market/view/product/ProductBrandListActivity$Companion;", "", "()V", "EXTRA_BRAND_LIST", "", "presentation_coolapkAppRelease"}, k = 1, mv = {1, 4, 2})
    /* compiled from: ProductBrandListActivity.kt */
    ...
    private final void loadProductList() {
        if (!isLoading()) {
            ...
            this.subscription = instance.getProductBrandList().compose(RxUtils.apiCommonToData()).subscribe((Subscriber<? super R>) new ProductBrandListActivity$loadProductList$1(this));
        }
    }
    ...
    public Fragment onCreateFragment() {
        ...
        return ProductBrandListFragment.Companion.newInstance(arrayList);
    }
}
