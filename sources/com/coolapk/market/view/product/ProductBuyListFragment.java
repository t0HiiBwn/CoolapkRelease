...
@Metadata(bv = {1, 0, 3}, d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\u0018\u0000 \u000f2\u00020\u0001:\u0001\u000fB\u0005¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0003\u001a\u00020\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006H\u0016J$\u0010\u0007\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\n0\t0\b2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000eH\u0016¨\u0006\u0010"}, d2 = {"Lcom/coolapk/market/view/product/ProductBuyListFragment;", "Lcom/coolapk/market/view/product/SimpleUserListFragment;", "()V", "onActivityCreated", "", "savedInstanceState", "Landroid/os/Bundle;", "onCreateRequest", "Lrx/Observable;", "", "Lcom/coolapk/market/model/User;", "isRefresh", "", "page", "", "Companion", "presentation_coolapkAppRelease"}, k = 1, mv = {1, 4, 2})
/* compiled from: ProductWishListFragment.kt */
public final class ProductBuyListFragment extends SimpleUserListFragment {
    public static final Companion Companion = new Companion(null);
    public static final String EXTRA_ID = "extra_id";

    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u0004R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\b"}, d2 = {"Lcom/coolapk/market/view/product/ProductBuyListFragment$Companion;", "", "()V", "EXTRA_ID", "", "newInstance", "Lcom/coolapk/market/view/product/ProductBuyListFragment;", "id", "presentation_coolapkAppRelease"}, k = 1, mv = {1, 4, 2})
    /* compiled from: ProductWishListFragment.kt */
    public static final class Companion {
        ...
        public final ProductBuyListFragment newInstance(String str) {
            Intrinsics.checkNotNullParameter(str, "id");
            ProductBuyListFragment productBuyListFragment = new ProductBuyListFragment();
            Bundle bundle = new Bundle();
            bundle.putString("extra_id", str);
            Unit unit = Unit.INSTANCE;
            productBuyListFragment.setArguments(bundle);
            return productBuyListFragment;
        }
    }
    ...
    public Observable<List<User>> onCreateRequest(boolean z, int i) {
        ...
        Observable<R> compose = instance.getProductBuyList(string, i, uid, str).compose(RxUtils.apiCommonToData());
