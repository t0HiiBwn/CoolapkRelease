...
final class ProductSeriesHorizonHolder$onClick$accepted$1 extends Lambda implements Function1<Throwable, Boolean> {
    final /* synthetic */ Product $product;
    final /* synthetic */ ProductSeriesHorizonHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ProductSeriesHorizonHolder$onClick$accepted$1(ProductSeriesHorizonHolder productSeriesHorizonHolder, Product product) {
        super(1);
    ...
    public final boolean invoke(Throwable th) {
        ...
        TextView textView = productSeriesHorizonHolder.binding.subtitleView1;
        Intrinsics.checkNotNullExpressionValue(textView, "binding.subtitleView1");
        FollowStyleTextView followStyleTextView = this.this$0.binding.actionButton1;
