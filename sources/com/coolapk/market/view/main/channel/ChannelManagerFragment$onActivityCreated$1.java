...
final class ChannelManagerFragment$onActivityCreated$1 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ ChannelManagerFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChannelManagerFragment$onActivityCreated$1(ChannelManagerFragment channelManagerFragment) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new ChannelTitleViewHolder(Container.Companion.with(this.this$0), view);
    }
}
