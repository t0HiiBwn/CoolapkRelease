...
public final class NavigationHelper {
    private final NavigationItem itemAppAndGame = new NavigationItem(2131887286, 2131231142, 2131231146, MarketFragmentV8.class);
    private final NavigationItem itemDiscovery = new NavigationItem(2131887306, 2131231262, 2131231263, DiscoveryFragmentV11.class);
    private final NavigationItem itemHome = new NavigationItem(2131887335, 2131231363, 2131231365, HomeFragmentV9.class);
    private final NavigationItem itemMine = new NavigationItem(2131887340, 2131231430, 2131231431, CenterV9Fragment.class);
    private final NavigationItem itemPhoneBa = new NavigationItem(2131887347, 2131231487, 2131231488, ProductFragmentVX.class);
