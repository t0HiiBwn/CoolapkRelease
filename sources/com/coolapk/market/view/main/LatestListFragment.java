...
public final class LatestListFragment extends ServiceAppTimeFragment {
    ...
    public Observable<List<Entity>> onCreateRequest(boolean z, int i) {
        ...
        Observable<R> map = instance.getLatestAppList(i, entityId, str).map(RxUtils.checkResultToData());
    ...
    protected String getTimeDescription(ServiceApp serviceApp) {
        ...
        String updateTimeDescription = DateUtils.getUpdateTimeDescription(getActivity(), serviceApp.getLastUpdate());
        Intrinsics.checkNotNullExpressionValue(updateTimeDescription, "DateUtils.getUpdateTimeD…y, serviceApp.lastUpdate)");
        return updateTimeDescription;
    }

    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0006\u0010\u0003\u001a\u00020\u0004¨\u0006\u0005"}, d2 = {"Lcom/coolapk/market/view/main/LatestListFragment$Companion;", "", "()V", "newInstance", "Lcom/coolapk/market/view/main/LatestListFragment;", "presentation_coolapkAppRelease"}, k = 1, mv = {1, 4, 2})
    /* compiled from: LatestListFragment.kt */
    public static final class Companion {
        ...
        public final LatestListFragment newInstance() {
