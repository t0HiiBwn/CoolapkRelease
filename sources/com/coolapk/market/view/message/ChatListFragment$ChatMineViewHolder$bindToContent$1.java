...
final class ChatListFragment$ChatMineViewHolder$bindToContent$1 implements View.OnLongClickListener {
    final /* synthetic */ Message $message;
    final /* synthetic */ ChatListFragment.ChatMineViewHolder this$0;

    ChatListFragment$ChatMineViewHolder$bindToContent$1(ChatListFragment.ChatMineViewHolder chatMineViewHolder, Message message) {
        this.this$0 = chatMineViewHolder;
    ...
    public final boolean onLongClick(View view) {
        ...
        TextView textView = ((ItemChatingMineBinding) this.this$0.getBinding()).textView;
