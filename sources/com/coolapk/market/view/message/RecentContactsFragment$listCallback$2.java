...
final class RecentContactsFragment$listCallback$2 extends Lambda implements Function0<AdapterListChangedCallback<ObservableList<Entity>>> {
    final /* synthetic */ RecentContactsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RecentContactsFragment$listCallback$2(RecentContactsFragment recentContactsFragment) {
        super(0);
    ...
    public final AdapterListChangedCallback<ObservableList<Entity>> invoke() {
        return new AdapterListChangedCallback<>(RecentContactsFragment.access$getAdapter$p(this.this$0));
    }
}
