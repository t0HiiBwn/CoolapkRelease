...
final class PictureCategoryDetailActivity$PictureTagListFragment$picType$2 extends Lambda implements Function0<String> {
    final /* synthetic */ PictureCategoryDetailActivity.PictureTagListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PictureCategoryDetailActivity$PictureTagListFragment$picType$2(PictureCategoryDetailActivity.PictureTagListFragment pictureTagListFragment) {
        super(0);
    ...
    public final String invoke() {
        String string = this.this$0.requireArguments().getString("TYPE");
