...
public final class ImageViewFragment$loadSource$2 extends CustomTarget<Drawable> {
    ...
    ImageViewFragment$loadSource$2(ImageViewFragment imageViewFragment) {
    ...
    public void onResourceReady(Drawable drawable, Transition<? super Drawable> transition) {
        ...
        if (photoView.getDrawable() == null) {
            ...
            LinearLayout linearLayout = ImageViewFragment.access$getPhotoBinding$p(imageViewFragment).frontView;
            Intrinsics.checkNotNullExpressionValue(linearLayout, "photoBinding.frontView");
            ImageViewFragment.alphaView$default(imageViewFragment, linearLayout, true, 0, 0, 12, null);
        }
    }
}
