...
final class SponsorSelfDrawViewHolder$updateContentView$3 extends Lambda implements Function1<Integer, Unit> {
    final /* synthetic */ SponsorSelfDrawViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SponsorSelfDrawViewHolder$updateContentView$3(SponsorSelfDrawViewHolder sponsorSelfDrawViewHolder) {
        super(1);
    ...
    public final void invoke(int i) {
        ...
        if (layoutParams != null) {
            ...
            maxWidthFrameLayout.getLayoutParams().height = i2;
            return;
        }
