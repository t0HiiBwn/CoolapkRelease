...
final class SponsorSelfDrawViewHolder$updateContentView$12 extends Lambda implements Function0<Unit> {
    ...
    SponsorSelfDrawViewHolder$updateContentView$12(SponsorSelfDrawViewHolder sponsorSelfDrawViewHolder, TTFeedAd tTFeedAd, List list) {
        super(0);
    ...
    public final void invoke() {
        ...
        this.$ad.registerViewForInteraction(SponsorSelfDrawViewHolder.access$getBinding$p(this.this$0).itemView, this.$imageViews, CollectionsKt.mutableListOf(linearLayout, root), null, SponsorSelfDrawViewHolder.access$getBinding$p(this.this$0).closeView, EntityAdHelperKt.getSIMPLE_TT_NATIVE_AD_LISTENER());
    }
}
