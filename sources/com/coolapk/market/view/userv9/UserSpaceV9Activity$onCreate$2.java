...
final class UserSpaceV9Activity$onCreate$2 implements DrawSystemBarFrameLayout.OnInsetChangeListener {
    final /* synthetic */ UserSpaceV9Activity this$0;

    UserSpaceV9Activity$onCreate$2(UserSpaceV9Activity userSpaceV9Activity) {
    ...
    public final void onInsetChange(Rect rect) {
        this.this$0.setPaddingBottom(rect.bottom);
    }
}
