...
public final class NodeFeedDialogInterceptor$buildSheetDataItem$1 implements SheetCallback {
    ...
    public SheetResult onSheetClick(SheetAction sheetAction) {
        ...
        return SheetResult.Companion.replace$default(SheetResult.Companion, this.this$0.buildChildSheetItems(this.$data), false, 2, null);
    }
}
