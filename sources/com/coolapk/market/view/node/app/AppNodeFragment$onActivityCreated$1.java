...
final class AppNodeFragment$onActivityCreated$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ NodeFeedDialogInterceptor $interceptor;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AppNodeFragment$onActivityCreated$1(NodeFeedDialogInterceptor nodeFeedDialogInterceptor) {
        super(0);
