...
public final class AppNodeViewPart$onBindToContent$$inlined$doOnLayout$2 implements View.OnLayoutChangeListener {
    final /* synthetic */ AppNodeViewPart this$0;

    public AppNodeViewPart$onBindToContent$$inlined$doOnLayout$2(AppNodeViewPart appNodeViewPart) {
    ...
    public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        CoolEllipsizeTextView coolEllipsizeTextView = ((AppNodeHeaderBinding) this.this$0.getBinding()).introduceView;
        Intrinsics.checkNotNullExpressionValue(coolEllipsizeTextView, "binding.introduceView");
        if (!coolEllipsizeTextView.isCollapsing()) {
            LinearLayout linearLayout = ((AppNodeHeaderBinding) this.this$0.getBinding()).introduceActionView;
            Intrinsics.checkNotNullExpressionValue(linearLayout, "binding.introduceActionView");
            linearLayout.setVisibility(8);
            ((AppNodeHeaderBinding) this.this$0.getBinding()).introductionLayout.setOnClickListener(null);
        }
    }
}
