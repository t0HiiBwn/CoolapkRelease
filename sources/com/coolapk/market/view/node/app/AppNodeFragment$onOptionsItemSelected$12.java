...
final class AppNodeFragment$onOptionsItemSelected$12 extends Lambda implements Function1<ServiceApp, Unit> {
    final /* synthetic */ AppNodeFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AppNodeFragment$onOptionsItemSelected$12(AppNodeFragment appNodeFragment) {
        super(1);
    ...
    public final void invoke(ServiceApp serviceApp) {
        ...
        ActionManager.startHistoryVersionActivity(this.this$0.getActivity(), serviceApp.getAppName(), serviceApp.getApkId(), serviceApp.getLogo());
    }
}
