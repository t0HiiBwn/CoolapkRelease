...
final class UserNodeRatingViewHolder$showAdminDialog$1 extends Lambda implements Function1<List<ActionItem>, Unit> {
    final /* synthetic */ NodeRating $data;
    final /* synthetic */ UserNodeRatingViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    UserNodeRatingViewHolder$showAdminDialog$1(UserNodeRatingViewHolder userNodeRatingViewHolder, NodeRating nodeRating) {
        super(1);
    ...
    public final void invoke(List<ActionItem> list) {
        ...
        MultiItemDialogFragmentKt.addItem(list, "删除评分", new Function0<Unit>(this) {
            /* class com.coolapk.market.view.node.rating.UserNodeRatingViewHolder$showAdminDialog$1.AnonymousClass1 */
            final /* synthetic */ UserNodeRatingViewHolder$showAdminDialog$1 this$0;
