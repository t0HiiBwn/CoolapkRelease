...
final class UserNodeRatingViewHolder$confirmDeleteRating$1 implements DialogInterface.OnClickListener {
    final /* synthetic */ NodeRating $data;
    final /* synthetic */ UserNodeRatingViewHolder this$0;

    UserNodeRatingViewHolder$confirmDeleteRating$1(UserNodeRatingViewHolder userNodeRatingViewHolder, NodeRating nodeRating) {
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        UserNodeRatingViewHolder.access$deleteNodeRating(this.this$0, this.$data, 0);
    }
}
