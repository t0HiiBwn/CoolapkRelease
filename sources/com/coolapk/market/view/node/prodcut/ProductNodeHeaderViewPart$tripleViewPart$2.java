...
final class ProductNodeHeaderViewPart$tripleViewPart$2 extends Lambda implements Function0<TripleAvatarViewPart> {
    final /* synthetic */ ProductNodeHeaderViewPart this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ProductNodeHeaderViewPart$tripleViewPart$2(ProductNodeHeaderViewPart productNodeHeaderViewPart) {
        super(0);
    ...
    public final TripleAvatarViewPart invoke() {
        TripleAvatarViewPart tripleAvatarViewPart = new TripleAvatarViewPart(new ContextBindingComponent(this.this$0.getActivity()));
        Space space = ((ProductNodeHeaderBinding) this.this$0.getBinding()).tripleAvatarSpaceHolder;
