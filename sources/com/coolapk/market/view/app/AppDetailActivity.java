...
public class AppDetailActivity extends ToolbarActivity {
    ...
    public static class AppDetailFragment extends BaseFragment implements AppDetailContract.View {
        ...
        public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            AppDetailBinding appDetailBinding = (AppDetailBinding) DataBindingUtil.inflate(layoutInflater, 2131558457, viewGroup, false);
        ...
        public void onActivityCreated(Bundle bundle) {
            ...
            this.binding.recyclerView.addItemDecoration(ItemDecorations.vertical(getActivity()).type(1, 2131231052).type(2, 2131231052).type(3, 2131231052).type(4, 2131231052).last(2131231052).create());
        ...
        private class DataAdapter extends RecyclerView.Adapter<BindingViewHolder> {
            ...
            public BindingViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                if (i == 1) {
                    return new AppDetailViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(2131558590, viewGroup, false), AppDetailFragment.this.viewModel);
                }
                if (i == 2) {
                    return new CardTripleViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(2131558634, viewGroup, false), AppDetailFragment.this.component, new ItemActionHandler() {
                ...
                return new CardDoubleViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(2131558630, viewGroup, false), AppDetailFragment.this.component, new ItemActionHandler() {
                    ...
                    public void onItemClick(RecyclerView.ViewHolder viewHolder, View view) {
                        super.onItemClick(viewHolder, view);
                        int id = view.getId();
                        if (id == 2131362769 || id == 2131362773) {
