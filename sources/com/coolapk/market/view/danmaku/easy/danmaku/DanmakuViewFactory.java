...
class DanmakuViewFactory {
    ...
    static DanmakuView createDanmakuView(Context context) {
        return (DanmakuView) LayoutInflater.from(context).inflate(2131558497, (ViewGroup) null, false);
    }

    /* access modifiers changed from: package-private */
    public static DanmakuView createDanmakuView(Context context, ViewGroup viewGroup) {
        return (DanmakuView) LayoutInflater.from(context).inflate(2131558497, viewGroup, false);
    }
}
