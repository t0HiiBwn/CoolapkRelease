...
final class RankingAppFragment$onActivityCreated$1 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ RankingAppFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RankingAppFragment$onActivityCreated$1(RankingAppFragment rankingAppFragment) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new ServiceAppViewHolder(view, new FragmentBindingComponent(this.this$0), EntityItemActionUtils.INSTANCE.serviceApk(this.this$0));
    }
}
