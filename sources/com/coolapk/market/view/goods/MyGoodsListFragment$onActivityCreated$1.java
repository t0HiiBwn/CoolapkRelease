...
final class MyGoodsListFragment$onActivityCreated$1 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ MyGoodsListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MyGoodsListFragment$onActivityCreated$1(MyGoodsListFragment myGoodsListFragment) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new ProductViewHolder(view, MyGoodsListFragment.access$getBindingComponent$p(this.this$0));
    }
}
