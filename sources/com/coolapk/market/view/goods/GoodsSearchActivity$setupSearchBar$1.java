...
final class GoodsSearchActivity$setupSearchBar$1 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ GoodsSearchActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GoodsSearchActivity$setupSearchBar$1(GoodsSearchActivity goodsSearchActivity) {
        super(1);
