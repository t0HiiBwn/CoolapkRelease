...
final class GoodsDataListFragment$onActivityCreated$3 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ GoodsDataListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GoodsDataListFragment$onActivityCreated$3(GoodsDataListFragment goodsDataListFragment) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new FeedGoodsViewHolder(view, GoodsDataListFragment.access$getBindingComponent$p(this.this$0));
    }
}
