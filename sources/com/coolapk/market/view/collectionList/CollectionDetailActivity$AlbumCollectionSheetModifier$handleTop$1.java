...
final class CollectionDetailActivity$AlbumCollectionSheetModifier$handleTop$1<T, R> implements Func1<Boolean, Observable<? extends Result<String>>> {
    final /* synthetic */ Album $album;

    CollectionDetailActivity$AlbumCollectionSheetModifier$handleTop$1(Album album) {
        this.$album = album;
    }
