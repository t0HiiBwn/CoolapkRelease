...
final class CollectionDetailFragment$setupToolbar$2 extends Lambda implements Function1<Float, Unit> {
    final /* synthetic */ FragmentActivity $activity;
    final /* synthetic */ CollectionDetailFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CollectionDetailFragment$setupToolbar$2(CollectionDetailFragment collectionDetailFragment, FragmentActivity fragmentActivity) {
        super(1);
    ...
    public final void invoke(float f) {
        ...
        if (TextUtils.isEmpty(CollectionDetailFragment.access$getCollection$p(this.this$0).getCoverPic())) {
            f = 1.0f;
        }
