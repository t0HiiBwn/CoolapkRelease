...
final class FunThingsDetailFragment$onCreateRequest$loadCollrctionItemList$1<R> implements Func0<Observable<List<Entity>>> {
    final /* synthetic */ int $page;
    final /* synthetic */ FunThingsDetailFragment this$0;

    FunThingsDetailFragment$onCreateRequest$loadCollrctionItemList$1(FunThingsDetailFragment funThingsDetailFragment, int i) {
    ...
    public final Observable<List<Entity>> call() {
        ...
        String access$getColId$p = FunThingsDetailFragment.access$getColId$p(this.this$0);
        int i = this.$page;
        String str = null;
