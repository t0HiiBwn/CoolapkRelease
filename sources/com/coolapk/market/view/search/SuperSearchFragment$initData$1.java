...
final class SuperSearchFragment$initData$1 extends Lambda implements Function1<Parcelable, Boolean> {
    public static final SuperSearchFragment$initData$1 INSTANCE = new SuperSearchFragment$initData$1();

    SuperSearchFragment$initData$1() {
        super(1);
    }
