...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\\\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\b\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u0003\n\u0002\b\t\u0018\u0000 )2\u001a\u0012\u0016\u0012\u0014\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00040\u00030\u00020\u0001:\u0003)*+B\u0005¢\u0006\u0002\u0010\u0005J\u0006\u0010\u0016\u001a\u00020\u0017J\u0012\u0010\u0018\u001a\u00020\u00172\b\u0010\u0019\u001a\u0004\u0018\u00010\u001aH\u0016J\u0012\u0010\u001b\u001a\u00020\u00172\b\u0010\u0019\u001a\u0004\u0018\u00010\u001aH\u0016J0\u0010\u001c\u001a\u001a\u0012\u0016\u0012\u0014\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00040\u00030\u00020\u001d2\u0006\u0010\u001e\u001a\u00020\u001f2\u0006\u0010 \u001a\u00020\fH\u0016J\u001a\u0010!\u001a\u00020\u00172\u0006\u0010\u001e\u001a\u00020\u001f2\b\u0010\"\u001a\u0004\u0018\u00010#H\u0014J,\u0010$\u001a\u00020\u001f2\u0006\u0010\u001e\u001a\u00020\u001f2\u001a\u0010%\u001a\u0016\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00040\u0003\u0018\u00010\u0002H\u0014J\u000e\u0010&\u001a\u00020\u00172\u0006\u0010\u0014\u001a\u00020\u0015J\b\u0010'\u001a\u00020\u001fH\u0014J\u0006\u0010(\u001a\u00020\u0017R\u0012\u0010\u0006\u001a\u00060\u0007R\u00020\u0000X.¢\u0006\u0002\n\u0000R6\u0010\b\u001a*\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00040\u00030\tj\u0014\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00040\u0003`\nX\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\u000b\u001a\u00020\fX\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\r\u0010\u000e\"\u0004\b\u000f\u0010\u0010R9\u0010\u0011\u001a*\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00040\u00030\tj\u0014\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00040\u0003`\n¢\u0006\b\n\u0000\u001a\u0004\b\u0012\u0010\u0013R\u000e\u0010\u0014\u001a\u00020\u0015X.¢\u0006\u0002\n\u0000¨\u0006,"}, d2 = {"Lcom/coolapk/market/view/search/SecondhandSortListFragment;", "Lcom/coolapk/market/view/base/asynclist/NewAsyncListFragment;", "", "Lkotlin/Pair;", "", "()V", "adapter", "Lcom/coolapk/market/view/search/SecondhandSortListFragment$DataAdapter;", "dataList", "Ljava/util/ArrayList;", "Lkotlin/collections/ArrayList;", "index", "", "getIndex", "()I", "setIndex", "(I)V", "outDataList", "getOutDataList", "()Ljava/util/ArrayList;", "viewModel", "Lcom/coolapk/market/view/search/SuperSearchViewModel;", "clearList", "", "onActivityCreated", "savedInstanceState", "Landroid/os/Bundle;", "onCreate", "onCreateRequest", "Lrx/Observable;", "isRefresh", "", "page", "onRequestFailure", "error", "", "onRequestResponse", "result", "setSuperSearchViewModel", "shouldShowList", "updateList", "Companion", "DataAdapter", "DataViewHolder", "presentation_coolapkAppRelease"}, k = 1, mv = {1, 4, 2})
/* compiled from: SecondhandSortListFragment.kt */
public final class SecondhandSortListFragment extends NewAsyncListFragment<List<? extends Pair<? extends String, ? extends String>>> {
    ...
    public static final /* synthetic */ SuperSearchViewModel access$getViewModel$p(SecondhandSortListFragment secondhandSortListFragment) {
        SuperSearchViewModel superSearchViewModel = secondhandSortListFragment.viewModel;
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bR\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Lcom/coolapk/market/view/search/SecondhandSortListFragment$Companion;", "", "()V", "KEY_INDEX", "", "newInstance", "Lcom/coolapk/market/view/search/SecondhandSortListFragment;", "index", "", "presentation_coolapkAppRelease"}, k = 1, mv = {1, 4, 2})
    /* compiled from: SecondhandSortListFragment.kt */
    public static final class Companion {
        ...
        public final SecondhandSortListFragment newInstance(int i) {
            SecondhandSortListFragment secondhandSortListFragment = new SecondhandSortListFragment();
            Bundle bundle = new Bundle();
            bundle.putInt("KEY_INDEX", i);
            Unit unit = Unit.INSTANCE;
            secondhandSortListFragment.setArguments(bundle);
            return secondhandSortListFragment;
        }
    }
    ...
    public Observable<List<Pair<String, String>>> onCreateRequest(boolean z, int i) {
        ...
        if (i2 == 0) {
            ...
            arrayList.addAll(MapsKt.toList(superSearchViewModel.getDealTypeMap()));
        } else if (i2 == 1) {
            ...
            arrayList2.addAll(MapsKt.toList(superSearchViewModel2.getSecondHandSortMap()));
        } else if (i2 == 2) {
            ArrayList<Pair<String, String>> arrayList3 = this.outDataList;
            SuperSearchViewModel superSearchViewModel3 = this.viewModel;
            if (superSearchViewModel3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("viewModel");
            }
            arrayList3.addAll(MapsKt.toList(superSearchViewModel3.getOtherMap()));
        } else if (i2 == 3) {
            ArrayList<Pair<String, String>> arrayList4 = this.outDataList;
            SuperSearchViewModel superSearchViewModel4 = this.viewModel;
            if (superSearchViewModel4 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("viewModel");
            }
            arrayList4.addAll(MapsKt.toList(superSearchViewModel4.getSecondHandChangeSortMap()));
        } else if (i2 == 4) {
            ArrayList<Pair<String, String>> arrayList5 = this.outDataList;
            SuperSearchViewModel superSearchViewModel5 = this.viewModel;
            if (superSearchViewModel5 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("viewModel");
            }
            arrayList5.addAll(MapsKt.toList(superSearchViewModel5.getOtherMapRemoveLink()));
        }
        SuperSearchViewModel superSearchViewModel6 = this.viewModel;
        if (superSearchViewModel6 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
        }
        superSearchViewModel6.setActionType(String.valueOf(this.index));
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0003J\b\u0010\u0004\u001a\u00020\u0005H\u0016J\u0018\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u00022\u0006\u0010\t\u001a\u00020\u0005H\u0016J\u0018\u0010\n\u001a\u00020\u00022\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u0005H\u0016¨\u0006\u000e"}, d2 = {"Lcom/coolapk/market/view/search/SecondhandSortListFragment$DataAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lcom/coolapk/market/view/search/SecondhandSortListFragment$DataViewHolder;", "(Lcom/coolapk/market/view/search/SecondhandSortListFragment;)V", "getItemCount", "", "onBindViewHolder", "", "holder", "position", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "presentation_coolapkAppRelease"}, k = 1, mv = {1, 4, 2})
    /* compiled from: SecondhandSortListFragment.kt */
    private final class DataAdapter extends RecyclerView.Adapter<DataViewHolder> {
        ...
        public DataViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            return new DataViewHolder(index, inflate, SecondhandSortListFragment.access$getViewModel$p(SecondhandSortListFragment.this), new SecondhandSortListFragment$DataAdapter$onCreateViewHolder$1(this));
        }

        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public int getItemCount() {
            return SecondhandSortListFragment.this.dataList.size();
        }

        public void onBindViewHolder(DataViewHolder dataViewHolder, int i) {
            Intrinsics.checkNotNullParameter(dataViewHolder, "holder");
            dataViewHolder.bindTo(SecondhandSortListFragment.this.dataList.get(i));
        }
    }
    ...
    private static final class DataViewHolder extends BindingViewHolder {
        ...
        @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Lcom/coolapk/market/view/search/SecondhandSortListFragment$DataViewHolder$Companion;", "", "()V", "LAYOUT_ID", "", "presentation_coolapkAppRelease"}, k = 1, mv = {1, 4, 2})
        /* compiled from: SecondhandSortListFragment.kt */
        public static final class Companion {
            private Companion() {
            }
        ...
        public void bindTo(Object obj) {
            ...
            String filterType = this.viewModel.getFilterType();
            switch (filterType.hashCode()) {
                case 48:
                    if (filterType.equals("0")) {
                        z = Intrinsics.areEqual((String) pair.getFirst(), this.viewModel.getDealType());
                        break;
                    }
                    z = false;
                    break;
                case 49:
                    if (filterType.equals("1")) {
                        if (!Intrinsics.areEqual(this.viewModel.getActionType(), "1")) {
                            z = Intrinsics.areEqual((String) pair.getFirst(), this.viewModel.getSecondHandChangeSort());
                            break;
                        } else {
                            z = Intrinsics.areEqual((String) pair.getFirst(), this.viewModel.getSecondHandSort());
                            break;
                        }
                    }
                    z = false;
                ...
                case 50:
                    if (filterType.equals("2")) {
                        if (!Intrinsics.areEqual(this.viewModel.getActionType(), "2")) {
                            z = Intrinsics.areEqual((String) pair.getFirst(), this.viewModel.getSecondHandFilterInBuy());
                            break;
                        } else {
