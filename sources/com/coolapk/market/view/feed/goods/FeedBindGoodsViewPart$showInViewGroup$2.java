...
final class FeedBindGoodsViewPart$showInViewGroup$2 extends Lambda implements Function1<Rect, Unit> {
    final /* synthetic */ FeedBindGoodsViewPart this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedBindGoodsViewPart$showInViewGroup$2(FeedBindGoodsViewPart feedBindGoodsViewPart) {
        super(1);
    ...
    public final void invoke(Rect rect) {
        ...
        LinearLayout linearLayout = ((FeedBindGoodsMainBinding) this.this$0.getBinding()).containerView;
