...
final class FeedBindGoodsViewPart$showAsBottomSheetDialog$2 extends Lambda implements Function1<Rect, Unit> {
    final /* synthetic */ FeedBindGoodsViewPart this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedBindGoodsViewPart$showAsBottomSheetDialog$2(FeedBindGoodsViewPart feedBindGoodsViewPart) {
        super(1);
    ...
    public final void invoke(Rect rect) {
        ...
        View root = ((FeedBindGoodsMainBinding) this.this$0.getBinding()).getRoot();
