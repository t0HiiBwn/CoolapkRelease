...
final class ForwardEntityActivity$DataAdapter$onBindViewHolder$5 implements View.OnClickListener {
    final /* synthetic */ ItemForwardEntityShareAppBinding $binding;
    final /* synthetic */ ForwardEntityActivity.DataAdapter this$0;

    ForwardEntityActivity$DataAdapter$onBindViewHolder$5(ForwardEntityActivity.DataAdapter dataAdapter, ItemForwardEntityShareAppBinding itemForwardEntityShareAppBinding) {
    ...
    public final void onClick(View view) {
        ...
        ShareUtils.shareToWechatUrl(this.this$0.getContext(), this.this$0.getEntity(), true);
