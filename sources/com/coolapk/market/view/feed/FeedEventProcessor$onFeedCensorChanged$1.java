...
final class FeedEventProcessor$onFeedCensorChanged$1 extends Lambda implements Function1<Feed, Feed> {
    final /* synthetic */ FeedCensorEvent $event;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedEventProcessor$onFeedCensorChanged$1(FeedCensorEvent feedCensorEvent) {
        super(1);
        this.$event = feedCensorEvent;
    }
