...
final class ArticlePreviewFragment$setupUI$2 extends Lambda implements Function1<Float, Unit> {
    final /* synthetic */ FragmentActivity $activity;
    final /* synthetic */ ArticleNative $topModel;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ArticlePreviewFragment$setupUI$2(FragmentActivity fragmentActivity, ArticleNative articleNative) {
        super(1);
