...
final class ArticlePreviewFragment$onActivityCreated$8 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ FragmentBindingComponent $bindingComponent;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ArticlePreviewFragment$onActivityCreated$8(FragmentBindingComponent fragmentBindingComponent) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new ArticlePreviewFragment.ArticlePreviewTextViewHolder(view, this.$bindingComponent);
    }
}
