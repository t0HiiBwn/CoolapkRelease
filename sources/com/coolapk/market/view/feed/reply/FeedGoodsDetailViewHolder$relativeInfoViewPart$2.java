...
final class FeedGoodsDetailViewHolder$relativeInfoViewPart$2 extends Lambda implements Function0<FeedRelativeInfoViewPart> {
    final /* synthetic */ FeedGoodsDetailViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedGoodsDetailViewHolder$relativeInfoViewPart$2(FeedGoodsDetailViewHolder feedGoodsDetailViewHolder) {
        super(0);
    ...
    public final FeedRelativeInfoViewPart invoke() {
        ...
        ViewUtil.replaceView(((ItemFeedGoodsDetailBinding) this.this$0.getBinding()).relativeSpaceView, feedRelativeInfoViewPart.createView(from, ((ItemFeedGoodsDetailBinding) this.this$0.getBinding()).cardView));
