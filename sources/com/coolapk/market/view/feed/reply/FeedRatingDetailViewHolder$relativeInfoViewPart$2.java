...
final class FeedRatingDetailViewHolder$relativeInfoViewPart$2 extends Lambda implements Function0<FeedRelativeInfoViewPart> {
    final /* synthetic */ FeedRatingDetailViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedRatingDetailViewHolder$relativeInfoViewPart$2(FeedRatingDetailViewHolder feedRatingDetailViewHolder) {
        super(0);
    ...
    public final FeedRelativeInfoViewPart invoke() {
        ...
        ViewUtil.replaceView(((ItemFeedRatingDetailBinding) this.this$0.getBinding()).relativeSpaceView, feedRelativeInfoViewPart.createView(from, ((ItemFeedRatingDetailBinding) this.this$0.getBinding()).cardView));
