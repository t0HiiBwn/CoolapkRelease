...
final class FeedAdminBaseSheetGroupFactory$handleHeadline$1 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ Feed $feed;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedAdminBaseSheetGroupFactory$handleHeadline$1(Feed feed) {
        super(1);
        this.$feed = feed;
    }
