...
final class FeedEventProcessor$onLikeChange$1 extends Lambda implements Function1<Feed, Feed> {
    final /* synthetic */ FeedLikeEvent $event;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedEventProcessor$onLikeChange$1(FeedLikeEvent feedLikeEvent) {
        super(1);
        this.$event = feedLikeEvent;
    }
