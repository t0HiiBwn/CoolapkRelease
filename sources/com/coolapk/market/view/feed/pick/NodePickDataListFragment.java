...
public final class NodePickDataListFragment extends DataListFragment {
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        getAdapter$presentation_coolapkAppRelease().register(SimpleViewHolderFactor.Companion.withLayoutId(2131558931).suitedMethod(NodePickDataListFragment$onActivityCreated$1.INSTANCE).constructor(new NodePickDataListFragment$onActivityCreated$2(this)).doAfterBind(NodePickDataListFragment$onActivityCreated$3.INSTANCE).resetItemViewType(2131558931).build(), -1);
        getAdapter$presentation_coolapkAppRelease().register(SimpleViewHolderFactor.Companion.withLayoutId(2131558889).suitedMethod(NodePickDataListFragment$onActivityCreated$4.INSTANCE).constructor(new NodePickDataListFragment$onActivityCreated$5(this)).doAfterBind(new NodePickDataListFragment$onActivityCreated$6(this)).resetItemViewType(2131558889).build(), -1);
