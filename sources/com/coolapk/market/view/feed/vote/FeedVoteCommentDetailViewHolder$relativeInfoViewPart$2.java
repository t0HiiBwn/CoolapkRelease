...
final class FeedVoteCommentDetailViewHolder$relativeInfoViewPart$2 extends Lambda implements Function0<FeedRelativeInfoViewPart> {
    final /* synthetic */ FeedVoteCommentDetailViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedVoteCommentDetailViewHolder$relativeInfoViewPart$2(FeedVoteCommentDetailViewHolder feedVoteCommentDetailViewHolder) {
        super(0);
    ...
    public final FeedRelativeInfoViewPart invoke() {
        ...
        ViewUtil.replaceView(((ItemFeedVoteCommentDetailBinding) this.this$0.getBinding()).relativeSpaceView, feedRelativeInfoViewPart.createView(from, ((ItemFeedVoteCommentDetailBinding) this.this$0.getBinding()).cardView));
