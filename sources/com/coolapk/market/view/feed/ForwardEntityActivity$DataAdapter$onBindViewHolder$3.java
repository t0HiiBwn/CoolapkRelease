...
final class ForwardEntityActivity$DataAdapter$onBindViewHolder$3 implements View.OnClickListener {
    final /* synthetic */ ItemForwardEntityShareAppBinding $binding;
    final /* synthetic */ ForwardEntityActivity.DataAdapter this$0;

    ForwardEntityActivity$DataAdapter$onBindViewHolder$3(ForwardEntityActivity.DataAdapter dataAdapter, ItemForwardEntityShareAppBinding itemForwardEntityShareAppBinding) {
    ...
    public final void onClick(View view) {
        ...
        ActionManager.startRecentActivity(UiUtils.getActivityNullable(this.this$0.getContext()), this.this$0.getEntity());
