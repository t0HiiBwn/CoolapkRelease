...
final class QuestionDetailViewHolder$relativeInfoViewPart$2 extends Lambda implements Function0<FeedRelativeInfoViewPart> {
    final /* synthetic */ QuestionDetailViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    QuestionDetailViewHolder$relativeInfoViewPart$2(QuestionDetailViewHolder questionDetailViewHolder) {
        super(0);
    ...
    public final FeedRelativeInfoViewPart invoke() {
        ...
        ViewUtil.replaceView(((ItemQuestionDetailViewBinding) this.this$0.getBinding()).relativeSpaceView, feedRelativeInfoViewPart.createView(from, ((ItemQuestionDetailViewBinding) this.this$0.getBinding()).cardView));
        ...
        if (marginLayoutParams2 != null) {
            marginLayoutParams2.topMargin = ConvertUtils.dp2px(8.0f);
