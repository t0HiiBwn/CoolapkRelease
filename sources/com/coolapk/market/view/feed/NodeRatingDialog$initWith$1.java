...
final class NodeRatingDialog$initWith$1 extends Lambda implements Function1<List<ActionItem>, Unit> {
    final /* synthetic */ NodeRating $data;
    final /* synthetic */ NodeRatingDialog this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NodeRatingDialog$initWith$1(NodeRatingDialog nodeRatingDialog, NodeRating nodeRating) {
        super(1);
    ...
    public final void invoke(List<ActionItem> list) {
        ...
        MultiItemDialogFragmentKt.addItem(list, "取消评分", new Function0<Unit>(this) {
            /* class com.coolapk.market.view.feed.NodeRatingDialog$initWith$1.AnonymousClass1 */
            final /* synthetic */ NodeRatingDialog$initWith$1 this$0;
