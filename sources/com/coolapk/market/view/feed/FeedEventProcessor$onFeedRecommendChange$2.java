...
final class FeedEventProcessor$onFeedRecommendChange$2 extends Lambda implements Function1<Feed, Feed> {
    final /* synthetic */ FeedEditorChoiceEvent $event;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedEventProcessor$onFeedRecommendChange$2(FeedEditorChoiceEvent feedEditorChoiceEvent) {
        super(1);
        this.$event = feedEditorChoiceEvent;
    }
