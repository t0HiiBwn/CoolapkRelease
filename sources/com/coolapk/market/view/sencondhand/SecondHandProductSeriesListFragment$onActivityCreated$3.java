...
final class SecondHandProductSeriesListFragment$onActivityCreated$3 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ SecondHandProductSeriesListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SecondHandProductSeriesListFragment$onActivityCreated$3(SecondHandProductSeriesListFragment secondHandProductSeriesListFragment) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new SecondHandProductSeriesListFragment.ProductSeriesTitleHolder(view, this.this$0.getBindingComponent());
    }
}
