...
final class SelectParamsFragment$onActivityCreated$2 extends Lambda implements Function1<Object, Boolean> {
    public static final SelectParamsFragment$onActivityCreated$2 INSTANCE = new SelectParamsFragment$onActivityCreated$2();

    SelectParamsFragment$onActivityCreated$2() {
        super(1);
    }
