...
public class ItemSimpleEntityHolderBindingImpl extends ItemSimpleEntityHolderBinding {
    ...
    private ItemSimpleEntityHolderBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (CoolapkCardView) objArr[0], (TextView) objArr[4], (ImageView) objArr[2], (LinearLayout) objArr[1], (TextView) objArr[3]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.coolapk.market.databinding.ItemSimpleEntityHolderBinding
