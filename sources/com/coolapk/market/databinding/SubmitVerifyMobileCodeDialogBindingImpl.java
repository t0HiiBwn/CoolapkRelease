...
public class SubmitVerifyMobileCodeDialogBindingImpl extends SubmitVerifyMobileCodeDialogBinding {
    ...
    private SubmitVerifyMobileCodeDialogBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[7], (TextView) objArr[1], (LinearLayout) objArr[0], (EditText) objArr[6], (TextView) objArr[8], (TextView) objArr[5], (TextView) objArr[2], (ProgressBar) objArr[3], (TextView) objArr[4]);
        this.mDirtyFlags = -1;
