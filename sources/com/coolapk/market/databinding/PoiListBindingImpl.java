...
public class PoiListBindingImpl extends PoiListBinding {
    ...
    private PoiListBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[3], (ProgressBar) objArr[1], (PreventAutoScrollRecyclerView) objArr[2]);
        this.mDirtyFlags = -1;
