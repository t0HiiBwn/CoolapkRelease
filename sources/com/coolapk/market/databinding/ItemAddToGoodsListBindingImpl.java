...
public class ItemAddToGoodsListBindingImpl extends ItemAddToGoodsListBinding {
    ...
    private ItemAddToGoodsListBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (LinearLayout) objArr[0], (CheckBox) objArr[3], (ImageView) objArr[1], (EllipsizeTextView) objArr[2]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.coolapk.market.databinding.ItemAddToGoodsListBinding
    ...
    protected void executeBindings() {
        ...
        if ((j & 4) != 0) {
            ViewBindingAdapters.clipView(this.iconView, null, 12);
        }
    }
}
