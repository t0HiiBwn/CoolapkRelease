...
public class DialogBackupCreateBindingImpl extends DialogBackupCreateBinding {
    ...
    private DialogBackupCreateBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[1], (TextView) objArr[2], (TextView) objArr[3], (EditText) objArr[4]);
        this.mDirtyFlags = -1;
