...
public class FeedActionBarBindingImpl extends FeedActionBarBinding {
    ...
    private FeedActionBarBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[2], (TextView) objArr[1], (AlbumActionView) objArr[4], (LinearLayout) objArr[3]);
        this.mDirtyFlags = -1;
        this.albumAddAppView.setTag(null);
    ...
    protected void executeBindings() {
        ...
        if ((j & 1) != 0) {
            ThemeBindingAdapters.setTextColor(this.albumAddAppView, "colorAccent");
