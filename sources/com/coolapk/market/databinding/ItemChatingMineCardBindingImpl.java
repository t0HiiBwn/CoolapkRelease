...
public class ItemChatingMineCardBindingImpl extends ItemChatingMineCardBinding {
    ...
    private ItemChatingMineCardBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (LinearLayout) objArr[2], (ImageView) objArr[7], (TextView) objArr[8], (CoolEllipsizeTextView) objArr[6], (LinearLayout) objArr[9], (LinearLayout) objArr[3], (RoundedImageView) objArr[4], (RelativeLayout) objArr[0], (TextView) objArr[5], (ImageView) objArr[1]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.coolapk.market.databinding.ItemChatingMineCardBinding
    ...
    protected void executeBindings() {
        ...
        int i7 = 0;
        int i8 = ((j & 2050) > 0 ? 1 : ((j & 2050) == 0 ? 0 : -1));
        if (i8 != 0) {
        ...
        if ((j & 2568) != 0) {
            int i9 = ((j & 2056) > 0 ? 1 : ((j & 2056) == 0 ? 0 : -1));
            if (i9 != 0) {
        ...
        int i10 = ((j & 2080) > 0 ? 1 : ((j & 2080) == 0 ? 0 : -1));
        if (i10 != 0) {
        ...
        if (i11 != 0) {
            TextViewBindingAdapters.setTextViewLinkable(this.contactAuthorDes, str6, null, "textColorPrimary", null, null, null);
        }
        if ((j & 2560) != 0) {
            str2 = str;
        ...
        if ((j & 2056) != 0) {
            this.contactMessage.setVisibility(i6);
        }
        if ((j & 2568) != 0) {
