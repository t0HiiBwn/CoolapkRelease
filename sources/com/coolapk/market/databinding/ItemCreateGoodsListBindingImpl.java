...
public class ItemCreateGoodsListBindingImpl extends ItemCreateGoodsListBinding {
    ...
    private ItemCreateGoodsListBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (CoolapkCardView) objArr[0], (AspectRatioImageView) objArr[2], (FrameLayout) objArr[1]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.coolapk.market.databinding.ItemCreateGoodsListBinding
