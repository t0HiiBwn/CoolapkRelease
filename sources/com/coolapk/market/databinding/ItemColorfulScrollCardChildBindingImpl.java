...
public class ItemColorfulScrollCardChildBindingImpl extends ItemColorfulScrollCardChildBinding {
    ...
    public ItemColorfulScrollCardChildBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 4, sIncludes, sViewsWithIds));
    }

    private ItemColorfulScrollCardChildBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
    ...
    @Override // com.coolapk.market.databinding.ItemColorfulScrollCardChildBinding
