...
public class SubmitFeedArticleTopPartBindingImpl extends SubmitFeedArticleTopPartBinding {
    ...
    private SubmitFeedArticleTopPartBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (FeedWarningBinding) objArr[2], (ImageView) objArr[4], (ArticleEditText) objArr[7], (ImageView) objArr[1], (LinearLayout) objArr[0], (RatingBar) objArr[5], (TextView) objArr[6], (LinearLayout) objArr[3]);
        this.mDirtyFlags = -1;
