...
public class ItemFeedCoolPicLayoutBindingImpl extends ItemFeedCoolPicLayoutBinding {
    ...
    static {
        ...
        sparseIntArray.put(2131362326, 6);
        sparseIntArray.put(2131363551, 7);
        sparseIntArray.put(2131363243, 8);
        sparseIntArray.put(2131362676, 9);
    }

    public ItemFeedCoolPicLayoutBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 10, sIncludes, sViewsWithIds));
    }

    private ItemFeedCoolPicLayoutBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (LinearLayout) objArr[1], (Space) objArr[6], (CoolapkCardView) objArr[0], (FeedActionView2) objArr[2], (ForegroundTextView) objArr[4], (Space) objArr[5], (Space) objArr[9], (Space) objArr[8], (TextView) objArr[7]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.coolapk.market.databinding.ItemFeedCoolPicLayoutBinding
