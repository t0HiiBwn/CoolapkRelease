...
public class StatusBarUtils {
    private static final int CONTENT_STATUS_BAR_ID = 2131362507;
    private static final int DECOR_STATUS_BAR_ID = 2131362508;
    ...
    public static View getFakeDecorStatusBarView(Activity activity) {
        ...
        View findViewById = viewGroup.findViewById(2131362508);
        if (findViewById != null) {
            return findViewById;
        }
        View createStatusBarView = createStatusBarView(activity);
        createStatusBarView.setId(2131362508);
    ...
    public static View getFakeContentStatusBarView(Activity activity) {
        ...
        View findViewById = viewGroup.findViewById(2131362507);
        if (findViewById != null) {
            return findViewById;
        }
        View createStatusBarView = createStatusBarView(activity);
        createStatusBarView.setId(2131362507);
        viewGroup.addView(createStatusBarView);
        makeStatusBarFitSystemWindow(activity);
        return createStatusBarView;
    }
    ...
    private static void makeStatusBarFitSystemWindow(Activity activity) {
        ...
        View findViewById = activity.findViewById(2131362507);
        if (findViewById != null) {
            arrayList.add(findViewById);
        }
        View findViewById2 = activity.findViewById(2131362508);
