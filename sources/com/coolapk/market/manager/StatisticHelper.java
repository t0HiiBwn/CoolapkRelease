...
public final class StatisticHelper {
    ...
    public static final String EVENT_SPLASH_EXPOSE = "splash_expose";
    ...
    public static final String KEY_SPLASH_TITLE = "splash_title";
    ...
    public final void traceViewExposedEvent(View view, String str, String str2, String str3, long j) {
        Object tag = view.getTag(2131363449);
        if (tag instanceof Runnable) {
            view.removeCallbacks((Runnable) tag);
            view.setTag(2131363449, null);
        }
        if (view.isAttachedToWindow()) {
            Runnable statisticHelper$traceViewExposedEvent$recordFeedRunnable$1 = new StatisticHelper$traceViewExposedEvent$recordFeedRunnable$1(this, str, str2, str3, view, 2131363449);
            view.postDelayed(statisticHelper$traceViewExposedEvent$recordFeedRunnable$1, j);
            view.setTag(2131363449, statisticHelper$traceViewExposedEvent$recordFeedRunnable$1);
            if (!ViewCompat.isAttachedToWindow(view)) {
                view.removeCallbacks(statisticHelper$traceViewExposedEvent$recordFeedRunnable$1);
                view.setTag(2131363449, null);
                return;
            }
            view.addOnAttachStateChangeListener(new StatisticHelper$traceViewExposedEvent$$inlined$doOnDetach$1(view, view, statisticHelper$traceViewExposedEvent$recordFeedRunnable$1, 2131363449));
    ...
    public final void recordSplashExpose(String str) {
        Intrinsics.checkNotNullParameter(str, "title");
        recordCustomKVEvent("splash_expose", TuplesKt.to("splash_title", str));
    }

    public final void recordSplashClick(String str) {
        Intrinsics.checkNotNullParameter(str, "title");
        recordCustomKVEvent("splash_click", TuplesKt.to("splash_title", str));
    }

    public final void recordSplashSkip(String str) {
        Intrinsics.checkNotNullParameter(str, "title");
        recordCustomKVEvent("splash_skip", TuplesKt.to("splash_title", str));
    }
