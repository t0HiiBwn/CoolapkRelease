...
public final class EntityExtendsKt {
    ...
    public static final <T extends Entity> T jsonToEntity(String str) {
        Intrinsics.checkNotNullParameter(str, "$this$jsonToEntity");
        try {
