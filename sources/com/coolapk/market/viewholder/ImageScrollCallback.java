...
final class ImageScrollCallback extends TitleRecycleViewCardViewHolder.Callback {
    ...
    public BindingViewHolder onCreateViewHolder(TitleRecycleViewCardViewHolder titleRecycleViewCardViewHolder, ViewGroup viewGroup, int i) {
        ...
        if (i == 2131558757) {
            ...
            Intrinsics.checkNotNullExpressionValue(inflate, "view");
            inflate.getLayoutParams().width = (DisplayUtils.getDecorMinSideLength(AppHolder.getApplication()) / 5) * 3;
            ...
            return new ImageTextCardChildViewHolder(inflate, component2, titleRecycleViewCardViewHolder);
        } else {
            Intrinsics.checkNotNullExpressionValue(inflate, "view");
            ...
            return new MoreItemViewHolder(inflate, component3, null);
        }
    }
