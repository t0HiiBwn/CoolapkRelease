...
final class FeedDetailViewHolderV8$extraTypeViewPart$2 extends Lambda implements Function0<FeedExtraTypeViewPart> {
    final /* synthetic */ DataBindingComponent $component;
    final /* synthetic */ FeedDetailViewHolderV8 this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedDetailViewHolderV8$extraTypeViewPart$2(FeedDetailViewHolderV8 feedDetailViewHolderV8, DataBindingComponent dataBindingComponent) {
        super(0);
    ...
    public final FeedExtraTypeViewPart invoke() {
        ...
        feedExtraTypeViewPart.createView(from, ((ItemFeedDetailViewV8Binding) this.this$0.getBinding()).cardView);
