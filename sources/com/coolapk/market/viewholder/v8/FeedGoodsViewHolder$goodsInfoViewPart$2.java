...
final class FeedGoodsViewHolder$goodsInfoViewPart$2 extends Lambda implements Function0<FeedGoodsInfoViewPart> {
    final /* synthetic */ DataBindingComponent $component;
    final /* synthetic */ FeedGoodsViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedGoodsViewHolder$goodsInfoViewPart$2(FeedGoodsViewHolder feedGoodsViewHolder, DataBindingComponent dataBindingComponent) {
        super(0);
    ...
    public final FeedGoodsInfoViewPart invoke() {
        ...
        ViewUtil.replaceView(((ItemFeedGoodsBinding) this.this$0.getBinding()).goodsSpaceView, feedGoodsInfoViewPart.createView(from, ((ItemFeedGoodsBinding) this.this$0.getBinding()).cardView));
