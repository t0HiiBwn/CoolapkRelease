...
final class CoolPicDetailViewHolder$relativeInfoViewPart$2 extends Lambda implements Function0<FeedRelativeInfoViewPart> {
    final /* synthetic */ CoolPicDetailViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CoolPicDetailViewHolder$relativeInfoViewPart$2(CoolPicDetailViewHolder coolPicDetailViewHolder) {
        super(0);
    ...
    public final FeedRelativeInfoViewPart invoke() {
        ...
        ViewUtil.replaceView(((ItemFeedCoolPicDetailBinding) this.this$0.getBinding()).relativeSpaceView, feedRelativeInfoViewPart.createView(from, ((ItemFeedCoolPicDetailBinding) this.this$0.getBinding()).cardView));
