...
final class HeadCardViewHolder$doCoverAnim$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ HeadCardViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HeadCardViewHolder$doCoverAnim$2(HeadCardViewHolder headCardViewHolder) {
        super(0);
    ...
    public final void invoke() {
        View view = ((ItemHeadCardBinding) this.this$0.getBinding()).coverViewMask;
