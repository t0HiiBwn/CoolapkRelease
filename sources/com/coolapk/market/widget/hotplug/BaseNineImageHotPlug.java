...
public class BaseNineImageHotPlug extends ViewPartHotPlug<NinePicViewPart, List<? extends String>> {
    ...
    public /* synthetic */ BaseNineImageHotPlug(View view, DataBindingComponent dataBindingComponent, ViewPartPool viewPartPool, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
