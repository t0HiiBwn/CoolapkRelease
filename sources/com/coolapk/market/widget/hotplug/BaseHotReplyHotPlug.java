...
public class BaseHotReplyHotPlug extends ViewPartHotPlug<FeedHotReplyViewPart, Feed> {
    ...
    public /* synthetic */ BaseHotReplyHotPlug(View view, DataBindingComponent dataBindingComponent, ViewPartPool viewPartPool, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public boolean shouldShowView(Feed feed) {
        ...
        return FeedHotReplyViewPart.Companion.shouldShowView(feed);
    }

    /* access modifiers changed from: protected */
    public void recycleViewPart(FeedHotReplyViewPart feedHotReplyViewPart) {
        Intrinsics.checkNotNullParameter(feedHotReplyViewPart, "viewPart");
        ViewUtil.replaceView(feedHotReplyViewPart.getView(), this.viewToReplace);
    }
    ...
    public void onViewPartLoad(FeedHotReplyViewPart feedHotReplyViewPart) {
        Intrinsics.checkNotNullParameter(feedHotReplyViewPart, "viewPart");
        ViewUtil.replaceView(this.viewToReplace, feedHotReplyViewPart.getView());
        ViewGroup.LayoutParams layoutParams = feedHotReplyViewPart.getView().getLayoutParams();
    ...
    /* access modifiers changed from: protected */
    public void bindData(FeedHotReplyViewPart feedHotReplyViewPart, Feed feed) {
        Intrinsics.checkNotNullParameter(feedHotReplyViewPart, "viewPart");
        Intrinsics.checkNotNullParameter(feed, "data");
        feedHotReplyViewPart.bindToContent(feed);
    }
}
