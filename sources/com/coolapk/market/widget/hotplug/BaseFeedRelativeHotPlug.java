...
public class BaseFeedRelativeHotPlug extends ViewPartHotPlug<FeedRelativeInfoViewPart, Feed> {
    ...
    public BaseFeedRelativeHotPlug(View view, DataBindingComponent dataBindingComponent, ViewPartPool viewPartPool, boolean z) {
        super(FeedRelativeInfoViewPart.Companion.getLAYOUT_ID(), viewPartPool, z);
    ...
    public boolean shouldShowView(Feed feed) {
        ...
        return FeedRelativeInfoViewPart.Companion.shouldShowView(feed);
    }

    /* access modifiers changed from: protected */
    public void recycleViewPart(FeedRelativeInfoViewPart feedRelativeInfoViewPart) {
        Intrinsics.checkNotNullParameter(feedRelativeInfoViewPart, "viewPart");
        ViewUtil.replaceView(feedRelativeInfoViewPart.getView(), this.viewToReplace);
    }

    /* access modifiers changed from: protected */
    @Override // com.coolapk.market.widget.hotplug.ViewPartHotPlug
    public FeedRelativeInfoViewPart createViewPart() {
        FeedRelativeInfoViewPart feedRelativeInfoViewPart = new FeedRelativeInfoViewPart(getViewPartPool());
        ...
        feedRelativeInfoViewPart.createView(from, this.initParent);
    ...
    public void onViewPartLoad(FeedRelativeInfoViewPart feedRelativeInfoViewPart) {
        Intrinsics.checkNotNullParameter(feedRelativeInfoViewPart, "viewPart");
        ViewUtil.replaceView(this.viewToReplace, feedRelativeInfoViewPart.getView());
    ...
    public void bindData(FeedRelativeInfoViewPart feedRelativeInfoViewPart, Feed feed) {
        Intrinsics.checkNotNullParameter(feedRelativeInfoViewPart, "viewPart");
        Intrinsics.checkNotNullParameter(feed, "data");
        feedRelativeInfoViewPart.bindTo(feed);
    }
}
