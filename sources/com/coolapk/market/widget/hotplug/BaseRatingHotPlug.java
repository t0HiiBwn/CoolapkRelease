...
public class BaseRatingHotPlug extends ViewPartHotPlug<FeedRatingViewPart, Feed> {
    ...
    public BaseRatingHotPlug(View view, DataBindingComponent dataBindingComponent, ViewPartPool viewPartPool, boolean z) {
        super(1225236460, viewPartPool, z);
    ...
    public boolean shouldShowView(Feed feed) {
        ...
        return FeedRatingViewPart.Companion.shouldShowView(feed);
    }

    /* access modifiers changed from: protected */
    public void recycleViewPart(FeedRatingViewPart feedRatingViewPart) {
        Intrinsics.checkNotNullParameter(feedRatingViewPart, "viewPart");
        ViewUtil.replaceView(feedRatingViewPart.getView(), this.viewToReplace);
    }

    /* access modifiers changed from: protected */
    @Override // com.coolapk.market.widget.hotplug.ViewPartHotPlug
    public FeedRatingViewPart createViewPart() {
        FeedRatingViewPart feedRatingViewPart = new FeedRatingViewPart();
        ...
        feedRatingViewPart.createView(from, this.initParent);
        return feedRatingViewPart;
    }

    /* access modifiers changed from: protected */
    public void onViewPartLoad(FeedRatingViewPart feedRatingViewPart) {
        Intrinsics.checkNotNullParameter(feedRatingViewPart, "viewPart");
        ViewUtil.replaceView(this.viewToReplace, feedRatingViewPart.getView());
        ViewGroup.LayoutParams layoutParams = feedRatingViewPart.getView().getLayoutParams();
    ...
    /* access modifiers changed from: protected */
    public void bindData(FeedRatingViewPart feedRatingViewPart, Feed feed) {
        Intrinsics.checkNotNullParameter(feedRatingViewPart, "viewPart");
        Intrinsics.checkNotNullParameter(feed, "data");
        feedRatingViewPart.bindToContent(feed);
    }
}
