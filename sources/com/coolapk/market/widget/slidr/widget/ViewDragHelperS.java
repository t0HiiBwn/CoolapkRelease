...
public class ViewDragHelperS {
    ...
    private static final Interpolator sInterpolator = new Interpolator() {
        /* class com.coolapk.market.widget.slidr.widget.ViewDragHelperS.AnonymousClass1 */
    ...
    private final Runnable mSetIdleRunnable = new Runnable() {
        /* class com.coolapk.market.widget.slidr.widget.ViewDragHelperS.AnonymousClass2 */

        @Override // java.lang.Runnable
        public void run() {
            ViewDragHelperS.this.setDragState(0);
        }
    };
    ...
    public static ViewDragHelperS create(ViewGroup viewGroup, Callback callback) {
        return new ViewDragHelperS(viewGroup.getContext(), viewGroup, callback);
    }

    public static ViewDragHelperS create(ViewGroup viewGroup, float f, Callback callback) {
        ViewDragHelperS create = create(viewGroup, callback);
        create.mTouchSlop = (int) (((float) create.mTouchSlop) * (1.0f / f));
        return create;
    }

    private ViewDragHelperS(Context context, ViewGroup viewGroup, Callback callback) {
        if (viewGroup == null) {
    ...
    private boolean forceSettleCapturedViewAt(int i, int i2, int i3, int i4) {
        int translationX = (int) this.mCapturedView.getTranslationX();
        ...
        this.mScroller.startScroll(translationX, top, i5, i6, computeSettleDuration(this.mCapturedView, i5, i6, i3, i4));
        setDragState(2);
        return true;
    }
    ...
    public void flingCapturedView(int i, int i2, int i3, int i4) {
        if (this.mReleaseInProgress) {
            this.mScroller.fling((int) this.mCapturedView.getTranslationX(), this.mCapturedView.getTop(), (int) VelocityTrackerCompat.getXVelocity(this.mVelocityTracker, this.mActivePointerId), (int) VelocityTrackerCompat.getYVelocity(this.mVelocityTracker, this.mActivePointerId), i, i3, i2, i4);
            setDragState(2);
            return;
        }
    ...
    public boolean continueSettling(boolean z) {
        if (this.mDragState == 2) {
            ...
            int currX = this.mScroller.getCurrX();
            int currY = this.mScroller.getCurrY();
            int translationX = currX - ((int) this.mCapturedView.getTranslationX());
            int top = currY - this.mCapturedView.getTop();
            if (translationX != 0) {
                View view = this.mCapturedView;
                ViewCompat.setTranslationX(view, view.getTranslationX() + ((float) translationX));
            }
            if (top != 0) {
                ViewCompat.offsetTopAndBottom(this.mCapturedView, top);
            }
            if (!(translationX == 0 && top == 0)) {
                this.mCallback.onViewPositionChanged(this.mCapturedView, currX, currY, translationX, top);
            }
    ...
    protected boolean canScroll(View view, boolean z, int i, int i2, int i3, int i4) {
        ...
        if (view instanceof ViewGroup) {
            ...
            for (int childCount = viewGroup.getChildCount() - 1; childCount >= 0; childCount--) {
                ...
                int i6 = i3 + scrollX;
                if (((float) i6) >= childAt.getTranslationX() && i6 < childAt.getRight() && (i5 = i4 + scrollY) >= childAt.getTop() && i5 < childAt.getBottom() && canScroll(childAt, true, i, i2, i6 - ((int) childAt.getTranslationX()), i5 - childAt.getTop())) {
                    return true;
                }
            }
        }
                ...
                if (actionMasked != 2) {
                    ...
                    for (int i4 = 0; i4 < pointerCount; i4++) {
                        ...
                        if (isValidPointerForActionMove(pointerId2)) {
                            ...
                            if (z2) {
                                int translationX = (int) findTopChildUnder2.getTranslationX();
                                int i5 = (int) f;
                                int clampViewPositionHorizontal = this.mCallback.clampViewPositionHorizontal(findTopChildUnder2, translationX + i5, i5);
    ...
    public void processTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            dragTo(((int) this.mCapturedView.getTranslationX()) + i8, this.mCapturedView.getTop() + i9, i8, i9);
            saveLastMotion(motionEvent);
        }
    }
    ...
    private void dragTo(int i, int i2, int i3, int i4) {
        ...
        if (i3 != 0) {
            ...
            ViewCompat.setTranslationX(this.mCapturedView, (float) i);
        }
        if (i4 != 0) {
        ...
        if (i3 != 0 || i4 != 0) {
            this.mCallback.onViewPositionChanged(this.mCapturedView, i, i2, i - translationX, i2 - top);
        }
    }
    ...
    public boolean isViewUnder(View view, int i, int i2) {
        if (view != null && ((float) i) >= view.getTranslationX() && i < view.getRight() && i2 >= view.getTop() && i2 < view.getBottom()) {
            return true;
        }
        return false;
    }
    ...
    public View findTopChildUnder(int i, int i2) {
        for (int childCount = this.mParentView.getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if (((float) i) >= childAt.getTranslationX() && i < childAt.getRight() && i2 >= childAt.getTop() && i2 < childAt.getBottom()) {
                return childAt;
            }
        }
        return null;
    ...
    private int getEdgesTouched(int i, int i2) {
        int i3 = ((float) i) < this.mParentView.getTranslationX() + ((float) this.mEdgeSize) ? 1 : 0;
