...
final class RecyclerViewDivider$onDraw$partialDrawBefore$1 extends Lambda implements Function0<Unit> {
    ...
    RecyclerViewDivider$onDraw$partialDrawBefore$1(boolean z, Ref.IntRef intRef, int i, int i2, Ref.IntRef intRef2, int i3, int i4, Function4 function4, Ref.IntRef intRef3, Ref.IntRef intRef4) {
        super(0);
        this.$isRTL = z;
        this.$right = intRef;
        this.$childRight = i;
    ...
    public final void invoke() {
        if (this.$isRTL) {
            this.$right.element = this.$childRight + this.$startMargin;
            this.$left.element = this.$right.element + this.$lastElementInSpanSize;
        } else {
            this.$right.element = this.$childLeft - this.$startMargin;
            this.$left.element = this.$right.element - this.$lastElementInSpanSize;
        }
