...
public final class IndicatorView extends LinearLayout {
    private ColorDrawable selectedDrawable = new ColorDrawable(ResourceUtils.getColorInt(getContext(), 2131099891));
    private int selectedIndex = -1;
    private int totalCount = -1;
    private ColorDrawable unselectedDrawable = new ColorDrawable(ResourceUtils.getColorInt(getContext(), 2131099893));
