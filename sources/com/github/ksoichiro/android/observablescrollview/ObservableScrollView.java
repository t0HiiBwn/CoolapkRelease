...
public class ObservableScrollView extends ScrollView implements Scrollable {
            ...
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    ...
                    if (currentScrollY <= 0.0f) {
                        ...
                        post(new Runnable() {
                            /* class com.github.ksoichiro.android.observablescrollview.ObservableScrollView.AnonymousClass1 */
    ...
    static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() {
            /* class com.github.ksoichiro.android.observablescrollview.ObservableScrollView.SavedState.AnonymousClass1 */
