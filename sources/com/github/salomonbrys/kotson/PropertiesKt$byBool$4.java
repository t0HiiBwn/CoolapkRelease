...
final class PropertiesKt$byBool$4 extends Lambda implements Function1<Boolean, JsonPrimitive> {
    public static final PropertiesKt$byBool$4 INSTANCE = new PropertiesKt$byBool$4();

    PropertiesKt$byBool$4() {
        super(1);
    }
