...
final class PropertiesKt$byByte$4 extends Lambda implements Function1<Byte, JsonPrimitive> {
    public static final PropertiesKt$byByte$4 INSTANCE = new PropertiesKt$byByte$4();

    PropertiesKt$byByte$4() {
        super(1);
    }
