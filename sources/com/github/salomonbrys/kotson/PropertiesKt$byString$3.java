...
final class PropertiesKt$byString$3 extends Lambda implements Function1<JsonElement, String> {
    public static final PropertiesKt$byString$3 INSTANCE = new PropertiesKt$byString$3();

    PropertiesKt$byString$3() {
        super(1);
    }
