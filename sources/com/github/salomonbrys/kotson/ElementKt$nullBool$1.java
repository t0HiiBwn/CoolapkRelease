...
final class ElementKt$nullBool$1 extends Lambda implements Function1<JsonElement, Boolean> {
    public static final ElementKt$nullBool$1 INSTANCE = new ElementKt$nullBool$1();

    ElementKt$nullBool$1() {
        super(1);
    }
