...
final class PropertiesKt$byFloat$1 extends Lambda implements Function1<JsonElement, Float> {
    public static final PropertiesKt$byFloat$1 INSTANCE = new PropertiesKt$byFloat$1();

    PropertiesKt$byFloat$1() {
        super(1);
    }
