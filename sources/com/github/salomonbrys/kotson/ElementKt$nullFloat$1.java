...
final class ElementKt$nullFloat$1 extends Lambda implements Function1<JsonElement, Float> {
    public static final ElementKt$nullFloat$1 INSTANCE = new ElementKt$nullFloat$1();

    ElementKt$nullFloat$1() {
        super(1);
    }
