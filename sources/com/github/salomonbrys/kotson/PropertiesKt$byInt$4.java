...
final class PropertiesKt$byInt$4 extends Lambda implements Function1<Integer, JsonPrimitive> {
    public static final PropertiesKt$byInt$4 INSTANCE = new PropertiesKt$byInt$4();

    PropertiesKt$byInt$4() {
        super(1);
    }
