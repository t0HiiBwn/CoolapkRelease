...
final class PropertiesKt$byDouble$3 extends Lambda implements Function1<JsonElement, Double> {
    public static final PropertiesKt$byDouble$3 INSTANCE = new PropertiesKt$byDouble$3();

    PropertiesKt$byDouble$3() {
        super(1);
    }
