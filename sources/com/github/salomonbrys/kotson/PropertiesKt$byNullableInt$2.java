...
final class PropertiesKt$byNullableInt$2 extends Lambda implements Function1<Integer, JsonElement> {
    public static final PropertiesKt$byNullableInt$2 INSTANCE = new PropertiesKt$byNullableInt$2();

    PropertiesKt$byNullableInt$2() {
        super(1);
    }
