...
final class PropertiesKt$byBool$1 extends Lambda implements Function1<JsonElement, Boolean> {
    public static final PropertiesKt$byBool$1 INSTANCE = new PropertiesKt$byBool$1();

    PropertiesKt$byBool$1() {
        super(1);
    }
