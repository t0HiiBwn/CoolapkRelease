...
final class PropertiesKt$byNullableBool$2 extends Lambda implements Function1<Boolean, JsonElement> {
    public static final PropertiesKt$byNullableBool$2 INSTANCE = new PropertiesKt$byNullableBool$2();

    PropertiesKt$byNullableBool$2() {
        super(1);
    }
