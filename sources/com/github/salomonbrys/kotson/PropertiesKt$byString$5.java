...
final class PropertiesKt$byString$5 extends Lambda implements Function1<JsonElement, String> {
    public static final PropertiesKt$byString$5 INSTANCE = new PropertiesKt$byString$5();

    PropertiesKt$byString$5() {
        super(1);
    }
