...
final class PropertiesKt$byNullableByte$4 extends Lambda implements Function1<Byte, JsonElement> {
    public static final PropertiesKt$byNullableByte$4 INSTANCE = new PropertiesKt$byNullableByte$4();

    PropertiesKt$byNullableByte$4() {
        super(1);
    }
