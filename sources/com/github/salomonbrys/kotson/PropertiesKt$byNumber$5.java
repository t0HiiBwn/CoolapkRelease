...
final class PropertiesKt$byNumber$5 extends Lambda implements Function1<JsonElement, Number> {
    public static final PropertiesKt$byNumber$5 INSTANCE = new PropertiesKt$byNumber$5();

    PropertiesKt$byNumber$5() {
        super(1);
    }
