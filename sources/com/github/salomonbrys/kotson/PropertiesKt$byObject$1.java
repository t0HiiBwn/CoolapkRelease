...
final class PropertiesKt$byObject$1 extends Lambda implements Function1<JsonElement, JsonObject> {
    public static final PropertiesKt$byObject$1 INSTANCE = new PropertiesKt$byObject$1();

    PropertiesKt$byObject$1() {
        super(1);
    }
