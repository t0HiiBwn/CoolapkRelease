...
final class PropertiesKt$byDouble$4 extends Lambda implements Function1<Double, JsonPrimitive> {
    public static final PropertiesKt$byDouble$4 INSTANCE = new PropertiesKt$byDouble$4();

    PropertiesKt$byDouble$4() {
        super(1);
    }
