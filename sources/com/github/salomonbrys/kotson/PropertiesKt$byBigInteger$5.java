...
final class PropertiesKt$byBigInteger$5 extends Lambda implements Function1<JsonElement, BigInteger> {
    public static final PropertiesKt$byBigInteger$5 INSTANCE = new PropertiesKt$byBigInteger$5();

    PropertiesKt$byBigInteger$5() {
        super(1);
    }
