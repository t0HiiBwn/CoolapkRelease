...
final class PropertiesKt$byBool$3 extends Lambda implements Function1<JsonElement, Boolean> {
    public static final PropertiesKt$byBool$3 INSTANCE = new PropertiesKt$byBool$3();

    PropertiesKt$byBool$3() {
        super(1);
    }
