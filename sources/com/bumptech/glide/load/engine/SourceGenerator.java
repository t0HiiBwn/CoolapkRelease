...
class SourceGenerator implements DataFetcherGenerator, DataFetcherGenerator.FetcherReadyCallback {
    ...
    boolean isCurrentRequest(ModelLoader.LoadData<?> loadData2) {
    ...
    void onDataReadyInternal(ModelLoader.LoadData<?> loadData2, Object obj) {
    ...
    void onLoadFailedInternal(ModelLoader.LoadData<?> loadData2, Exception exc) {
