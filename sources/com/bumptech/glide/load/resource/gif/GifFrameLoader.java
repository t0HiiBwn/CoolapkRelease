...
class GifFrameLoader {
    ...
    void setFrameTransformation(Transformation<Bitmap> transformation2, Bitmap bitmap) {
    ...
    void setOnEveryFrameReadyListener(OnEveryFrameListener onEveryFrameListener2) {
