...
public class a {
    ...
    private static boolean b(Context context, String str) {
        ...
        try {
            ...
            u.f(str2, "checkPermissinKITKATNew，locationOp,permission：" + checkOp + "," + lowerCase);
            if (checkOp == 0) {
                return true;
            }
            try {
                u.f(str2, "checkPermissinKITKATNew，false,permission：" + lowerCase);
                return false;
            } catch (Exception e2) {
                e = e2;
            }
            ...
            z = true;
            String str3 = a;
            u.f(str3, "权限检查出错时默认返回有权限，异常代码：" + e);
            return z;
        }
    }
