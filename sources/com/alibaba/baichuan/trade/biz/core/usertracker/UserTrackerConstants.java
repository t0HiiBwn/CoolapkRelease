...
public class UserTrackerConstants {
    ...
    public static final String E_SHOWLOGIN_FAIL = ("api_loginFail_aliTradesdk_" + AlibcTradeBiz.systemVersion);
    public static final String E_SHOWLOGIN_SUCCESS = ("api_loginSuccess_aliTradesdk_" + AlibcTradeBiz.systemVersion);
