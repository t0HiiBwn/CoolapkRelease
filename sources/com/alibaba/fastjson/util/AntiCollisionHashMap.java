...
public class AntiCollisionHashMap<K, V> extends AbstractMap<K, V> implements Map<K, V>, Cloneable, Serializable {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: com.alibaba.fastjson.util.AntiCollisionHashMap<K, V> */
    ...
    private final class ValueIterator extends AntiCollisionHashMap<K, V>.HashIterator {
    ...
    private final class KeyIterator extends AntiCollisionHashMap<K, V>.HashIterator {
        private KeyIterator() {
            super();
        }
    ...
    private final class EntryIterator extends AntiCollisionHashMap<K, V>.HashIterator {
