...
public class c {
    ...
    public static byte[] encode(byte[] bArr, int i, int i2, int i3) {
        C0014c cVar = new C0014c(i3, null);
        int i4 = (i2 / 3) * 4;
        int i5 = 2;
        if (!cVar.do_padding) {
            int i6 = i2 % 3;
    ...
    static class C0014c extends a {
        ...
        public boolean process(byte[] r18, int r19, int r20, boolean r21) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.alibaba.mtl.log.d.c.C0014c.process(byte[], int, int, boolean):boolean");
        }
    }
