...
public class OSSUtils {
    ...
    public static String determineContentType(String str, String str2, String str3) {
        ...
        if (str2 == null || (mimeTypeFromExtension2 = singleton.getMimeTypeFromExtension(str2.substring(str2.lastIndexOf(46) + 1))) == null) {
            return (str3 == null || (mimeTypeFromExtension = singleton.getMimeTypeFromExtension(str3.substring(str3.lastIndexOf(46) + 1))) == null) ? "application/octet-stream" : mimeTypeFromExtension;
        }
            ...
            if (requestMessage.getCredentialProvider() != null) {
                ...
                if (z) {
                    ...
                    if (oSSFederationToken != null) {
                        requestMessage.getHeaders().put("x-oss-security-token", oSSFederationToken.getSecurityToken());
                    } else {
