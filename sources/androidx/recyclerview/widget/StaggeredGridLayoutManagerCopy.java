...
public class StaggeredGridLayoutManagerCopy extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new Runnable() {
        /* class androidx.recyclerview.widget.StaggeredGridLayoutManagerCopy.AnonymousClass1 */

        @Override // java.lang.Runnable
        public void run() {
            StaggeredGridLayoutManagerCopy.this.checkForGaps();
        }
    };
    ...
    private SpanIndexLookup mLookup;
    ...
    public interface SpanIndexLookup {
        int getSpanIndex(int i, int i2);
    }

    public void setSpanIndexLookup(SpanIndexLookup spanIndexLookup) {
        this.mLookup = spanIndexLookup;
    }

    public StaggeredGridLayoutManagerCopy(Context context, AttributeSet attributeSet, int i, int i2) {
    ...
    public StaggeredGridLayoutManagerCopy(int i, int i2) {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (z4) {
                ...
                SpanIndexLookup spanIndexLookup = this.mLookup;
                if (spanIndexLookup != null) {
                    Span[] spanArr2 = this.mSpans;
                    span = spanArr2[spanIndexLookup.getSpanIndex(viewLayoutPosition, ArraysKt.indexOf(spanArr2, span))];
                }
    ...
    class Span {
        ...
        void calculateCachedStart() {
            ...
            this.mCachedStart = StaggeredGridLayoutManagerCopy.this.mPrimaryOrientation.getDecoratedStart(view);
            if (layoutParams.mFullSpan && (fullSpanItem = StaggeredGridLayoutManagerCopy.this.mLazySpanLookup.getFullSpanItem(layoutParams.getViewLayoutPosition())) != null && fullSpanItem.mGapDir == -1) {
        ...
        void calculateCachedEnd() {
            ...
            LayoutParams layoutParams = getLayoutParams(view);
            this.mCachedEnd = StaggeredGridLayoutManagerCopy.this.mPrimaryOrientation.getDecoratedEnd(view);
            if (layoutParams.mFullSpan && (fullSpanItem = StaggeredGridLayoutManagerCopy.this.mLazySpanLookup.getFullSpanItem(layoutParams.getViewLayoutPosition())) != null && fullSpanItem.mGapDir == 1) {
        ...
        void prependToSpan(View view) {
            ...
            if (layoutParams.isItemRemoved() || layoutParams.isItemChanged()) {
                this.mDeletedSize += StaggeredGridLayoutManagerCopy.this.mPrimaryOrientation.getDecoratedMeasurement(view);
            }
        }
        ...
        void cacheReferenceLineAndClear(boolean z, int i) {
            ...
            clear();
            if (i2 != Integer.MIN_VALUE) {
                if (z && i2 < StaggeredGridLayoutManagerCopy.this.mPrimaryOrientation.getEndAfterPadding()) {
                    return;
                }
                if (z || i2 <= StaggeredGridLayoutManagerCopy.this.mPrimaryOrientation.getStartAfterPadding()) {
                    if (i != Integer.MIN_VALUE) {
                        i2 += i;
                    }
                    this.mCachedEnd = i2;
        ...
        void popEnd() {
            ...
            if (layoutParams.isItemRemoved() || layoutParams.isItemChanged()) {
                this.mDeletedSize -= StaggeredGridLayoutManagerCopy.this.mPrimaryOrientation.getDecoratedMeasurement(remove);
            }
            if (size == 1) {
                this.mCachedStart = Integer.MIN_VALUE;
            }
        ...
        public int findFirstVisibleItemPosition() {
            if (StaggeredGridLayoutManagerCopy.this.mReverseLayout) {
        ...
        int findOnePartiallyOrCompletelyVisibleChild(int i, int i2, boolean z, boolean z2, boolean z3) {
            int startAfterPadding = StaggeredGridLayoutManagerCopy.this.mPrimaryOrientation.getStartAfterPadding();
            int endAfterPadding = StaggeredGridLayoutManagerCopy.this.mPrimaryOrientation.getEndAfterPadding();
            int i3 = i2 > i ? 1 : -1;
            while (i != i2) {
                View view = this.mViews.get(i);
                int decoratedStart = StaggeredGridLayoutManagerCopy.this.mPrimaryOrientation.getDecoratedStart(view);
                int decoratedEnd = StaggeredGridLayoutManagerCopy.this.mPrimaryOrientation.getDecoratedEnd(view);
                boolean z4 = false;
                ...
                if (z5 && z4) {
                    if (!z || !z2) {
                        if (z2) {
                            return StaggeredGridLayoutManagerCopy.this.getPosition(view);
                        }
        ...
        public View getFocusableViewAfter(int i, int i2) {
            ...
            if (i2 != -1) {
                ...
                while (size >= 0) {
                    ...
                    if ((StaggeredGridLayoutManagerCopy.this.mReverseLayout && StaggeredGridLayoutManagerCopy.this.getPosition(view2) >= i) || ((!StaggeredGridLayoutManagerCopy.this.mReverseLayout && StaggeredGridLayoutManagerCopy.this.getPosition(view2) <= i) || !view2.hasFocusable())) {
                        break;
                    }
                    size--;
                    view = view2;
                ...
                while (i3 < size2) {
                    ...
                    if ((StaggeredGridLayoutManagerCopy.this.mReverseLayout && StaggeredGridLayoutManagerCopy.this.getPosition(view3) <= i) || ((!StaggeredGridLayoutManagerCopy.this.mReverseLayout && StaggeredGridLayoutManagerCopy.this.getPosition(view3) >= i) || !view3.hasFocusable())) {
                        break;
                    }
                    i3++;
                    view = view3;
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Parcelable.Creator<FullSpanItem> CREATOR = new Parcelable.Creator<FullSpanItem>() {
                /* class androidx.recyclerview.widget.StaggeredGridLayoutManagerCopy.LazySpanLookup.FullSpanItem.AnonymousClass1 */
    ...
    public static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() {
            /* class androidx.recyclerview.widget.StaggeredGridLayoutManagerCopy.SavedState.AnonymousClass1 */
    ...
    class AnchorInfo {
        ...
        void saveSpanReferenceLines(Span[] spanArr) {
            ...
            if (iArr == null || iArr.length < length) {
                this.mSpanReferenceLines = new int[StaggeredGridLayoutManagerCopy.this.mSpans.length];
            }
        ...
        void assignCoordinateFromPadding() {
            ...
            if (this.mLayoutFromEnd) {
                i = StaggeredGridLayoutManagerCopy.this.mPrimaryOrientation.getEndAfterPadding();
            } else {
                i = StaggeredGridLayoutManagerCopy.this.mPrimaryOrientation.getStartAfterPadding();
            }
            this.mOffset = i;
        }
        ...
        void assignCoordinateFromPadding(int i) {
            if (this.mLayoutFromEnd) {
                this.mOffset = StaggeredGridLayoutManagerCopy.this.mPrimaryOrientation.getEndAfterPadding() - i;
            } else {
                this.mOffset = StaggeredGridLayoutManagerCopy.this.mPrimaryOrientation.getStartAfterPadding() + i;
            }
        }
    }
}
