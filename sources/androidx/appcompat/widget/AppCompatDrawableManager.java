            ...
            if (INSTANCE == null) {
                ...
                INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() {
                    ...
                    /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x003b: APUT  
                      ...
                      (wrap: int[] : 0x0039: SGET  (r2v2 int[]) =  androidx.appcompat.widget.ThemeUtils.DISABLED_STATE_SET int[])
                     */
                    /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x0043: APUT  
                      (r0v1 int[])
                      (0 ??[int, short, byte, char])
                      (wrap: int : 0x003f: INVOKE  (r2v4 int) = 
                      (r8v0 android.content.Context)
                      (wrap: int : 0x003d: SGET  (r2v3 int) =  androidx.appcompat.R.attr.colorSwitchThumbNormal int)
