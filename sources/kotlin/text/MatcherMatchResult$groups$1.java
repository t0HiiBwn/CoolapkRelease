...
public final class MatcherMatchResult$groups$1 extends AbstractCollection<MatchGroup> implements MatchNamedGroupCollection {
    ...
    public MatchGroup get(int i) {
        IntRange intRange = RegexKt.range(MatcherMatchResult.access$getMatchResult$p(this.this$0), i);
        if (intRange.getStart().intValue() < 0) {
            return null;
        }
        String group2 = MatcherMatchResult.access$getMatchResult$p(this.this$0).group(i);
        Intrinsics.checkNotNullExpressionValue(group2, "matchResult.group(index)");
        return new MatchGroup(group2, intRange);
    }
