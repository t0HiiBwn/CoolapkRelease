...
public final class KotlinVersion implements Comparable<KotlinVersion> {
    ...
    /* JADX DEBUG: TODO: convert one arg to string using `String.valueOf()`, args: [(wrap: int : 0x0005: IGET  (r1v0 int) = (r3v0 'this' kotlin.KotlinVersion A[IMMUTABLE_TYPE, THIS]) kotlin.KotlinVersion.major int), ('.' char), (wrap: int : 0x000f: IGET  (r2v0 int) = (r3v0 'this' kotlin.KotlinVersion A[IMMUTABLE_TYPE, THIS]) kotlin.KotlinVersion.minor int), ('.' char), (wrap: int : 0x0017: IGET  (r1v2 int) = (r3v0 'this' kotlin.KotlinVersion A[IMMUTABLE_TYPE, THIS]) kotlin.KotlinVersion.patch int)] */
