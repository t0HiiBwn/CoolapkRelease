...
public final class FlowKt__ContextKt$flowWith$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = FlowKt__ContextKt.buffer$default(FlowKt.flowOn((Flow) this.$builder$inlined.invoke(FlowKt__ContextKt.buffer$default(FlowKt.flowOn(this.$source$inlined, continuation.getContext().minusKey(Job.Key)), this.$bufferSize$inlined, null, 2, null)), this.$flowContext$inlined), this.$bufferSize$inlined, null, 2, null).collect(new FlowKt__ContextKt$flowWith$$inlined$unsafeFlow$1$lambda$1(flowCollector), continuation);
