...
public final class ValueOrClosed<T> {
    ...
    public static final /* synthetic */ ValueOrClosed m1406boximpl(Object obj) {
        return new ValueOrClosed(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static Object m1407constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1408equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ValueOrClosed) && Intrinsics.areEqual(obj, ((ValueOrClosed) obj2).m1416unboximpl());
    }
    ...
    public static int m1413hashCodeimpl(Object obj) {
        if (obj != null) {
            return obj.hashCode();
        }
        return 0;
    ...
    public boolean equals(Object obj) {
        return m1408equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1413hashCodeimpl(this.holder);
    }

    public String toString() {
        return m1415toStringimpl(this.holder);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Object m1416unboximpl() {
        return this.holder;
    }
    ...
    public static final boolean m1414isClosedimpl(Object obj) {
    ...
    public static final T m1411getValueimpl(Object obj) {
    ...
    public static final T m1412getValueOrNullimpl(Object obj) {
        if (obj instanceof Closed) {
            return null;
        }
        return obj;
    ...
    public static final Throwable m1410getCloseCauseimpl(Object obj) {
        if (obj instanceof Closed) {
    ...
    public static String m1415toStringimpl(Object obj) {
        if (obj instanceof Closed) {
            return obj.toString();
        }
        return "Value(" + obj + ')';
    ...
    public static final class Companion {
        ...
        public final <E> Object m1418valueZYPwvRU$kotlinx_coroutines_core(E e) {
            return ValueOrClosed.m1407constructorimpl(e);
        }

        /* renamed from: closed-ZYPwvRU$kotlinx_coroutines_core  reason: not valid java name */
        public final <E> Object m1417closedZYPwvRU$kotlinx_coroutines_core(Throwable th) {
            return ValueOrClosed.m1407constructorimpl(new Closed(th));
        }
    }
}
