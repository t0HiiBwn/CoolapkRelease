            ...
            while (true) {
                ...
                if (obj2 == SelectKt.UNDECIDED) {
                    ...
                    if (Result.m693isFailureimpl(obj)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable r4 = Result.m690exceptionOrNullimpl(obj);
                        if (r4 == null) {
                            Intrinsics.throwNpe();
                        }
                        Result.Companion companion = Result.Companion;
                        ...
                        continuation.resumeWith(Result.m687constructorimpl(ResultKt.createFailure(r4)));
                        return;
                    }
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected()) {
            while (true) {
                ...
                if (obj == SelectKt.UNDECIDED) {
                    ...
                    Result.Companion companion = Result.Companion;
                    intercepted.resumeWith(Result.m687constructorimpl(ResultKt.createFailure(th)));
                    return;
                }
            }
        } else {
