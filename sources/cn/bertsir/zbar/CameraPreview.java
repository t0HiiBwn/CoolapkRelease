...
public class CameraPreview extends FrameLayout implements SurfaceHolder.Callback {
    ...
    public CameraPreview(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mFocusCallback = new Camera.AutoFocusCallback() {
            /* class cn.bertsir.zbar.CameraPreview.AnonymousClass2 */
        ...
        this.mAutoFocusTask = new Runnable() {
            /* class cn.bertsir.zbar.CameraPreview.AnonymousClass3 */
    ...
    private void startCameraPreview(SurfaceHolder surfaceHolder) {
        try {
            ...
            new Handler().postDelayed(new Runnable() {
                /* class cn.bertsir.zbar.CameraPreview.AnonymousClass1 */
