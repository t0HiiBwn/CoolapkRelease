...
public class Single<T> {
    ...
    public static <T> Observable<T> merge(Observable<? extends Single<? extends T>> observable, int i) {
        return (Observable<R>) observable.flatMapSingle(UtilityFunctions.identity(), false, i);
    }
    ...
    public static <T> Observable<T> mergeDelayError(Observable<? extends Single<? extends T>> observable, int i) {
        return (Observable<R>) observable.flatMapSingle(UtilityFunctions.identity(), true, i);
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v2, resolved type: rx.Single$OnSubscribe */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    public final Single<T> doOnEach(final Action1<Notification<? extends T>> action1) {
        if (action1 != null) {
            return create(new SingleDoOnEvent(this, new Action1<T>() {
                ...
                /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: rx.functions.Action1 */
                /* JADX WARN: Multi-variable type inference failed */
                @Override // rx.functions.Action1
