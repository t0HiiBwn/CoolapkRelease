    ...
    public static class PathDataNode {
            ...
            while (i3 < fArr2.length) {
                if (c3 != 'A') {
                    if (c3 == 'C') {
                                ...
                                if (c3 == 'v') {
                                    ...
                                    if (c3 == 'M') {
                                        ...
                                        if (c4 == 'M' || c4 == 'm') {
                                            ...
                                            if (fArr2[i27] == 0.0f) {
                                                int i28 = i3 + 1;
                                                if (fArr2[i28] == 0.0f) {
                                                    path.addCircle(fArr2[i27], fArr2[i28], 1.0f, Path.Direction.CW);
                                                }
                                            }
                                        }
                                        int i29 = i3 + 0;
                                        ...
                                        int i35 = i3 + 2;
                                        int i36 = i3 + 3;
                                        path.rCubicTo(f6, f5, fArr2[i33], fArr2[i34], fArr2[i35], fArr2[i36]);
                                        f2 = fArr2[i33] + f15;
                                        f = fArr2[i34] + f16;
                                        f15 += fArr2[i35];
                                        f3 = fArr2[i36];
                                        ...
                                        int i37 = i3 + 0;
                                        int i38 = i3 + 1;
                                        path.rQuadTo(f7, f8, fArr2[i37], fArr2[i38]);
                                        float f27 = f7 + f15;
                                        float f28 = f8 + f16;
                                        f15 += fArr2[i37];
                                        f16 += fArr2[i38];
                                    ...
                                    if (c4 == 'M' || c4 == 'm') {
                                        ...
                                        if (fArr2[i39] == f15) {
                                            int i40 = i3 + 1;
                                            if (fArr2[i40] == f16) {
                                                path.addCircle(fArr2[i39], fArr2[i40], 1.0f, Path.Direction.CW);
                                            }
                                        }
                                    }
                                    int i41 = i3 + 0;
                                    int i42 = i3 + 1;
                                    path.lineTo(fArr2[i41], fArr2[i42]);
                                    f15 = fArr2[i41];
                                    f16 = fArr2[i42];
                                }
                                f16 += f4;
                        ...
                        int i49 = i3 + 6;
                        i2 = i3;
                        drawArc(path, f15, f16, fArr2[i48] + f15, fArr2[i49] + f16, fArr2[i3 + 0], fArr2[i3 + 1], fArr2[i3 + 2], fArr2[i3 + 3] != 0.0f, fArr2[i3 + 4] != 0.0f);
                        f15 += fArr2[i48];
                        f16 += fArr2[i49];
                    }
                    i3 = i2 + i;
                    ...
                    int i50 = i2 + 5;
                    int i51 = i2 + 6;
                    drawArc(path, f15, f16, fArr2[i50], fArr2[i51], fArr2[i2 + 0], fArr2[i2 + 1], fArr2[i2 + 2], fArr2[i2 + 3] != 0.0f, fArr2[i2 + 4] != 0.0f);
                    f15 = fArr2[i50];
                    f16 = fArr2[i51];
                }
                f12 = f16;
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d18 < 0.0d) {
                ...
                Log.w(str, "Points are too far apart " + d17);
