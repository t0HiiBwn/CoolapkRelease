...
public class SubmitFeedNewGoodsBindingImpl extends SubmitFeedNewGoodsBinding {
    ...
    private SubmitFeedNewGoodsBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[6], (ImageButton) objArr[8], (LinearLayout) objArr[0], (EditText) objArr[4], (TextView) objArr[5], (LinearLayout) objArr[7], (TextView) objArr[1], (TextView) objArr[3], (TextView) objArr[2]);
        this.mDirtyFlags = -1;
