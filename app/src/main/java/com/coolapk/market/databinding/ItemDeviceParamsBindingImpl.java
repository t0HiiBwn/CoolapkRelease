...
public class ItemDeviceParamsBindingImpl extends ItemDeviceParamsBinding {
    ...
    private ItemDeviceParamsBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
