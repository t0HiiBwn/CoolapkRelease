...
public class ItemCommentbarChildViewBindingImpl extends ItemCommentbarChildViewBinding {
    ...
    private ItemCommentbarChildViewBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (RelativeLayout) objArr[0], (ImageView) objArr[1], (TextView) objArr[2]);
        this.mDirtyFlags = -1;
        this.commentBarChild.setTag(null);
        setRootTag(view);
        invalidateAll();
    }
