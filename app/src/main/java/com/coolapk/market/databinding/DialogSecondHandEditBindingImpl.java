...
public class DialogSecondHandEditBindingImpl extends DialogSecondHandEditBinding {
    ...
    private DialogSecondHandEditBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[1], (EditText) objArr[5], (ProgressBar) objArr[3], (TextView) objArr[2], (TextView) objArr[4]);
        this.mDirtyFlags = -1;
    ...
    @Override // com.coolapk.market.databinding.DialogSecondHandEditBinding
