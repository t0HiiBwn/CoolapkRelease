...
public class ItemHeadlineTitleBindingImpl extends ItemHeadlineTitleBinding {
    ...
    private ItemHeadlineTitleBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
    ...
    protected void executeBindings() {
        ...
        if ((j & 1) != 0) {
            ThemeBindingAdapters.setTextColor(this.refreshTextView, "colorAccent");
        }
    }
}
