...
public class AlbumCommentBarBindingImpl extends AlbumCommentBarBinding {
    ...
    private AlbumCommentBarBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
    ...
    @Override // com.coolapk.market.databinding.AlbumCommentBarBinding
