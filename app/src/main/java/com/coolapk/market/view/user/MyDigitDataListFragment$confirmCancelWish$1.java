...
final class MyDigitDataListFragment$confirmCancelWish$1 implements DialogInterface.OnClickListener {
    final /* synthetic */ Product $data;
    final /* synthetic */ MyDigitDataListFragment this$0;

    MyDigitDataListFragment$confirmCancelWish$1(MyDigitDataListFragment myDigitDataListFragment, Product product) {
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        MyDigitDataListFragment.access$doCancelWish(this.this$0, this.$data);
    }
}
