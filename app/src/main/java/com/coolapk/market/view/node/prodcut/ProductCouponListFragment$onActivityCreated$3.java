...
final class ProductCouponListFragment$onActivityCreated$3 extends Lambda implements Function2<RecyclerView.ViewHolder, Object, Unit> {
    final /* synthetic */ ProductCouponListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ProductCouponListFragment$onActivityCreated$3(ProductCouponListFragment productCouponListFragment) {
        super(2);
    ...
    public final void invoke(RecyclerView.ViewHolder viewHolder, Object obj) {
        ...
        productCouponViewHolder.showDevices(this.this$0.shouldShowDevice.get(productCouponViewHolder.getAdapterPosition()), false);
    }
}
