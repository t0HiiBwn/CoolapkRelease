...
final class AppPickListFragment$onCreateRequest$3<T, R> implements Func1<MobileApp, Boolean> {
    final /* synthetic */ AppPickListFragment this$0;

    AppPickListFragment$onCreateRequest$3(AppPickListFragment appPickListFragment) {
