...
final class BlockWordListFragment$onOptionsItemSelected$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ BlockWordListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BlockWordListFragment$onOptionsItemSelected$1(BlockWordListFragment blockWordListFragment) {
        super(0);
