...
final class AppNodeViewPart$onViewCreated$1 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ AppNodeViewPart this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AppNodeViewPart$onViewCreated$1(AppNodeViewPart appNodeViewPart) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        RecyclerView recyclerView = ((AppNodeHeaderBinding) this.this$0.getBinding()).thumbnailList;
        Intrinsics.checkNotNullExpressionValue(recyclerView, "binding.thumbnailList");
        return new ItemThumbnailViewHolder(view, recyclerView, this.this$0.viewModel);
    }
}
