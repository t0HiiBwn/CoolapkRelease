...
final class PicAdminDialog$onActivityCreated$1 extends Lambda implements Function1<List<ActionItem>, Unit> {
    public static final PicAdminDialog$onActivityCreated$1 INSTANCE = new PicAdminDialog$onActivityCreated$1();

    PicAdminDialog$onActivityCreated$1() {
        super(1);
    }
    ...
    public final void invoke(List<ActionItem> list) {
        ...
        MultiItemDialogFragmentKt.addItem(list, "正在加载数据...", AnonymousClass1.INSTANCE);
    }
}
