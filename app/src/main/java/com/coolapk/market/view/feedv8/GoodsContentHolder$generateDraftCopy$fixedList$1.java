...
final class GoodsContentHolder$generateDraftCopy$fixedList$1<T, R> implements Func1<ImageUrl, ImageUrl> {
    final /* synthetic */ Map $oldImageMap;

    GoodsContentHolder$generateDraftCopy$fixedList$1(Map map) {
