...
final class AppNodeCommunityViewPart$tripleViewPart$2 extends Lambda implements Function0<TripleAvatarViewPart> {
    final /* synthetic */ AppNodeCommunityViewPart this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AppNodeCommunityViewPart$tripleViewPart$2(AppNodeCommunityViewPart appNodeCommunityViewPart) {
        super(0);
    ...
    public final TripleAvatarViewPart invoke() {
        ...
        Space space = ((AppNodeCommunityHeaderBinding) this.this$0.getBinding()).tripleAvatarSpaceHolder;
