...
final class FeedReplyDetailFragment$onFeedReplyLoaded$eventHandler$1 extends Lambda implements Function2<FeedReply, Boolean, Unit> {
    final /* synthetic */ FeedReply $feedReply;
    final /* synthetic */ FeedReplyDetailFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedReplyDetailFragment$onFeedReplyLoaded$eventHandler$1(FeedReplyDetailFragment feedReplyDetailFragment, FeedReply feedReply) {
        super(2);
    ...
    public final void invoke(FeedReply feedReply, boolean z) {
        ...
        if (!this.this$0.getDataList().isEmpty() && Intrinsics.areEqual(this.$feedReply.getId(), feedReply.getParentReplyId())) {
            this.this$0.removeNoMoreDataView();
            this.this$0.getDataList().add(feedReply);
            this.this$0.userReplyList.add(feedReply);
        }
    }
}
