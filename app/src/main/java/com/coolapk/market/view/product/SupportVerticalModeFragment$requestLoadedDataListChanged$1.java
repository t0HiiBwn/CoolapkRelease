...
final class SupportVerticalModeFragment$requestLoadedDataListChanged$1 extends Lambda implements Function1<List<Parcelable>, Unit> {
    final /* synthetic */ SupportVerticalModeFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SupportVerticalModeFragment$requestLoadedDataListChanged$1(SupportVerticalModeFragment supportVerticalModeFragment) {
        super(1);
