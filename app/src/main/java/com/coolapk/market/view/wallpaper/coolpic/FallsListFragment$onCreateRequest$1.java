...
final class FallsListFragment$onCreateRequest$1<T> implements Observable.OnSubscribe<AMapLocation> {
    final /* synthetic */ FallsListFragment this$0;

    FallsListFragment$onCreateRequest$1(FallsListFragment fallsListFragment) {
    ...
    public final void call(final Subscriber<? super AMapLocation> subscriber) {
        this.this$0.startSingleLocation(new AMapLocationListener() {
            /* class com.coolapk.market.view.wallpaper.coolpic.FallsListFragment$onCreateRequest$1.AnonymousClass1 */
        ...
        subscriber.add(Subscriptions.create(new Action0(this) {
            /* class com.coolapk.market.view.wallpaper.coolpic.FallsListFragment$onCreateRequest$1.AnonymousClass2 */
            final /* synthetic */ FallsListFragment$onCreateRequest$1 this$0;
