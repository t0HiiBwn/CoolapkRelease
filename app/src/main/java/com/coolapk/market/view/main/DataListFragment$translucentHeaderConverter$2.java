...
final class DataListFragment$translucentHeaderConverter$2 extends Lambda implements Function0<TranslucentHeaderConverter> {
    final /* synthetic */ DataListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DataListFragment$translucentHeaderConverter$2(DataListFragment dataListFragment) {
        super(0);
