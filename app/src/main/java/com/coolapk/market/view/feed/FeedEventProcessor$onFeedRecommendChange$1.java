...
final class FeedEventProcessor$onFeedRecommendChange$1 extends Lambda implements Function1<Feed, Feed> {
    final /* synthetic */ FeedRecommendEvent $event;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedEventProcessor$onFeedRecommendChange$1(FeedRecommendEvent feedRecommendEvent) {
        super(1);
        this.$event = feedRecommendEvent;
    }
