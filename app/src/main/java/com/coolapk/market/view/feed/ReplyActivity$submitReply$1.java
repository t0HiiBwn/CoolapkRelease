...
final class ReplyActivity$submitReply$1 extends Lambda implements Function1<Result<FeedReply>, Unit> {
    final /* synthetic */ ReplyActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ReplyActivity$submitReply$1(ReplyActivity replyActivity) {
        super(1);
