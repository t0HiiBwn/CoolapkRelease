...
public final class PhotoViewActivity$ImageFragment$loadSource$2 extends DrawableImageViewTarget {
    ...
    public void onResourceReady(Drawable drawable, Transition<? super Drawable> transition) {
        ...
        super.onResourceReady((PhotoViewActivity$ImageFragment$loadSource$2) drawable, (Transition<? super PhotoViewActivity$ImageFragment$loadSource$2>) transition);
