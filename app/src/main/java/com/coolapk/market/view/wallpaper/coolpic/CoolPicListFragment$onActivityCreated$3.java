...
final class CoolPicListFragment$onActivityCreated$3 extends Lambda implements Function2<RecyclerView.ViewHolder, Object, Unit> {
    final /* synthetic */ CoolPicListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CoolPicListFragment$onActivityCreated$3(CoolPicListFragment coolPicListFragment) {
        super(2);
    ...
    public final void invoke(RecyclerView.ViewHolder viewHolder, Object obj) {
        ...
        ((CoolPicDetailViewHolder) viewHolder).applyWindowsInset(this.this$0.lastWindowsInset);
    }
}
