...
final class VoteCommentMultiViewPart$bindToUserVoteDetail$setAnimateFraction$1 extends Lambda implements Function1<Float, Unit> {
    ...
    final /* synthetic */ VoteCommentMultiViewPart this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VoteCommentMultiViewPart$bindToUserVoteDetail$setAnimateFraction$1(VoteCommentMultiViewPart voteCommentMultiViewPart, ClipDrawable clipDrawable, float f, LayerDrawable layerDrawable, VoteOption voteOption) {
        super(1);
        this.this$0 = voteCommentMultiViewPart;
    ...
    /* JADX DEBUG: TODO: convert one arg to string using `String.valueOf()`, args: [(wrap: int : 0x0042: INVOKE  (r2v5 int) = 
      ...
      (r3v0 'this' com.coolapk.market.view.feed.vote.VoteCommentMultiViewPart$bindToUserVoteDetail$setAnimateFraction$1 A[IMMUTABLE_TYPE, THIS])
     com.coolapk.market.view.feed.vote.VoteCommentMultiViewPart$bindToUserVoteDetail$setAnimateFraction$1.$option com.coolapk.market.model.VoteOption)
    ...
    /* JADX DEBUG: TODO: convert one arg to string using `String.valueOf()`, args: [(wrap: int : 0x0074: INVOKE  (r4v3 int) = 
      ...
      (r3v0 'this' com.coolapk.market.view.feed.vote.VoteCommentMultiViewPart$bindToUserVoteDetail$setAnimateFraction$1 A[IMMUTABLE_TYPE, THIS])
     com.coolapk.market.view.feed.vote.VoteCommentMultiViewPart$bindToUserVoteDetail$setAnimateFraction$1.$percentFloat float) * (r4v0 float)) * (wrap: float : 0x0071: CAST (r4v2 float) = (float) (100 int)))
