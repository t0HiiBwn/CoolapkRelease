...
final class FeedEventProcessor$onFeedReplyBlock$1 extends Lambda implements Function1<Feed, Feed> {
    final /* synthetic */ FeedReplyBlockEvent $event;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedEventProcessor$onFeedReplyBlock$1(FeedReplyBlockEvent feedReplyBlockEvent) {
        super(1);
        this.$event = feedReplyBlockEvent;
    }
