...
final class MyDyhListFragment$onActivityCreated$2 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ MyDyhListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MyDyhListFragment$onActivityCreated$2(MyDyhListFragment myDyhListFragment) {
        super(1);
        this.this$0 = myDyhListFragment;
    }
