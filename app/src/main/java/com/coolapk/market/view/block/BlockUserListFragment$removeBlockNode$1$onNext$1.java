...
final class BlockUserListFragment$removeBlockNode$1$onNext$1 extends Lambda implements Function1<Parcelable, Boolean> {
    final /* synthetic */ BlockUserListFragment$removeBlockNode$1 this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BlockUserListFragment$removeBlockNode$1$onNext$1(BlockUserListFragment$removeBlockNode$1 blockUserListFragment$removeBlockNode$1) {
        super(1);
        this.this$0 = blockUserListFragment$removeBlockNode$1;
    }
