...
final class TopicNodeHeaderViewPart$tripleViewPart$2 extends Lambda implements Function0<TripleAvatarViewPart> {
    final /* synthetic */ TopicNodeHeaderViewPart this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TopicNodeHeaderViewPart$tripleViewPart$2(TopicNodeHeaderViewPart topicNodeHeaderViewPart) {
        super(0);
    ...
    public final TripleAvatarViewPart invoke() {
        ...
        Space space = ((TopicNodeHeaderBinding) this.this$0.getBinding()).tripleAvatarSpaceHolder;
