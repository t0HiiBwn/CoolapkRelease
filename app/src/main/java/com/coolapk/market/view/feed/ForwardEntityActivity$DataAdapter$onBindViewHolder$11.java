...
final class ForwardEntityActivity$DataAdapter$onBindViewHolder$11 implements View.OnClickListener {
    final /* synthetic */ ItemForwardEntityShareAppBinding $binding;
    final /* synthetic */ ForwardEntityActivity.DataAdapter this$0;

    ForwardEntityActivity$DataAdapter$onBindViewHolder$11(ForwardEntityActivity.DataAdapter dataAdapter, ItemForwardEntityShareAppBinding itemForwardEntityShareAppBinding) {
    ...
    public final void onClick(View view) {
        ...
        ShareUtils.shareToWeibo(this.this$0.getContext(), this.this$0.getEntity());
