...
final class AppDetailListFragment$onActivityCreated$4 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ AppDetailListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AppDetailListFragment$onActivityCreated$4(AppDetailListFragment appDetailListFragment) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new SmallScrollCardViewHolder(view, this.this$0.getBindingComponent());
    }
}
