...
final class SecondHandAgreementDialogFragment$onClick$2<T> implements Action1<Throwable> {
    final /* synthetic */ SecondHandAgreementDialogFragment this$0;

    SecondHandAgreementDialogFragment$onClick$2(SecondHandAgreementDialogFragment secondHandAgreementDialogFragment) {
