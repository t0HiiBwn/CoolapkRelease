...
final class ArticleEditShareUrlHolder$viewPart$2 extends Lambda implements Function0<ShareInfoViewPart> {
    final /* synthetic */ DataBindingComponent $component;
    final /* synthetic */ ArticleEditShareUrlHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ArticleEditShareUrlHolder$viewPart$2(ArticleEditShareUrlHolder articleEditShareUrlHolder, DataBindingComponent dataBindingComponent) {
        super(0);
    ...
    public final ShareInfoViewPart invoke() {
        ...
        ViewUtil.replaceView(this.this$0.binding.spaceView, shareInfoViewPart.createView(from, this.this$0.binding.itemView));
        ...
        marginLayoutParams2.bottomMargin = NumberExtendsKt.getDp((Number) 12);
