...
final class AlbumEditListFragment$listCallback$2 extends Lambda implements Function0<AdapterListChangedCallback<ObservableList<Entity>>> {
    final /* synthetic */ AlbumEditListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AlbumEditListFragment$listCallback$2(AlbumEditListFragment albumEditListFragment) {
        super(0);
    ...
    public final AdapterListChangedCallback<ObservableList<Entity>> invoke() {
        return new AdapterListChangedCallback<>(this.this$0.mAdapter);
    }
}
