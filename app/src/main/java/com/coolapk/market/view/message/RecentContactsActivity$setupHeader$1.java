...
final class RecentContactsActivity$setupHeader$1 implements TextView.OnEditorActionListener {
    final /* synthetic */ RecentContactsActivity this$0;

    RecentContactsActivity$setupHeader$1(RecentContactsActivity recentContactsActivity) {
    ...
    public final boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
        ...
        recentContactsActivity.inputKeyword(textView.getText().toString());
        return true;
    }
}
