...
final class FeedAdminBaseSheetGroupFactory$handleHomeVisible$1 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ FeedAdminBaseSheetGroupFactory this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedAdminBaseSheetGroupFactory$handleHomeVisible$1(FeedAdminBaseSheetGroupFactory feedAdminBaseSheetGroupFactory) {
        super(1);
