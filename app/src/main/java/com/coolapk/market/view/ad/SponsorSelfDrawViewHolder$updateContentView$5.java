...
final class SponsorSelfDrawViewHolder$updateContentView$5 extends Lambda implements Function1<Integer, Unit> {
    final /* synthetic */ SponsorSelfDrawViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SponsorSelfDrawViewHolder$updateContentView$5(SponsorSelfDrawViewHolder sponsorSelfDrawViewHolder) {
        super(1);
