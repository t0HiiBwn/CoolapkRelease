...
final class SelectParamsFragment$onActivityCreated$2 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ SelectParamsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SelectParamsFragment$onActivityCreated$2(SelectParamsFragment selectParamsFragment) {
        super(1);
