...
final class FeedVoteCommentDetailViewHolder$headerViewPart$2 extends Lambda implements Function0<FeedFollowableHeaderViewPart> {
    final /* synthetic */ DataBindingComponent $component;
    final /* synthetic */ FeedVoteCommentDetailViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedVoteCommentDetailViewHolder$headerViewPart$2(FeedVoteCommentDetailViewHolder feedVoteCommentDetailViewHolder, DataBindingComponent dataBindingComponent) {
        super(0);
    ...
    public final FeedFollowableHeaderViewPart invoke() {
        ...
        Space space = ((ItemFeedVoteCommentDetailBinding) this.this$0.getBinding()).headerSpaceView;
        ...
        ViewUtil.replaceView(((ItemFeedVoteCommentDetailBinding) this.this$0.getBinding()).headerSpaceView, feedFollowableHeaderViewPart.getView());
