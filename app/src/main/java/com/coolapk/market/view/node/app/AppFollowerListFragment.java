...
public final class AppFollowerListFragment extends EntityListFragment {
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        SimpleHolderFactorBuilder constructor = SimpleViewHolderFactor.Companion.withLayoutId(2131558933).suitedEntityType("user").constructor(new AppFollowerListFragment$onActivityCreated$1(this));
    ...
    public Observable<List<Entity>> onCreateRequest(boolean z, int i) {
        ...
        Observable<R> compose = instance.getAppFollowerList(string, i, uid, str).compose(RxUtils.apiCommonToData());
