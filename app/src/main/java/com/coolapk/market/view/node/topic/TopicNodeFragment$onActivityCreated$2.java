...
final class TopicNodeFragment$onActivityCreated$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ NodeFeedDialogInterceptor $interceptor;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TopicNodeFragment$onActivityCreated$2(NodeFeedDialogInterceptor nodeFeedDialogInterceptor) {
        super(0);
