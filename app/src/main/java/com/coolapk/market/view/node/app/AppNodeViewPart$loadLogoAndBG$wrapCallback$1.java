...
final class AppNodeViewPart$loadLogoAndBG$wrapCallback$1 extends Lambda implements Function2<Integer, Integer, Unit> {
    final /* synthetic */ Function2 $callback;
    final /* synthetic */ boolean $hasCover;
    final /* synthetic */ AppNodeViewPart this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AppNodeViewPart$loadLogoAndBG$wrapCallback$1(AppNodeViewPart appNodeViewPart, boolean z, Function2 function2) {
        super(2);
    ...
    public final void invoke(int i, int i2) {
        if (this.$hasCover) {
            View view = ((AppNodeHeaderBinding) this.this$0.getBinding()).backgroundPlaceholderView;
            Intrinsics.checkNotNullExpressionValue(view, "binding.backgroundPlaceholderView");
            view.setVisibility(0);
            ViewPager viewPager = ((AppNodeHeaderBinding) this.this$0.getBinding()).imageViewPager;
            Intrinsics.checkNotNullExpressionValue(viewPager, "binding.imageViewPager");
            viewPager.setBackground(new ColorDrawable(i));
            View view2 = ((AppNodeHeaderBinding) this.this$0.getBinding()).maskView;
            ...
            View view3 = ((AppNodeHeaderBinding) this.this$0.getBinding()).maskView;
            Intrinsics.checkNotNullExpressionValue(view3, "binding.maskView");
            NodeExtendsKt.nodeCoverDarkForegroundIfNeed(view3);
        }
        LinearLayout linearLayout = ((AppNodeHeaderBinding) this.this$0.getBinding()).backgroundContainer;
