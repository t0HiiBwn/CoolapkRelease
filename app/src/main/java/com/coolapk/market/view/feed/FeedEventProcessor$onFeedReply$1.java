...
final class FeedEventProcessor$onFeedReply$1 extends Lambda implements Function1<Feed, Feed> {
    final /* synthetic */ FeedReplyEvent $event;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedEventProcessor$onFeedReply$1(FeedReplyEvent feedReplyEvent) {
        super(1);
        this.$event = feedReplyEvent;
    }
