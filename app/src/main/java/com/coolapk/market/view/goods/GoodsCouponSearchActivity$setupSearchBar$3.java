...
final class GoodsCouponSearchActivity$setupSearchBar$3<T> implements Action1<String> {
    final /* synthetic */ GoodsCouponSearchActivity this$0;

    GoodsCouponSearchActivity$setupSearchBar$3(GoodsCouponSearchActivity goodsCouponSearchActivity) {
    ...
    public final void call(String str) {
        ...
        goodsCouponSearchActivity.inputKeywords(str, false);
    }
}
