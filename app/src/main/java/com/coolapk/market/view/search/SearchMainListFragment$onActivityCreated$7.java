...
public final class SearchMainListFragment$onActivityCreated$7 implements ViewMarginRule {
    ...
    public ViewMarginData getViewMarginData(int i, Object obj, ViewMarginData viewMarginData) {
        ...
        if (!(obj instanceof Entity) || !Intrinsics.areEqual(((Entity) obj).getEntityTemplate(), "searchHotListCard")) {
