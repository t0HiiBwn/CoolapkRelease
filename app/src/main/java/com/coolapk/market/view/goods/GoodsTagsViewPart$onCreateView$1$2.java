...
final class GoodsTagsViewPart$onCreateView$1$2 extends Lambda implements Function1<RelativeInfoView.RelativeItem, Unit> {
    final /* synthetic */ RelativeInfoView $this_apply;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GoodsTagsViewPart$onCreateView$1$2(RelativeInfoView relativeInfoView) {
        super(1);
