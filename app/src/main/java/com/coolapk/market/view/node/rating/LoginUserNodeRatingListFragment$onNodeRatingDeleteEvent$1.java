...
final class LoginUserNodeRatingListFragment$onNodeRatingDeleteEvent$1 extends Lambda implements Function1<List<Parcelable>, Unit> {
    final /* synthetic */ NodeRatingDeleteEvent $event;
    final /* synthetic */ LoginUserNodeRatingListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LoginUserNodeRatingListFragment$onNodeRatingDeleteEvent$1(LoginUserNodeRatingListFragment loginUserNodeRatingListFragment, NodeRatingDeleteEvent nodeRatingDeleteEvent) {
        super(1);
        this.this$0 = loginUserNodeRatingListFragment;
    ...
    public final void invoke(List<Parcelable> list) {
        ...
        CollectionsKt.removeAll((List) this.this$0.getDataList(), (Function1) new Function1<Parcelable, Boolean>(this) {
            /* class com.coolapk.market.view.node.rating.LoginUserNodeRatingListFragment$onNodeRatingDeleteEvent$1.AnonymousClass1 */
            final /* synthetic */ LoginUserNodeRatingListFragment$onNodeRatingDeleteEvent$1 this$0;
        ...
        if (i < 0) {
            this.this$0.addFullHintView("你还没有发过点评", null);
        }
    }
}
