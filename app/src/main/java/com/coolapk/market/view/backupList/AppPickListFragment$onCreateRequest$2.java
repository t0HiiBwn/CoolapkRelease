...
final class AppPickListFragment$onCreateRequest$2<T, R> implements Func1<List<MobileApp>, Observable<? extends MobileApp>> {
    public static final AppPickListFragment$onCreateRequest$2 INSTANCE = new AppPickListFragment$onCreateRequest$2();

    AppPickListFragment$onCreateRequest$2() {
    }
