...
final class GoodsListFeedItemViewHolder$headerViewPart$2 extends Lambda implements Function0<FeedIntegratedHeaderViewPart> {
    final /* synthetic */ DataBindingComponent $component;
    final /* synthetic */ GoodsListFeedItemViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GoodsListFeedItemViewHolder$headerViewPart$2(GoodsListFeedItemViewHolder goodsListFeedItemViewHolder, DataBindingComponent dataBindingComponent) {
        super(0);
    ...
    public final FeedIntegratedHeaderViewPart invoke() {
        ...
        LinearLayout linearLayout = ((ItemGoodsListFeedBinding) this.this$0.getBinding()).cardLayout;
        ...
        ViewUtil.replaceView(((ItemGoodsListFeedBinding) this.this$0.getBinding()).headerSpaceView, newInstance.getView());
        return newInstance;
    }
}
