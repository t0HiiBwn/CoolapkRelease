...
final class DyhArticleAction$TopAction$takeAction$1<T, R> implements Func1<Boolean, Observable<? extends Result<String>>> {
    final /* synthetic */ DyhArticleAction.TopAction this$0;

    DyhArticleAction$TopAction$takeAction$1(DyhArticleAction.TopAction topAction) {
    ...
    public final Observable<? extends Result<String>> call(Boolean bool) {
        ...
        if (bool.booleanValue()) {
            return DataManager.getInstance().onStick(this.this$0.dyhArticle.getId(), 2);
        }
        return DataManager.getInstance().onStick(this.this$0.dyhArticle.getId(), 1);
    }
}
