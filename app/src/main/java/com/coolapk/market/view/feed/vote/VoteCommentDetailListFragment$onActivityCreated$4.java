...
final class VoteCommentDetailListFragment$onActivityCreated$4 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ VoteCommentDetailListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VoteCommentDetailListFragment$onActivityCreated$4(VoteCommentDetailListFragment voteCommentDetailListFragment) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new VoteCommentDetailListFragment.VoteCommentEmptyViewHolder(view, this.this$0.getBindingComponent(), config);
    }
}
