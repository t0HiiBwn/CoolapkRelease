...
final class FunThingsDetailFragment$onCreateRequest$2<T, R> implements Func1<Collection, Observable<? extends List<? extends Entity>>> {
    final /* synthetic */ Observable $loadCollrctionItemList;

    FunThingsDetailFragment$onCreateRequest$2(Observable observable) {
