...
final class NewBaseChatActivity$onClick$2 implements Runnable {
    final /* synthetic */ LinearLayout.LayoutParams $lp;
    final /* synthetic */ NewBaseChatActivity this$0;

    NewBaseChatActivity$onClick$2(NewBaseChatActivity newBaseChatActivity, LinearLayout.LayoutParams layoutParams) {
