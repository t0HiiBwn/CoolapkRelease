...
final class QuestionDetailFragment$addBottomView$1 extends Lambda implements Function1<Rect, Unit> {
    final /* synthetic */ QuestionDetailFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    QuestionDetailFragment$addBottomView$1(QuestionDetailFragment questionDetailFragment) {
        super(1);
    ...
    public final void invoke(Rect rect) {
        ...
        QuestionDetailFragment.access$getViewPart$p(this.this$0).applyWindowsInset(rect);
    }
}
