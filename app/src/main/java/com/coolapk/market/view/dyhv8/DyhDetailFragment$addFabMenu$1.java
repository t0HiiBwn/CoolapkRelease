...
final class DyhDetailFragment$addFabMenu$1 implements View.OnClickListener {
    final /* synthetic */ DyhModel $model;
    final /* synthetic */ DyhDetailFragment this$0;

    DyhDetailFragment$addFabMenu$1(DyhDetailFragment dyhDetailFragment, DyhModel dyhModel) {
    ...
    public final void onClick(View view) {
        ...
        FeedUIConfig build = FeedArgsFactoryKt.applyDyh(uiConfigForFeed, dyhModel).build();
