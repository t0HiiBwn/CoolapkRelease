...
final class FeedGoodsHelper$showAddGoodsDialog$2$subscription$1<T1, T2, R> implements Func2<FeedGoods, Long, FeedGoods> {
    public static final FeedGoodsHelper$showAddGoodsDialog$2$subscription$1 INSTANCE = new FeedGoodsHelper$showAddGoodsDialog$2$subscription$1();

    FeedGoodsHelper$showAddGoodsDialog$2$subscription$1() {
    }
