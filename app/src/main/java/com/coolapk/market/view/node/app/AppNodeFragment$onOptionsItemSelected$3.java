...
final class AppNodeFragment$onOptionsItemSelected$3 extends Lambda implements Function1<ServiceApp, Unit> {
    final /* synthetic */ AppNodeFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AppNodeFragment$onOptionsItemSelected$3(AppNodeFragment appNodeFragment) {
        super(1);
    ...
    public final void invoke(ServiceApp serviceApp) {
        ...
        AppCopyDialog newInstance = AppCopyDialog.Companion.newInstance(serviceApp);
