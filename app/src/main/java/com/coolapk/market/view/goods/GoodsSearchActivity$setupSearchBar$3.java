...
final class GoodsSearchActivity$setupSearchBar$3<T> implements Action1<String> {
    final /* synthetic */ GoodsSearchActivity this$0;

    GoodsSearchActivity$setupSearchBar$3(GoodsSearchActivity goodsSearchActivity) {
    ...
    public final void call(String str) {
        ...
        goodsSearchActivity.inputKeywords(str);
    }
}
