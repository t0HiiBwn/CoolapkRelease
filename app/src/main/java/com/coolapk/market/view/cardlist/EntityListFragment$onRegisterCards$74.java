...
final class EntityListFragment$onRegisterCards$74 extends Lambda implements Function1<View, BindingViewHolder> {
    final /* synthetic */ EntityListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EntityListFragment$onRegisterCards$74(EntityListFragment entityListFragment) {
        super(1);
    ...
    public final BindingViewHolder invoke(View view) {
        ...
        return new TextLinkListCardViewHolder(view, this.this$0.getBindingComponent());
    }
}
