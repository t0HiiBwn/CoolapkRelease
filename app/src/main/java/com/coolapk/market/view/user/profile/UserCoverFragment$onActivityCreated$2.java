...
final class UserCoverFragment$onActivityCreated$2 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ UserCoverFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    UserCoverFragment$onActivityCreated$2(UserCoverFragment userCoverFragment) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new UserCoverFragment.CoverImageViewHolder(view, this.this$0.getComponent(), this.this$0.getPresenter());
    }
}
