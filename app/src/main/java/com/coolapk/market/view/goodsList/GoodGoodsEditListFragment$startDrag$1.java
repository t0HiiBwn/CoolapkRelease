...
final class GoodGoodsEditListFragment$startDrag$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ int $position;
    final /* synthetic */ GoodGoodsEditListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GoodGoodsEditListFragment$startDrag$1(GoodGoodsEditListFragment goodGoodsEditListFragment, int i) {
        super(0);
