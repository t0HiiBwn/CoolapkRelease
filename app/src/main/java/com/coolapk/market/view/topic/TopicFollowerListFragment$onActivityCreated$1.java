...
final class TopicFollowerListFragment$onActivityCreated$1 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ TopicFollowerListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TopicFollowerListFragment$onActivityCreated$1(TopicFollowerListFragment topicFollowerListFragment) {
        super(1);
        this.this$0 = topicFollowerListFragment;
    }
