...
final class ProductFragmentVX$showPageMenu$1 extends Lambda implements Function1<Entity, Unit> {
    ...
    ProductFragmentVX$showPageMenu$1(Fragment fragment, FloatExpandedMenuView floatExpandedMenuView, ConfigPage configPage, Function1 function1) {
        super(1);
