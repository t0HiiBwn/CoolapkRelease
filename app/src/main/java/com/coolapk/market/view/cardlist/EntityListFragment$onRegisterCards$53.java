...
final class EntityListFragment$onRegisterCards$53 extends Lambda implements Function1<View, BindingViewHolder> {
    final /* synthetic */ EntityListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EntityListFragment$onRegisterCards$53(EntityListFragment entityListFragment) {
        super(1);
    ...
    public final BindingViewHolder invoke(View view) {
        ...
        return new DyhArticleVH(view, this.this$0.getBindingComponent(), null);
    }
}
