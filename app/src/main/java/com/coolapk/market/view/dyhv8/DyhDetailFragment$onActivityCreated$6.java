...
final class DyhDetailFragment$onActivityCreated$6 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ DyhDetailFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DyhDetailFragment$onActivityCreated$6(DyhDetailFragment dyhDetailFragment) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new DyhDetailViewHolder(view, this.this$0.getBindingComponent(), null);
    }
}
