...
final class VoteCommentDetailViewPart$voteMultiView$2 extends Lambda implements Function0<LinearAdapterLayout> {
    final /* synthetic */ VoteCommentDetailViewPart this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VoteCommentDetailViewPart$voteMultiView$2(VoteCommentDetailViewPart voteCommentDetailViewPart) {
        super(0);
