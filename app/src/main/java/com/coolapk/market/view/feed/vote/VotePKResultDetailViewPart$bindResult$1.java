...
final class VotePKResultDetailViewPart$bindResult$1 implements View.OnClickListener {
    final /* synthetic */ Feed $data;
    final /* synthetic */ VoteOption $optionLeft;
    final /* synthetic */ int[] $pkOptionColors;
    final /* synthetic */ String[] $pkOptionIds;
    final /* synthetic */ VotePKResultDetailViewPart this$0;

    VotePKResultDetailViewPart$bindResult$1(VotePKResultDetailViewPart votePKResultDetailViewPart, Feed feed, VoteOption voteOption, String[] strArr, int[] iArr) {
        this.this$0 = votePKResultDetailViewPart;
        this.$data = feed;
        this.$optionLeft = voteOption;
    ...
    public final void onClick(View view) {
        ...
        VoteOption voteOption = this.$optionLeft;
        Intrinsics.checkNotNullExpressionValue(voteOption, "optionLeft");
        String id2 = voteOption.getId();
        Intrinsics.checkNotNullExpressionValue(id2, "optionLeft.id");
