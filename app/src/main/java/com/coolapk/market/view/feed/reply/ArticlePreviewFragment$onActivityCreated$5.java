...
final class ArticlePreviewFragment$onActivityCreated$5 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ FragmentBindingComponent $bindingComponent;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ArticlePreviewFragment$onActivityCreated$5(FragmentBindingComponent fragmentBindingComponent) {
        super(1);
