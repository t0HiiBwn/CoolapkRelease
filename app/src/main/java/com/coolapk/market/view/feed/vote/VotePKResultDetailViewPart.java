...
public final class VotePKResultDetailViewPart extends ViewPart {
    ...
    protected View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        ...
        ViewDataBinding inflate = DataBindingUtil.inflate(layoutInflater, 2131558743, viewGroup, false, this.component);
    ...
    public final void bindResult(Feed feed2) {
        ...
        if (stringToColor == null) {
            stringToColor = Integer.valueOf(ResourceUtils.getColorInt(getContext(), 2131099790));
        }
        ...
        if (stringToColor2 == null) {
            stringToColor2 = Integer.valueOf(ResourceUtils.getColorInt(getContext(), 2131099789));
        }
