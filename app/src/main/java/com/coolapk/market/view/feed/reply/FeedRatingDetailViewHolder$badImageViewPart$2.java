...
final class FeedRatingDetailViewHolder$badImageViewPart$2 extends Lambda implements Function0<NinePicViewPart> {
    final /* synthetic */ DataBindingComponent $component;
    final /* synthetic */ FeedRatingDetailViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedRatingDetailViewHolder$badImageViewPart$2(FeedRatingDetailViewHolder feedRatingDetailViewHolder, DataBindingComponent dataBindingComponent) {
        super(0);
    ...
    public final NinePicViewPart invoke() {
        ...
        ViewUtil.replaceView(((ItemFeedRatingDetailBinding) this.this$0.getBinding()).badImageSpaceView, ninePicViewPart.getView());
