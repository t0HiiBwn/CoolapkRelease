...
final class GoodsContentHolder$prepareMultiFeed$fixedList$1<T, R> implements Func1<ImageUrl, ImageUrl> {
    final /* synthetic */ Map $oldImageMap;

    GoodsContentHolder$prepareMultiFeed$fixedList$1(Map map) {
