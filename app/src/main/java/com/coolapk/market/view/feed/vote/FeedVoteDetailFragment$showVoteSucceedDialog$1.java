...
final class FeedVoteDetailFragment$showVoteSucceedDialog$1 implements DialogInterface.OnClickListener {
    final /* synthetic */ Vote $vote;
    final /* synthetic */ FeedVoteDetailFragment this$0;

    FeedVoteDetailFragment$showVoteSucceedDialog$1(FeedVoteDetailFragment feedVoteDetailFragment, Vote vote) {
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        FeedVoteDetailFragment.access$getHeaderViewPart$p(this.this$0).handleActionClick(this.$vote);
    }
}
