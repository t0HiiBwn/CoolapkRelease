...
public final class DyhDetailActivity$FeedDyhDetailSheetModifier$modifySheet$$inlined$also$lambda$1 implements SheetCallback {
    ...
    DyhDetailActivity$FeedDyhDetailSheetModifier$modifySheet$$inlined$also$lambda$1(boolean z, DyhDetailActivity.FeedDyhDetailSheetModifier feedDyhDetailSheetModifier, boolean z2, int i, boolean z3, Object obj, boolean z4, DyhModel dyhModel) {
        this.$isFeedTop = z;
    ...
    public SheetResult onSheetClick(SheetAction sheetAction) {
        ...
        this.this$0.handleTop((Feed) this.$data$inlined, this.$isFeedTop);
