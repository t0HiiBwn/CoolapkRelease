...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0006\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\u0018\u0000 \u00192\u00020\u0001:\u0001\u0019B\u0005¢\u0006\u0002\u0010\u0002J\u0012\u0010\n\u001a\u00020\u000b2\b\u0010\f\u001a\u0004\u0018\u00010\rH\u0016J\u0010\u0010\u000e\u001a\u00020\u000b2\u0006\u0010\u000f\u001a\u00020\u0010H\u0007J$\u0010\u0011\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00140\u00130\u00122\u0006\u0010\u0015\u001a\u00020\u00162\u0006\u0010\u0017\u001a\u00020\u0018H\u0016R#\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u00048BX\u0002¢\u0006\f\n\u0004\b\b\u0010\t\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u001a"}, d2 = {"Lcom/coolapk/market/view/userv9/UserCollectionListFragment;", "Lcom/coolapk/market/view/cardlist/EntityListFragment;", "()V", "uid", "", "kotlin.jvm.PlatformType", "getUid", "()Ljava/lang/String;", "uid$delegate", "Lkotlin/Lazy;", "onActivityCreated", "", "savedInstanceState", "Landroid/os/Bundle;", "onCollectionDelete", "event", "Lcom/coolapk/market/event/CollectionDelEvent;", "onCreateRequest", "Lrx/Observable;", "", "Lcom/coolapk/market/model/Entity;", "isRefresh", "", "page", "", "Companion", "presentation_coolapkAppRelease"}, k = 1, mv = {1, 4, 2})
/* compiled from: UserCollectionListFragment.kt */
public final class UserCollectionListFragment extends EntityListFragment {
    public static final Companion Companion = new Companion(null);
    public static final String EXTRA_UID = "uid";
    private final Lazy uid$delegate = LazyKt.lazy(new UserCollectionListFragment$uid$2(this));

    private final String getUid() {
        return (String) this.uid$delegate.getValue();
    }

    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u0004R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\b"}, d2 = {"Lcom/coolapk/market/view/userv9/UserCollectionListFragment$Companion;", "", "()V", "EXTRA_UID", "", "newInstance", "Lcom/coolapk/market/view/userv9/UserCollectionListFragment;", "uid", "presentation_coolapkAppRelease"}, k = 1, mv = {1, 4, 2})
    /* compiled from: UserCollectionListFragment.kt */
    public static final class Companion {
        ...
        public final UserCollectionListFragment newInstance(String str) {
    ...
    public Observable<List<Entity>> onCreateRequest(boolean z, int i) {
        ...
        Observable<R> compose = instance.getUserCollectionList(uid, i, entityId, str).compose(RxUtils.apiCommonToData());
        Intrinsics.checkNotNullExpressionValue(compose, "DataManager.getInstance(…xUtils.apiCommonToData())");
        return compose;
    }

    @Subscribe
    public final void onCollectionDelete(CollectionDelEvent collectionDelEvent) {
        ...
        for (T t : getDataList()) {
            if (!(t instanceof Collection) || !Intrinsics.areEqual(t.getId(), collectionDelEvent.getColId())) {
                ...
                if (getDataList().size() < 1) {
                    addHintView("这里还没有收藏单", UserCollectionListFragment$onCollectionDelete$1.INSTANCE);
                    return;
                }
                return;
            }
