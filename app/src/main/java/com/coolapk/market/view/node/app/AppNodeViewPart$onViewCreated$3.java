...
final class AppNodeViewPart$onViewCreated$3 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ AppNodeViewPart this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AppNodeViewPart$onViewCreated$3(AppNodeViewPart appNodeViewPart) {
        super(1);
    ...
    public final RecyclerView.ViewHolder invoke(View view) {
        ...
        return new SmallScrollCardItemViewHolder(view, new ContextBindingComponent(this.this$0.activity));
    }
}
