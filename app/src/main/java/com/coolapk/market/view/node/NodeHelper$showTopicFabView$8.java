...
final class NodeHelper$showTopicFabView$8 extends Lambda implements Function0<Unit> {
    final /* synthetic */ FabVerticalMenuLayout $layout;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NodeHelper$showTopicFabView$8(FabVerticalMenuLayout fabVerticalMenuLayout) {
        super(0);
