...
final class AlbumItemDialog$HomePageActionItem$takeAction$1<T, R> implements Func1<Boolean, Observable<? extends Result<String>>> {
    final /* synthetic */ AlbumItemDialog.HomePageActionItem this$0;

    AlbumItemDialog$HomePageActionItem$takeAction$1(AlbumItemDialog.HomePageActionItem homePageActionItem) {
