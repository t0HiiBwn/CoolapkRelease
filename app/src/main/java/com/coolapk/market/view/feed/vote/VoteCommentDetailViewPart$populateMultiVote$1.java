...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000#\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001J\"\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\u00042\u0006\u0010\b\u001a\u00020\tH\u0016¨\u0006\n"}, d2 = {"com/coolapk/market/view/feed/vote/VoteCommentDetailViewPart$populateMultiVote$1", "Landroid/widget/ArrayAdapter;", "", "getView", "Landroid/view/View;", "position", "", "convertView", "parent", "Landroid/view/ViewGroup;", "presentation_coolapkAppRelease"}, k = 1, mv = {1, 4, 2})
/* compiled from: VoteCommentDetailViewPart.kt */
public final class VoteCommentDetailViewPart$populateMultiVote$1 extends ArrayAdapter<String> {
    ...
    VoteCommentDetailViewPart$populateMultiVote$1(VoteCommentDetailViewPart voteCommentDetailViewPart, Vote vote, Feed feed, int i, List list, Context context, int i2, List list2) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            voteCommentMultiViewPart.getView().setTag(2131363492, voteCommentMultiViewPart);
        } else {
        ...
        for (T t : voteOptions) {
            ...
            if (Intrinsics.areEqual(t.getId(), str)) {
                ...
                VoteCommentMultiViewPart.bindToUserVoteDetail$default(voteCommentMultiViewPart, feed, t, this.$realTotalSelectNum, !this.this$0.getHaveShownAnimation$presentation_coolapkAppRelease(), false, 16, null);
