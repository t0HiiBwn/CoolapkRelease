...
final class FeedGoodsDetailViewHolder$headerViewPart$2 extends Lambda implements Function0<FeedFollowableHeaderViewPart> {
    final /* synthetic */ DataBindingComponent $component;
    final /* synthetic */ FeedGoodsDetailViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedGoodsDetailViewHolder$headerViewPart$2(FeedGoodsDetailViewHolder feedGoodsDetailViewHolder, DataBindingComponent dataBindingComponent) {
        super(0);
    ...
    public final FeedFollowableHeaderViewPart invoke() {
        ...
        Space space = ((ItemFeedGoodsDetailBinding) this.this$0.getBinding()).headerSpaceView;
        ...
        ViewUtil.replaceView(((ItemFeedGoodsDetailBinding) this.this$0.getBinding()).headerSpaceView, feedFollowableHeaderViewPart.getView());
