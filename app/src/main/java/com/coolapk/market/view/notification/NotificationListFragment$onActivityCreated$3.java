...
import com.coolapk.market.viewholder.NotificationNavViewHolder;
...
final class NotificationListFragment$onActivityCreated$3 extends Lambda implements Function1<View, RecyclerView.ViewHolder> {
    final /* synthetic */ NotificationListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NotificationListFragment$onActivityCreated$3(NotificationListFragment notificationListFragment) {
        super(1);
