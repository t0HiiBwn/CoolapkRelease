...
final class SecondHandProductBrandListFragment$onActivityCreated$1 extends Lambda implements Function1<Rect, Unit> {
    final /* synthetic */ SecondHandProductBrandListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SecondHandProductBrandListFragment$onActivityCreated$1(SecondHandProductBrandListFragment secondHandProductBrandListFragment) {
        super(1);
