...
final class NewMessageListFragment$onShowDelView$3 implements CompoundButton.OnCheckedChangeListener {
    final /* synthetic */ NewMessageListFragment this$0;

    NewMessageListFragment$onShowDelView$3(NewMessageListFragment newMessageListFragment) {
        this.this$0 = newMessageListFragment;
    }

    @Override // android.widget.CompoundButton.OnCheckedChangeListener
    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        this.this$0.selectAll(z);
        this.this$0.isSelectAll = z;
    }
}
