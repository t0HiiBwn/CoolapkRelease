...
final class TopicNodeFragment$installTopicContent$1 extends Lambda implements Function2<Integer, Integer, Unit> {
    final /* synthetic */ TopicNodeFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TopicNodeFragment$installTopicContent$1(TopicNodeFragment topicNodeFragment) {
        super(2);
