...
final class ChattingItemDialog$ChatAddTopActionItem$takeAction$3<T> implements Action1<Throwable> {
    final /* synthetic */ ChattingItemDialog.ChatAddTopActionItem this$0;

    ChattingItemDialog$ChatAddTopActionItem$takeAction$3(ChattingItemDialog.ChatAddTopActionItem chatAddTopActionItem) {
