...
final class NodeRatingListFragment$onNodeRatingDeleteEvent$1 extends Lambda implements Function1<List<Parcelable>, Unit> {
    final /* synthetic */ NodeRatingDeleteEvent $event;
    final /* synthetic */ NodeRatingListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NodeRatingListFragment$onNodeRatingDeleteEvent$1(NodeRatingListFragment nodeRatingListFragment, NodeRatingDeleteEvent nodeRatingDeleteEvent) {
        super(1);
    ...
    public final void invoke(List<Parcelable> list) {
        ...
        CollectionsKt.removeAll((List) this.this$0.getDataList(), (Function1) new Function1<Parcelable, Boolean>(this) {
            /* class com.coolapk.market.view.node.rating.NodeRatingListFragment$onNodeRatingDeleteEvent$1.AnonymousClass1 */
            final /* synthetic */ NodeRatingListFragment$onNodeRatingDeleteEvent$1 this$0;
