...
final class AppNodeCommunityViewPart$loadLogoAndBG$wrapCallback$1 extends Lambda implements Function2<Integer, Integer, Unit> {
    final /* synthetic */ Function2 $callback;
    final /* synthetic */ boolean $hasCover;
    final /* synthetic */ AppNodeCommunityViewPart this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AppNodeCommunityViewPart$loadLogoAndBG$wrapCallback$1(AppNodeCommunityViewPart appNodeCommunityViewPart, boolean z, Function2 function2) {
        super(2);
    ...
    public final void invoke(int i, int i2) {
        if (this.$hasCover) {
            View view = ((AppNodeCommunityHeaderBinding) this.this$0.getBinding()).backgroundPlaceholderView;
            Intrinsics.checkNotNullExpressionValue(view, "binding.backgroundPlaceholderView");
            view.setVisibility(0);
            ViewPager viewPager = ((AppNodeCommunityHeaderBinding) this.this$0.getBinding()).imageViewPager;
            Intrinsics.checkNotNullExpressionValue(viewPager, "binding.imageViewPager");
            viewPager.setBackground(new ColorDrawable(i));
            View view2 = ((AppNodeCommunityHeaderBinding) this.this$0.getBinding()).maskView;
            ...
            View view3 = ((AppNodeCommunityHeaderBinding) this.this$0.getBinding()).maskView;
            Intrinsics.checkNotNullExpressionValue(view3, "binding.maskView");
            NodeExtendsKt.nodeCoverDarkForegroundIfNeed(view3);
        }
        LinearLayout linearLayout = ((AppNodeCommunityHeaderBinding) this.this$0.getBinding()).backgroundContainer;
