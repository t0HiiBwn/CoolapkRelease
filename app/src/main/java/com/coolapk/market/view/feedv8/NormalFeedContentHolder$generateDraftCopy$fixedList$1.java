...
final class NormalFeedContentHolder$generateDraftCopy$fixedList$1<T, R> implements Func1<ImageUrl, ImageUrl> {
    final /* synthetic */ Map $oldImageMap;

    NormalFeedContentHolder$generateDraftCopy$fixedList$1(Map map) {
