...
final class AppViewListFragment$onActivityCreated$15 extends Lambda implements Function1<Float, Unit> {
    final /* synthetic */ AppViewListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AppViewListFragment$onActivityCreated$15(AppViewListFragment appViewListFragment) {
        super(1);
    ...
    public final void invoke(float f) {
        ...
        if (alphableToolbar != null) {
            alphableToolbar.setToolbarTitle(f >= ((float) 1) ? AppViewListFragment.access$getViewModel$p(this.this$0).getAppName() : "");
        }
    }
}
