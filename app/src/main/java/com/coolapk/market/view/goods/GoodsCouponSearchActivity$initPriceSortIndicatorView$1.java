...
final class GoodsCouponSearchActivity$initPriceSortIndicatorView$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ ImageView $indicatorView;
    final /* synthetic */ TextView $textView;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GoodsCouponSearchActivity$initPriceSortIndicatorView$1(TextView textView, ImageView imageView) {
        super(0);
