...
final class MyCardManagerActivity$submitCardConfig$2<T> implements Action1<Throwable> {
    final /* synthetic */ ProgressDialogFragment $dialog;
    final /* synthetic */ MyCardManagerActivity this$0;

    MyCardManagerActivity$submitCardConfig$2(MyCardManagerActivity myCardManagerActivity, ProgressDialogFragment progressDialogFragment) {
