...
public final class ProductCategoryDataListFragment extends SupportVerticalModeFragment {
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        BaseMultiTypeAdapter.register$default(getAdapter$presentation_coolapkAppRelease(), SimpleViewHolderFactor.Companion.withLayoutId(2131558878).suitedMethod(ProductCategoryDataListFragment$onActivityCreated$2.INSTANCE).constructor(new ProductCategoryDataListFragment$onActivityCreated$3(this)).build(), 0, 2, null);
        BaseMultiTypeAdapter.register$default(getAdapter$presentation_coolapkAppRelease(), SimpleViewHolderFactor.Companion.withLayoutId(2131558877).suitedMethod(ProductCategoryDataListFragment$onActivityCreated$4.INSTANCE).constructor(new ProductCategoryDataListFragment$onActivityCreated$5(this)).build(), 0, 2, null);
        BaseMultiTypeAdapter.register$default(getAdapter$presentation_coolapkAppRelease(), SimpleViewHolderFactor.Companion.withLayoutId(2131558876).suitedMethod(ProductCategoryDataListFragment$onActivityCreated$6.INSTANCE).constructor(new ProductCategoryDataListFragment$onActivityCreated$7(this)).build(), 0, 2, null);
        BaseMultiTypeAdapter.register$default(getAdapter$presentation_coolapkAppRelease(), SimpleViewHolderFactor.Companion.withLayoutId(2131558875).suitedMethod(ProductCategoryDataListFragment$onActivityCreated$8.INSTANCE).constructor(new ProductCategoryDataListFragment$onActivityCreated$9(this)).build(), 0, 2, null);
        BaseMultiTypeAdapter.register$default(getAdapter$presentation_coolapkAppRelease(), SimpleViewHolderFactor.Companion.withLayoutId(2131558956).suitedMethod(ProductCategoryDataListFragment$onActivityCreated$10.INSTANCE).constructor(new ProductCategoryDataListFragment$onActivityCreated$11(this)).resetItemViewType(2115689501).build(), 0, 2, null);
    }
