...
final class DraftListFragment$FeedRoughDraftViewHolder$bindTo$2 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ RoughDraft $roughDraft;
    final /* synthetic */ DraftListFragment.FeedRoughDraftViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DraftListFragment$FeedRoughDraftViewHolder$bindTo$2(DraftListFragment.FeedRoughDraftViewHolder feedRoughDraftViewHolder, RoughDraft roughDraft) {
        super(1);
    ...
    public final void invoke(View view) {
        ...
        this.this$0.showActionPopMenu(this.$roughDraft, view);
    }
}
