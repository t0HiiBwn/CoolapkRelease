...
final class QuestionViewHolder$headerViewPart$2 extends Lambda implements Function0<FeedIntegratedHeaderViewPart> {
    final /* synthetic */ DataBindingComponent $component;
    final /* synthetic */ QuestionViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    QuestionViewHolder$headerViewPart$2(QuestionViewHolder questionViewHolder, DataBindingComponent dataBindingComponent) {
        super(0);
        this.this$0 = questionViewHolder;
    ...
    public final FeedIntegratedHeaderViewPart invoke() {
        ...
        LinearLayout linearLayout = ((ItemQuestionViewBinding) this.this$0.getBinding()).cardView;
        ...
        ViewUtil.replaceView(((ItemQuestionViewBinding) this.this$0.getBinding()).headerSpaceView, newInstance.getView());
        return newInstance;
    }
}
