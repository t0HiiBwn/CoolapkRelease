...
final class AlbumFeedViewHolder$headerViewPart$2 extends Lambda implements Function0<FeedIntegratedHeaderViewPart> {
    final /* synthetic */ DataBindingComponent $component;
    final /* synthetic */ AlbumFeedViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AlbumFeedViewHolder$headerViewPart$2(AlbumFeedViewHolder albumFeedViewHolder, DataBindingComponent dataBindingComponent) {
        super(0);
        this.this$0 = albumFeedViewHolder;
    ...
    public final FeedIntegratedHeaderViewPart invoke() {
        ...
        LinearLayout linearLayout = ((ItemFeedAlbumLayoutBinding) this.this$0.getBinding()).cardView;
        ...
        ViewUtil.replaceView(((ItemFeedAlbumLayoutBinding) this.this$0.getBinding()).headerSpaceView, newInstance.getView());
        return newInstance;
    }
}
