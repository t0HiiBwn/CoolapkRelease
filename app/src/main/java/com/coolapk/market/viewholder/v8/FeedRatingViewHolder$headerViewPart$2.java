...
final class FeedRatingViewHolder$headerViewPart$2 extends Lambda implements Function0<FeedIntegratedHeaderViewPart> {
    final /* synthetic */ DataBindingComponent $component;
    final /* synthetic */ FeedRatingViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedRatingViewHolder$headerViewPart$2(FeedRatingViewHolder feedRatingViewHolder, DataBindingComponent dataBindingComponent) {
        super(0);
    ...
    public final FeedIntegratedHeaderViewPart invoke() {
        ...
        LinearLayout linearLayout = ((ItemFeedRatingBinding) this.this$0.getBinding()).cardView;
        ...
        ViewUtil.replaceView(((ItemFeedRatingBinding) this.this$0.getBinding()).headerSpaceView, newInstance.getView());
        return newInstance;
    }
}
