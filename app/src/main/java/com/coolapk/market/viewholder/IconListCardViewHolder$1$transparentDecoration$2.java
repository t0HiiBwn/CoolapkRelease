...
final class IconListCardViewHolder$1$transparentDecoration$2 extends Lambda implements Function0<RecyclerViewDivider.Builder> {
    public static final IconListCardViewHolder$1$transparentDecoration$2 INSTANCE = new IconListCardViewHolder$1$transparentDecoration$2();

    IconListCardViewHolder$1$transparentDecoration$2() {
        super(0);
    }
