...
final class CoolPicViewHolder$headerViewPart$2 extends Lambda implements Function0<FeedIntegratedHeaderViewPart> {
    final /* synthetic */ DataBindingComponent $component;
    final /* synthetic */ CoolPicViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CoolPicViewHolder$headerViewPart$2(CoolPicViewHolder coolPicViewHolder, DataBindingComponent dataBindingComponent) {
        super(0);
    ...
    public final FeedIntegratedHeaderViewPart invoke() {
        ...
        LinearLayout linearLayout = ((ItemFeedCoolPicLayoutBinding) this.this$0.getBinding()).cardView;
        ...
        ViewUtil.replaceView(((ItemFeedCoolPicLayoutBinding) this.this$0.getBinding()).headerSpaceView, newInstance.getView());
        return newInstance;
    }
}
