...
final class FeedVoteViewHolder$headerViewPart$2 extends Lambda implements Function0<FeedIntegratedHeaderViewPart> {
    final /* synthetic */ DataBindingComponent $component;
    final /* synthetic */ FeedVoteViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FeedVoteViewHolder$headerViewPart$2(FeedVoteViewHolder feedVoteViewHolder, DataBindingComponent dataBindingComponent) {
        super(0);
    ...
    public final FeedIntegratedHeaderViewPart invoke() {
        ...
        LinearLayout linearLayout = ((ItemFeedVoteBinding) this.this$0.getBinding()).cardView;
        ...
        ViewUtil.replaceView(((ItemFeedVoteBinding) this.this$0.getBinding()).headerSpaceView, newInstance.getView());
        return newInstance;
    }
}
