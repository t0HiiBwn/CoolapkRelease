...
import com.coolapk.market.databinding.ItemColorfulFatScrollCardChildBinding;
...
final class ColorfulFatScrollCardChildViewHolder extends GenericBindHolder<ItemColorfulFatScrollCardChildBinding, Entity> {
    ...
    public ColorfulFatScrollCardChildViewHolder(View view, DataBindingComponent dataBindingComponent, Function0<? extends EntityCard> function0) {
        super(view, dataBindingComponent, null);
        Intrinsics.checkNotNullParameter(view, "itemView");
        Intrinsics.checkNotNullParameter(dataBindingComponent, "component");
        Intrinsics.checkNotNullParameter(function0, "callback");
        this.callback = function0;
        ItemColorfulFatScrollCardChildBinding itemColorfulFatScrollCardChildBinding = (ItemColorfulFatScrollCardChildBinding) getBinding();
        Intrinsics.checkNotNullExpressionValue(itemColorfulFatScrollCardChildBinding, "binding");
        itemColorfulFatScrollCardChildBinding.setClick(this);
    }

    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Lcom/coolapk/market/viewholder/ColorfulFatScrollCardChildViewHolder$Companion;", "", "()V", "LAYOUT_ID", "", "presentation_coolapkAppRelease"}, k = 1, mv = {1, 4, 2})
    /* compiled from: ColorfulFatScrollCardViewHolder.kt */
    ...
    public void bindToContent(Entity entity) {
        ...
        ItemColorfulFatScrollCardChildBinding itemColorfulFatScrollCardChildBinding = (ItemColorfulFatScrollCardChildBinding) getBinding();
        Intrinsics.checkNotNullExpressionValue(itemColorfulFatScrollCardChildBinding, "binding");
        if (!Intrinsics.areEqual(itemColorfulFatScrollCardChildBinding.getModel(), entity)) {
            LinearLayout linearLayout = ((ItemColorfulFatScrollCardChildBinding) getBinding()).itemView;
            Intrinsics.checkNotNullExpressionValue(linearLayout, "binding.itemView");
            LinearLayout linearLayout2 = linearLayout;
            ViewGroup.LayoutParams layoutParams = linearLayout2.getLayoutParams();
            if (layoutParams != null) {
                layoutParams.width = Math.max((int) (((float) DisplayUtils.getDecorMinSideLength(getContext())) * 0.675f), NumberExtendsKt.getDp((Number) 243));
                ...
                if (entity instanceof Product) {
                    ...
                    if (z) {
                        str = EntityExtendsKt.getDisplayPerferRatingScore(product) + "分  " + KotlinExtendKt.toDisplayString(product.getHotNum()) + "热度";
                    } else {
                    ...
                    TextView textView = ((ItemColorfulFatScrollCardChildBinding) getBinding()).infoView;
                    Intrinsics.checkNotNullExpressionValue(textView, "binding.infoView");
                    textView.setText(str);
                    TextView textView2 = ((ItemColorfulFatScrollCardChildBinding) getBinding()).infoView;
                    Intrinsics.checkNotNullExpressionValue(textView2, "binding.infoView");
                    textView2.setVisibility(0);
                } else {
                    TextView textView3 = ((ItemColorfulFatScrollCardChildBinding) getBinding()).infoView;
                    Intrinsics.checkNotNullExpressionValue(textView3, "binding.infoView");
                    textView3.setText(entity.getSubTitle());
                    TextView textView4 = ((ItemColorfulFatScrollCardChildBinding) getBinding()).infoView;
                ...
                loadBackground(str2);
                ItemColorfulFatScrollCardChildBinding itemColorfulFatScrollCardChildBinding2 = (ItemColorfulFatScrollCardChildBinding) getBinding();
                Intrinsics.checkNotNullExpressionValue(itemColorfulFatScrollCardChildBinding2, "binding");
                itemColorfulFatScrollCardChildBinding2.setModel(entity);
                ((ItemColorfulFatScrollCardChildBinding) getBinding()).executePendingBindings();
                return;
            }
    ...
    public void onClick(View view) {
        ...
        ItemColorfulFatScrollCardChildBinding itemColorfulFatScrollCardChildBinding = (ItemColorfulFatScrollCardChildBinding) getBinding();
        Intrinsics.checkNotNullExpressionValue(itemColorfulFatScrollCardChildBinding, "binding");
        Entity model = itemColorfulFatScrollCardChildBinding.getModel();
        if (model != null) {
