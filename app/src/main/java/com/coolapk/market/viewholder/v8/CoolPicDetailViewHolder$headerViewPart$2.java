...
final class CoolPicDetailViewHolder$headerViewPart$2 extends Lambda implements Function0<FeedFollowableHeaderViewPart> {
    final /* synthetic */ DataBindingComponent $component;
    final /* synthetic */ CoolPicDetailViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CoolPicDetailViewHolder$headerViewPart$2(CoolPicDetailViewHolder coolPicDetailViewHolder, DataBindingComponent dataBindingComponent) {
        super(0);
    ...
    public final FeedFollowableHeaderViewPart invoke() {
        ...
        Space space = ((ItemFeedCoolPicDetailBinding) this.this$0.getBinding()).headerSpaceView;
        ...
        ViewUtil.replaceView(((ItemFeedCoolPicDetailBinding) this.this$0.getBinding()).headerSpaceView, feedFollowableHeaderViewPart.getView());
