...
final class AnswerViewHolder$headerViewPart$2 extends Lambda implements Function0<FeedIntegratedHeaderViewPart> {
    final /* synthetic */ DataBindingComponent $component;
    final /* synthetic */ AnswerViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AnswerViewHolder$headerViewPart$2(AnswerViewHolder answerViewHolder, DataBindingComponent dataBindingComponent) {
        super(0);
    ...
    public final FeedIntegratedHeaderViewPart invoke() {
        ...
        LinearLayout linearLayout = ((ItemAnswerViewBinding) this.this$0.getBinding()).cardView;
        ...
        ViewUtil.replaceView(((ItemAnswerViewBinding) this.this$0.getBinding()).headerSpaceView, newInstance.getView());
        return newInstance;
    }
}
