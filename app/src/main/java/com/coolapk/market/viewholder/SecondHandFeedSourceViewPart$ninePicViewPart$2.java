...
final class SecondHandFeedSourceViewPart$ninePicViewPart$2 extends Lambda implements Function0<NinePicViewPart> {
    final /* synthetic */ SecondHandFeedSourceViewPart this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SecondHandFeedSourceViewPart$ninePicViewPart$2(SecondHandFeedSourceViewPart secondHandFeedSourceViewPart) {
        super(0);
    ...
    public final NinePicViewPart invoke() {
        NinePicViewPart ninePicViewPart = new NinePicViewPart(SecondHandFeedSourceViewPart.access$getComponent$p(this.this$0));
