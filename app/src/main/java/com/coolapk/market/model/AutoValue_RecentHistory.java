...
final class AutoValue_RecentHistory extends C$AutoValue_RecentHistory {
    ...
    AutoValue_RecentHistory(String str, String str2, String str3, Integer num, String str4, String str5, String str6, String str7, String str8, String str9, String str10, Long l2, Long l3, String str11, int i, int i2, String str12, String str13, String str14, int i3, int i4, int i5, int i6) {
