...
abstract class C$$AutoValue_AppCategory extends AppCategory {
    ...
    public int hashCode() {
        ...
        int hashCode10 = (((((hashCode9 ^ (l3 == null ? 0 : l3.hashCode())) * 1000003) ^ this.id.hashCode()) * 1000003) ^ this.title.hashCode()) * 1000003;
