...
import com.coolapk.market.viewholder.FeedSecondHandViewPart;
...
/* compiled from: BaseSecondHandHotPlug.kt */
public class BaseSecondHandHotPlug extends ViewPartHotPlug<FeedSecondHandViewPart, Feed> {
    private final DataBindingComponent component;
    private final ViewGroup initParent;
    private final View viewToReplace;

    /* JADX WARNING: Illegal instructions before constructor call */
    public /* synthetic */ BaseSecondHandHotPlug(View view, DataBindingComponent dataBindingComponent, ViewPartPool viewPartPool, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public BaseSecondHandHotPlug(View view, DataBindingComponent dataBindingComponent, ViewPartPool viewPartPool, boolean z) {
        super(-82255444, viewPartPool, z);
    ...
    public boolean shouldShowView(Feed feed) {
        ...
        return FeedSecondHandViewPart.Companion.shouldShowView(feed);
    }

    /* access modifiers changed from: protected */
    public void recycleViewPart(FeedSecondHandViewPart feedSecondHandViewPart) {
        Intrinsics.checkNotNullParameter(feedSecondHandViewPart, "viewPart");
        ViewUtil.replaceView(feedSecondHandViewPart.getView(), this.viewToReplace);
    }

    /* access modifiers changed from: protected */
    @Override // com.coolapk.market.widget.hotplug.ViewPartHotPlug
    public FeedSecondHandViewPart createViewPart() {
        FeedSecondHandViewPart feedSecondHandViewPart = new FeedSecondHandViewPart(this.component, false);
        ...
        feedSecondHandViewPart.createView(from, this.initParent);
        return feedSecondHandViewPart;
    }

    /* access modifiers changed from: protected */
    public void onViewPartLoad(FeedSecondHandViewPart feedSecondHandViewPart) {
        Intrinsics.checkNotNullParameter(feedSecondHandViewPart, "viewPart");
        ViewUtil.replaceView(this.viewToReplace, feedSecondHandViewPart.getView());
        ViewGroup.LayoutParams layoutParams = feedSecondHandViewPart.getView().getLayoutParams();
    ...
    /* access modifiers changed from: protected */
    public void bindData(FeedSecondHandViewPart feedSecondHandViewPart, Feed feed) {
        Intrinsics.checkNotNullParameter(feedSecondHandViewPart, "viewPart");
        Intrinsics.checkNotNullParameter(feed, "data");
        feedSecondHandViewPart.bindToContent(feed);
    }
}
