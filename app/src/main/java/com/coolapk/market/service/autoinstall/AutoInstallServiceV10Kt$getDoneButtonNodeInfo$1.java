...
final class AutoInstallServiceV10Kt$getDoneButtonNodeInfo$1 extends Lambda implements Function2<AccessibilityNodeInfo, AccessibilityService, AccessibilityNodeInfo> {
    public static final AutoInstallServiceV10Kt$getDoneButtonNodeInfo$1 INSTANCE = new AutoInstallServiceV10Kt$getDoneButtonNodeInfo$1();

    AutoInstallServiceV10Kt$getDoneButtonNodeInfo$1() {
        super(2);
    }
    ...
    public final AccessibilityNodeInfo invoke(AccessibilityNodeInfo accessibilityNodeInfo, AccessibilityService accessibilityService) {
        ...
        if (!StringsKt.equals(AutoInstallUtilKt.getTextString(accessibilityNodeInfo), AutoInstallUtilKt.getBtnTextDone(accessibilityService), true)) {
            return null;
        }
