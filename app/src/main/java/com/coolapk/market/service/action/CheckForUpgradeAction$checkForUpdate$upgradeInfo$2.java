...
final class CheckForUpgradeAction$checkForUpdate$upgradeInfo$2<T, R> implements Func1<PatchInfo, UpgradeInfo> {
    public static final CheckForUpgradeAction$checkForUpdate$upgradeInfo$2 INSTANCE = new CheckForUpgradeAction$checkForUpdate$upgradeInfo$2();

    CheckForUpgradeAction$checkForUpdate$upgradeInfo$2() {
    }
