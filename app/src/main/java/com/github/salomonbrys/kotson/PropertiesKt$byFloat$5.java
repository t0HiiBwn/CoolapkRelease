...
final class PropertiesKt$byFloat$5 extends Lambda implements Function1<JsonElement, Float> {
    public static final PropertiesKt$byFloat$5 INSTANCE = new PropertiesKt$byFloat$5();

    PropertiesKt$byFloat$5() {
        super(1);
    }
