...
final class PropertiesKt$byDouble$1 extends Lambda implements Function1<JsonElement, Double> {
    public static final PropertiesKt$byDouble$1 INSTANCE = new PropertiesKt$byDouble$1();

    PropertiesKt$byDouble$1() {
        super(1);
    }
