...
final class PropertiesKt$byChar$4 extends Lambda implements Function1<Character, JsonPrimitive> {
    public static final PropertiesKt$byChar$4 INSTANCE = new PropertiesKt$byChar$4();

    PropertiesKt$byChar$4() {
        super(1);
    }
