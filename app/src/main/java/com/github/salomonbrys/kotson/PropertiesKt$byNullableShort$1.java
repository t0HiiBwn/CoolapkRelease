...
final class PropertiesKt$byNullableShort$1 extends Lambda implements Function1<JsonElement, Short> {
    public static final PropertiesKt$byNullableShort$1 INSTANCE = new PropertiesKt$byNullableShort$1();

    PropertiesKt$byNullableShort$1() {
        super(1);
    }
