...
final class PropertiesKt$byChar$6 extends Lambda implements Function1<Character, JsonPrimitive> {
    public static final PropertiesKt$byChar$6 INSTANCE = new PropertiesKt$byChar$6();

    PropertiesKt$byChar$6() {
        super(1);
    }
