...
final class PropertiesKt$byDouble$2 extends Lambda implements Function1<Double, JsonPrimitive> {
    public static final PropertiesKt$byDouble$2 INSTANCE = new PropertiesKt$byDouble$2();

    PropertiesKt$byDouble$2() {
        super(1);
    }
