...
final class PropertiesKt$byNullableLong$1 extends Lambda implements Function1<JsonElement, Long> {
    public static final PropertiesKt$byNullableLong$1 INSTANCE = new PropertiesKt$byNullableLong$1();

    PropertiesKt$byNullableLong$1() {
        super(1);
    }
