...
final class PropertiesKt$byLong$5 extends Lambda implements Function1<JsonElement, Long> {
    public static final PropertiesKt$byLong$5 INSTANCE = new PropertiesKt$byLong$5();

    PropertiesKt$byLong$5() {
        super(1);
    }
