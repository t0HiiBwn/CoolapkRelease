...
final class PropertiesKt$byNumber$1 extends Lambda implements Function1<JsonElement, Number> {
    public static final PropertiesKt$byNumber$1 INSTANCE = new PropertiesKt$byNumber$1();

    PropertiesKt$byNumber$1() {
        super(1);
    }
