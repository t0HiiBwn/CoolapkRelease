...
final class PropertiesKt$byShort$4 extends Lambda implements Function1<Short, JsonPrimitive> {
    public static final PropertiesKt$byShort$4 INSTANCE = new PropertiesKt$byShort$4();

    PropertiesKt$byShort$4() {
        super(1);
    }
