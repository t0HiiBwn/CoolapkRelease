...
final class PropertiesKt$byShort$3 extends Lambda implements Function1<JsonElement, Short> {
    public static final PropertiesKt$byShort$3 INSTANCE = new PropertiesKt$byShort$3();

    PropertiesKt$byShort$3() {
        super(1);
    }
