...
final class PropertiesKt$byNullableObject$1 extends Lambda implements Function1<JsonElement, JsonObject> {
    public static final PropertiesKt$byNullableObject$1 INSTANCE = new PropertiesKt$byNullableObject$1();

    PropertiesKt$byNullableObject$1() {
        super(1);
    }
