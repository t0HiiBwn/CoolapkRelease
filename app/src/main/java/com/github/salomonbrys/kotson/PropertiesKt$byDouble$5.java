...
final class PropertiesKt$byDouble$5 extends Lambda implements Function1<JsonElement, Double> {
    public static final PropertiesKt$byDouble$5 INSTANCE = new PropertiesKt$byDouble$5();

    PropertiesKt$byDouble$5() {
        super(1);
    }
