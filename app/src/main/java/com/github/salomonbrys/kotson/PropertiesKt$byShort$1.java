...
final class PropertiesKt$byShort$1 extends Lambda implements Function1<JsonElement, Short> {
    public static final PropertiesKt$byShort$1 INSTANCE = new PropertiesKt$byShort$1();

    PropertiesKt$byShort$1() {
        super(1);
    }
