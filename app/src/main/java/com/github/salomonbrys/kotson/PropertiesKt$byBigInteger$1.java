...
final class PropertiesKt$byBigInteger$1 extends Lambda implements Function1<JsonElement, BigInteger> {
    public static final PropertiesKt$byBigInteger$1 INSTANCE = new PropertiesKt$byBigInteger$1();

    PropertiesKt$byBigInteger$1() {
        super(1);
    }
