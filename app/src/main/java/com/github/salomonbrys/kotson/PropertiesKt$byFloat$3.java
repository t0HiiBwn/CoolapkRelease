...
final class PropertiesKt$byFloat$3 extends Lambda implements Function1<JsonElement, Float> {
    public static final PropertiesKt$byFloat$3 INSTANCE = new PropertiesKt$byFloat$3();

    PropertiesKt$byFloat$3() {
        super(1);
    }
