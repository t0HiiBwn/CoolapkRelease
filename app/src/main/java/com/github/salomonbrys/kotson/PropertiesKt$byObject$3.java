...
final class PropertiesKt$byObject$3 extends Lambda implements Function1<JsonElement, JsonObject> {
    public static final PropertiesKt$byObject$3 INSTANCE = new PropertiesKt$byObject$3();

    PropertiesKt$byObject$3() {
        super(1);
    }
