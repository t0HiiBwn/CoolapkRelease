...
final class PropertiesKt$byNullableChar$2 extends Lambda implements Function1<Character, JsonElement> {
    public static final PropertiesKt$byNullableChar$2 INSTANCE = new PropertiesKt$byNullableChar$2();

    PropertiesKt$byNullableChar$2() {
        super(1);
    }
