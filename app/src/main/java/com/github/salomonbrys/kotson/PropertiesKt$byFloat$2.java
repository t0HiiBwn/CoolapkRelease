...
final class PropertiesKt$byFloat$2 extends Lambda implements Function1<Float, JsonPrimitive> {
    public static final PropertiesKt$byFloat$2 INSTANCE = new PropertiesKt$byFloat$2();

    PropertiesKt$byFloat$2() {
        super(1);
    }
