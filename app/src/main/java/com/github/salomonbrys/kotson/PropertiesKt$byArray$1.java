...
final class PropertiesKt$byArray$1 extends Lambda implements Function1<JsonElement, JsonArray> {
    public static final PropertiesKt$byArray$1 INSTANCE = new PropertiesKt$byArray$1();

    PropertiesKt$byArray$1() {
        super(1);
    }
