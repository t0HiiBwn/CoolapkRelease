...
final class PropertiesKt$byBigInteger$3 extends Lambda implements Function1<JsonElement, BigInteger> {
    public static final PropertiesKt$byBigInteger$3 INSTANCE = new PropertiesKt$byBigInteger$3();

    PropertiesKt$byBigInteger$3() {
        super(1);
    }
