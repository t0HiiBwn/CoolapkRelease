...
final class PropertiesKt$byNumber$3 extends Lambda implements Function1<JsonElement, Number> {
    public static final PropertiesKt$byNumber$3 INSTANCE = new PropertiesKt$byNumber$3();

    PropertiesKt$byNumber$3() {
        super(1);
    }
