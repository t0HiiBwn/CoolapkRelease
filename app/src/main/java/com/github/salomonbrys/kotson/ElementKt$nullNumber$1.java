...
final class ElementKt$nullNumber$1 extends Lambda implements Function1<JsonElement, Number> {
    public static final ElementKt$nullNumber$1 INSTANCE = new ElementKt$nullNumber$1();

    ElementKt$nullNumber$1() {
        super(1);
    }
