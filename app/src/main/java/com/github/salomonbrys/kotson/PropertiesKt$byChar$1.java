...
final class PropertiesKt$byChar$1 extends Lambda implements Function1<JsonElement, Character> {
    public static final PropertiesKt$byChar$1 INSTANCE = new PropertiesKt$byChar$1();

    PropertiesKt$byChar$1() {
        super(1);
    }
