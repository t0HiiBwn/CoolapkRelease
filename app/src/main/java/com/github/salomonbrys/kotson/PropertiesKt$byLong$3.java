...
final class PropertiesKt$byLong$3 extends Lambda implements Function1<JsonElement, Long> {
    public static final PropertiesKt$byLong$3 INSTANCE = new PropertiesKt$byLong$3();

    PropertiesKt$byLong$3() {
        super(1);
    }
