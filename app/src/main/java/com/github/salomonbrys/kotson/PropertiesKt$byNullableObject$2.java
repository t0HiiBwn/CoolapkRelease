...
final class PropertiesKt$byNullableObject$2 extends Lambda implements Function1<JsonObject, JsonElement> {
    public static final PropertiesKt$byNullableObject$2 INSTANCE = new PropertiesKt$byNullableObject$2();

    PropertiesKt$byNullableObject$2() {
        super(1);
    }
