...
final class PropertiesKt$byBigInteger$4 extends Lambda implements Function1<BigInteger, JsonPrimitive> {
    public static final PropertiesKt$byBigInteger$4 INSTANCE = new PropertiesKt$byBigInteger$4();

    PropertiesKt$byBigInteger$4() {
        super(1);
    }
