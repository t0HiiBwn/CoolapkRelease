...
final class PropertiesKt$byNullableDouble$1 extends Lambda implements Function1<JsonElement, Double> {
    public static final PropertiesKt$byNullableDouble$1 INSTANCE = new PropertiesKt$byNullableDouble$1();

    PropertiesKt$byNullableDouble$1() {
        super(1);
    }
