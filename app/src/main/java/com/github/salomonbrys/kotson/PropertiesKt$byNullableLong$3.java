...
final class PropertiesKt$byNullableLong$3 extends Lambda implements Function1<JsonElement, Long> {
    public static final PropertiesKt$byNullableLong$3 INSTANCE = new PropertiesKt$byNullableLong$3();

    PropertiesKt$byNullableLong$3() {
        super(1);
    }
