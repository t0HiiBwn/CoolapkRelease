            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 3:
                        ...
                        setRequestAuthInfo(z, parcel.readString(), parcel.readString(), parcel.readString());
                        parcel2.writeNoException();
                        return true;
                    case 4:
                        parcel.enforceInterface("com.alibaba.mtl.appmonitor.IMonitor");
                    ...
                    case 38:
                        ...
                        stat_commit2(readString9, readString10, dimensionValueSet, parcel.readDouble(), parcel.readHashMap(getClass().getClassLoader()));
                        parcel2.writeNoException();
                        return true;
                    case 39:
                        parcel.enforceInterface("com.alibaba.mtl.appmonitor.IMonitor");
                        ...
                        stat_commit3(readString11, readString12, createFromParcel3, measureValueSet, parcel.readHashMap(getClass().getClassLoader()));
                        parcel2.writeNoException();
                        return true;
                    case 40:
                        parcel.enforceInterface("com.alibaba.mtl.appmonitor.IMonitor");
