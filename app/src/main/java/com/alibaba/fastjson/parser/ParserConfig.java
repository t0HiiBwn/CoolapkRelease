...
public class ParserConfig {
    ...
    public ObjectDeserializer getDeserializer(Class<?> cls, Type type) {
                ...
                if (replace.startsWith("org.joda.time.")) {
                    ...
                    for (int i4 = 0; i4 < 9; i4++) {
                        ...
                        if (str4.equals(replace)) {
                            ...
                            ObjectDeserializer objectDeserializer7 = JodaCodec.instance;
                            putDeserializer(cls5, objectDeserializer7);
            ...
            try {
                ...
                for (int i5 = 0; i5 < 5; i5++) {
                    ...
                    if (str5.equals(replace)) {
                        ...
                        ObjectDeserializer objectDeserializer8 = GuavaCodec.instance;
                        putDeserializer(cls6, objectDeserializer8);
        ...
        if (cls.isEnum()) {
            ...
            if (jSONType2 != null) {
                try {
                    ObjectDeserializer objectDeserializer9 = (ObjectDeserializer) jSONType2.deserializer().newInstance();
                    putDeserializer(cls, objectDeserializer9);
                    return objectDeserializer9;
    ...
    public Class<?> checkAutoType(Class cls) {
        ...
        return checkAutoType(cls.getName(), null, JSON.DEFAULT_PARSER_FEATURE);
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:131:0x027e A[ExcHandler: all (th java.lang.Throwable), Splitter:B:123:0x0266] */
    /* JADX WARNING: Removed duplicated region for block: B:150:0x02a3  */
    /* JADX WARNING: Removed duplicated region for block: B:160:0x02b7 A[ADDED_TO_REGION] */
    /* JADX WARNING: Removed duplicated region for block: B:165:0x02c5  */
    /* JADX WARNING: Removed duplicated region for block: B:189:0x0347  */
    ...
    public Class<?> checkAutoType(String str, Class<?> cls, int i) {
        ...
        if ((!this.safeMode && (i & i2) == 0 && (i2 & JSON.DEFAULT_PARSER_FEATURE) == 0) ? false : true) {
        ...
        } else if (str.length() >= 192 || str.length() < 3) {
            throw new JSONException("autoType is not support. " + str);
        } else {
            if (cls == null || cls == Object.class || cls == Serializable.class || cls == Cloneable.class || cls == Closeable.class || cls == EventListener.class || cls == Iterable.class || cls == Collection.class) {
                z = false;
            } else {
                z = true;
            }
            ...
            if (charAt == -5808493101479473382L) {
                throw new JSONException("autoType is not support. " + str);
            } else if ((((long) replace.charAt(replace.length() - 1)) ^ charAt) * 1099511628211L != 655701488918567152L) {
                ...
                long fnv1a_64 = TypeUtils.fnv1a_64(replace);
                boolean z4 = Arrays.binarySearch(INTERNAL_WHITELIST_HASHCODES, fnv1a_64) >= 0;
                if (this.internalDenyHashCodes != null) {
                    long j = charAt2;
                    int i3 = 3;
                    while (i3 < replace.length()) {
                        long charAt3 = (j ^ ((long) replace.charAt(i3))) * 1099511628211L;
                ...
                if (!z4 && (this.autoTypeSupport || z)) {
                    ...
                    while (i4 < replace.length()) {
                        j2 = (((long) replace.charAt(i4)) ^ j2) * 1099511628211L;
                        if (Arrays.binarySearch(this.acceptHashCodes, j2) >= 0 && (loadClass = TypeUtils.loadClass(str, this.defaultClassLoader, true)) != null) {
                            return loadClass;
                        }
                        if (Arrays.binarySearch(this.denyHashCodes, j2) < 0 || TypeUtils.getClassFromMapping(str) != null || Arrays.binarySearch(this.acceptHashCodes, fnv1a_64) >= 0) {
                            i4++;
                            charAt2 = charAt2;
                        } else {
                            throw new JSONException("autoType is not support. " + str);
                ...
                if (classFromMapping == null) {
                    if (!this.autoTypeSupport) {
                        ...
                        while (i5 < replace.length()) {
                            long charAt4 = (j3 ^ ((long) replace.charAt(i5))) * 1099511628211L;
                            if (Arrays.binarySearch(this.denyHashCodes, charAt4) >= 0) {
                                throw new JSONException("autoType is not support. " + str);
                            } else if (Arrays.binarySearch(this.acceptHashCodes, charAt4) >= 0) {
                    ...
                    try {
                        ...
                        if (classLoader != null) {
                            inputStream2 = classLoader.getResourceAsStream(str2);
                        } else {
                            inputStream2 = ParserConfig.class.getClassLoader().getResourceAsStream(str2);
                        }
                        if (inputStream2 != null) {
                            try {
                                ClassReader classReader = new ClassReader(inputStream2, true);
                    ...
                    int i6 = Feature.SupportAutoType.mask;
                    z3 = (this.autoTypeSupport && (i & i6) == 0 && (JSON.DEFAULT_PARSER_FEATURE & i6) == 0) ? false : true;
                    if (z3 || z2 || z) {
                        classFromMapping = TypeUtils.loadClass(str, this.defaultClassLoader, !z3 || z2);
                    }
                    if (classFromMapping != null) {
                    ...
                    throw new JSONException("autoType is not support. " + str);
                } else if (cls == null || classFromMapping == HashMap.class || cls.isAssignableFrom(classFromMapping)) {
                    return classFromMapping;
                } else {
                    throw new JSONException("type not match. " + str + " -> " + cls.getName());
                }
