...
public class b {
    private final Map<String, C0031b> a;
            ...
            if (!a(str) || (bVar = this.a.get(str)) == null) {
                ...
                if (a2 == null || aVar == null) {
                    ...
                    this.b.post(new Runnable() {
                        /* class com.bytedance.sdk.adnet.b.b.AnonymousClass1 */

                        @Override // java.lang.Runnable
                        public void run() {
                            aVar.a(a2.length(), a2.length());
                            aVar.a(m.a(a2, (a.C0035a) null));
                        }
                    });
                }
            } else {
    ...
    private C0031b b(String str, a aVar, boolean z) {
        String str2;
        ...
        return new C0031b(str, str2, aVar, z);
    }
    ...
    class C0031b {
        ...
        C0031b(String str, String str2, a aVar, boolean z) {
            this.a = str;
            this.b = str2;
            this.d = z;
            a(aVar);
        ...
        void a() {
            c cVar = new c(this.b, this.a, new c.a() {
                /* class com.bytedance.sdk.adnet.b.b.C0031b.AnonymousClass1 */

                @Override // com.bytedance.sdk.adnet.b.c.a
                public void a(long j, long j2) {
                    if (C0031b.this.c != null) {
                        for (a aVar : C0031b.this.c) {
                            try {
                                aVar.a(j, j2);
                            } catch (Throwable th) {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof C0031b) {
                return ((C0031b) obj).a.equals(this.a);
            }
