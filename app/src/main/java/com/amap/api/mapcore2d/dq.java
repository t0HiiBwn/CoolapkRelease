...
public class dq {
    ...
    void a(Context context) {
        try {
            ...
            if (b2 != null) {
                ...
                int i = 0;
                try {
                    daVar = new da.a(f, "1.0", "").a(new String[0]).a();
    ...
    private File[] b(Context context) {
        File file = new File(dm.a(context));
        if (!file.isDirectory()) {
            return null;
        }
    ...
    private static void a(Context context, a aVar) throws JSONException {
        if (!(TextUtils.isEmpty(aVar.b()) || TextUtils.isEmpty(aVar.c()) || TextUtils.isEmpty(aVar.d()))) {
            ...
            edit.putString("SO_ERROR_KEY", db.g(co.a(db.a(jSONArray.toString()))));
            edit.commit();
        }
    }
    ...
    private byte[] b(File file) {
        try {
            ...
            byte[] a2 = cv.a("a1f5886b7153004c5c99559f5261676f".getBytes(), bArr, "nFy1THrhajaZzz8U".getBytes());
            byte[] bArr2 = new byte[16];
            byte[] bArr3 = new byte[(a2.length - 16)];
            System.arraycopy(a2, 0, bArr2, 0, 16);
            System.arraycopy(a2, 16, bArr3, 0, a2.length - 16);
            return !a(cx.a(bArr3, "MD5"), bArr2) ? new byte[0] : bArr3;
        } catch (Throwable unused) {
            return null;
        }
    }
