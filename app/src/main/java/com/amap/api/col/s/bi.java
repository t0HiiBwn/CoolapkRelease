...
public final class bi {
    ...
    public static String e(Context context) {
        try {
            ...
            byte[] digest = MessageDigest.getInstance(bs.c("IU0hBMQ")).digest(packageInfo.signatures[0].toByteArray());
    ...
    private static String g(Context context) {
        ...
        File file = new File(ce.c(context, "k.store"));
        String str = "";
        if (!file.exists()) {
            return str;
        }
