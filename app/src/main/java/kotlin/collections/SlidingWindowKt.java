...
public final class SlidingWindowKt {
    ...
    public static final <T> Iterator<List<T>> windowedIterator(Iterator<? extends T> it2, int i, int i2, boolean z, boolean z2) {
        Intrinsics.checkNotNullParameter(it2, "iterator");
        if (!it2.hasNext()) {
            return EmptyIterator.INSTANCE;
        }
        return SequencesKt.iterator(new SlidingWindowKt$windowedIterator$1(i, i2, it2, z2, z, null));
    }
}
