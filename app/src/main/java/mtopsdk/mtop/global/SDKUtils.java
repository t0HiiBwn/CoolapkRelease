...
public class SDKUtils {
    ...
    public static void registerTtid(String str) {
        Mtop.instance("INNER", (Context) null).registerTtid(str);
    }

    @Deprecated
    public static void registerMtopSdkProperty(String str, String str2) {
        Mtop.instance("INNER", (Context) null).getMtopConfig().registerMtopSdkProperty(str, str2);
    }
    ...
    public static boolean unintallCacheBlock(String str) {
        return Mtop.instance("INNER", (Context) null).unintallCacheBlock(str);
    }

    @Deprecated
    public static boolean removeCacheItem(String str, String str2) {
        return Mtop.instance("INNER", (Context) null).removeCacheItem(str, str2);
    }
}
