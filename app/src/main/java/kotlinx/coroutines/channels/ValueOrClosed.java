...
public final class ValueOrClosed<T> {
    ...
    public static final /* synthetic */ ValueOrClosed m2002boximpl(Object obj) {
    ...
    public static Object m2003constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2004equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ValueOrClosed) && Intrinsics.areEqual(obj, ((ValueOrClosed) obj2).m2012unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2005equalsimpl0(Object obj, Object obj2) {
        return Intrinsics.areEqual(obj, obj2);
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m2009hashCodeimpl(Object obj) {
        if (obj != null) {
            return obj.hashCode();
        }
        return 0;
    ...
    public boolean equals(Object obj) {
        return m2004equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m2009hashCodeimpl(this.holder);
    }

    public String toString() {
        return m2011toStringimpl(this.holder);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Object m2012unboximpl() {
        return this.holder;
    }
    ...
    public static final boolean m2010isClosedimpl(Object obj) {
    ...
    public static final T m2007getValueimpl(Object obj) {
    ...
    public static final T m2008getValueOrNullimpl(Object obj) {
        if (obj instanceof Closed) {
            return null;
        }
        return obj;
    ...
    public static final Throwable m2006getCloseCauseimpl(Object obj) {
        if (obj instanceof Closed) {
    ...
    public static String m2011toStringimpl(Object obj) {
        if (obj instanceof Closed) {
            return obj.toString();
        }
        return "Value(" + obj + ')';
    ...
    public static final class Companion {
        ...
        public final <E> Object value$kotlinx_coroutines_core(E e) {
            return ValueOrClosed.m2003constructorimpl(e);
        }

        public final <E> Object closed$kotlinx_coroutines_core(Throwable th) {
            return ValueOrClosed.m2003constructorimpl(new Closed(th));
        }
    }
}
