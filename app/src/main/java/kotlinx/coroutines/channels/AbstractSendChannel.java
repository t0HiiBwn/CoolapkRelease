...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, Closed<?> closed) {
        ...
        continuation.resumeWith(Result.m687constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    private final void helpClose(Closed<?> closed) {
        Object r2 = InlineList.m2017constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (receive == null) {
                ...
                r2 = InlineList.m2022plusimpl(r2, receive);
            }
        }
        if (r2 != null) {
