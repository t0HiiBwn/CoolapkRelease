...
public final class UndispatchedKt {
        ...
        if (function1 != null) {
            try {
                ...
                if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    probeCoroutineCreated.resumeWith(Result.m687constructorimpl(invoke));
                }
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                probeCoroutineCreated.resumeWith(Result.m687constructorimpl(ResultKt.createFailure(th)));
            }
        } else {
    ...
    public static final <T> void startCoroutineUndispatched(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> continuation) {
        ...
        try {
            ...
            Result.Companion companion2 = Result.Companion;
            probeCoroutineCreated.resumeWith(Result.m687constructorimpl(ResultKt.createFailure(th2)));
        }
    }
